...
class Jane extends ChainGenerator
{
    ...
    public static function build(array $options = []): self
    {
        ...
        $normGenerator = new NormalizerGenerator($naming, $parser, $options['reference'], $options['use-cacheable-supports-method'] ?? false, $options['normalizer-force-null-when-nullable'] ?? true);
