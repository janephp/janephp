    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('id') && null !== $data->getId()) {
            ...
            if (is_null($data->getId())) {
                ...
                $value = $data->getId() === null ? null : new \Jane\Component\JsonSchema\Tests\Expected\OneOfNullable\Runtime\JsonObject($this->normalizer->normalize($data->getId(), 'json', $context));
            }
            $dataArray['id'] = $value;
        }
        return $dataArray;
