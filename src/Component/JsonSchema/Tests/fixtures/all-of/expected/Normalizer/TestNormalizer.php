...
class TestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('child', $data)) {
            $object->setChild($this->denormalizer->denormalize($data['child'], \Jane\Component\JsonSchema\Tests\Expected\AllOf\Model\Childtype::class, 'json', $context));
        }
        if (\array_key_exists('parent', $data)) {
            $object->setParent($this->denormalizer->denormalize($data['parent'], \Jane\Component\JsonSchema\Tests\Expected\AllOf\Model\Parenttype::class, 'json', $context));
        }
        return $object;
    }
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('child') && null !== $data->getChild()) {
            $dataArray['child'] = $data->getChild() === null ? null : new \Jane\Component\JsonSchema\Tests\Expected\AllOf\Runtime\JsonObject($this->normalizer->normalize($data->getChild(), 'json', $context));
        }
        if ($data->isInitialized('parent') && null !== $data->getParent()) {
            $dataArray['parent'] = $data->getParent() === null ? null : new \Jane\Component\JsonSchema\Tests\Expected\AllOf\Runtime\JsonObject($this->normalizer->normalize($data->getParent(), 'json', $context));
        }
        return $dataArray;
    }
