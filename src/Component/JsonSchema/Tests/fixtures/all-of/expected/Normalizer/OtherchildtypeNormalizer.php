...
class OtherchildtypeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\JsonSchema\Tests\Expected\AllOf\Model\Otherchildtype::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return $data instanceof \Jane\Component\JsonSchema\Tests\Expected\AllOf\Model\Otherchildtype;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Component\JsonSchema\Tests\Expected\AllOf\Model\Otherchildtype();
    ...
    {
        return [\Jane\Component\JsonSchema\Tests\Expected\AllOf\Model\Otherchildtype::class => false];
    }
}