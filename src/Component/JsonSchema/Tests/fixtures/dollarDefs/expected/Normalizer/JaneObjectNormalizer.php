...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    private function initNormalizer(string $normalizerClass)
    {
        $normalizer = match ($normalizerClass) {
            \Jane\JsonSchema\Tests\Expected\DollarDefs\Normalizer\FooNormalizer::class => new \Jane\JsonSchema\Tests\Expected\DollarDefs\Normalizer\FooNormalizer(),
            \Jane\JsonSchema\Tests\Expected\DollarDefs\Normalizer\BarItemNormalizer::class => new \Jane\JsonSchema\Tests\Expected\DollarDefs\Normalizer\BarItemNormalizer(),
            \Jane\JsonSchema\Tests\Expected\DollarDefs\Normalizer\HelloWorldNormalizer::class => new \Jane\JsonSchema\Tests\Expected\DollarDefs\Normalizer\HelloWorldNormalizer(),
            \Jane\JsonSchema\Tests\Expected\DollarDefs\Runtime\Normalizer\ReferenceNormalizer::class => new \Jane\JsonSchema\Tests\Expected\DollarDefs\Runtime\Normalizer\ReferenceNormalizer(),
