...
class BarItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\JsonSchema\Tests\Expected\DollarDefs\Model\BarItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return $data instanceof \Jane\JsonSchema\Tests\Expected\DollarDefs\Model\BarItem;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\JsonSchema\Tests\Expected\DollarDefs\Model\BarItem();
    ...
    {
        return [\Jane\JsonSchema\Tests\Expected\DollarDefs\Model\BarItem::class => false];
    }
}