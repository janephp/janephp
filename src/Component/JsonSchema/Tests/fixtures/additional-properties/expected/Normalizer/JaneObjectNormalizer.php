...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    private function initNormalizer(string $normalizerClass)
    {
        $normalizer = match ($normalizerClass) {
            \Jane\Component\JsonSchema\Tests\Expected\AdditionalProperties\Normalizer\AdditionalPropertiesNormalizer::class => new \Jane\Component\JsonSchema\Tests\Expected\AdditionalProperties\Normalizer\AdditionalPropertiesNormalizer(),
            \Jane\Component\JsonSchema\Tests\Expected\AdditionalProperties\Normalizer\PatternPropertiesNormalizer::class => new \Jane\Component\JsonSchema\Tests\Expected\AdditionalProperties\Normalizer\PatternPropertiesNormalizer(),
            \Jane\Component\JsonSchema\Tests\Expected\AdditionalProperties\Runtime\Normalizer\ReferenceNormalizer::class => new \Jane\Component\JsonSchema\Tests\Expected\AdditionalProperties\Runtime\Normalizer\ReferenceNormalizer(),
