...
class TestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\JsonSchema\Tests\Expected\TestDefault\Model\Test::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return $data instanceof \Jane\Component\JsonSchema\Tests\Expected\TestDefault\Model\Test;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Component\JsonSchema\Tests\Expected\TestDefault\Model\Test();
        ...
        if (\array_key_exists('subObject', $data) && $data['subObject'] !== null) {
            $object->setSubObject($this->denormalizer->denormalize($data['subObject'], \Jane\Component\JsonSchema\Tests\Expected\TestDefault\Model\TestSubObject::class, 'json', $context));
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('subObject') && null !== $data->getSubObject()) {
            $dataArray['subObject'] = $data->getSubObject() === null ? null : new \Jane\Component\JsonSchema\Tests\Expected\TestDefault\Runtime\JsonObject($this->normalizer->normalize($data->getSubObject(), 'json', $context));
        }
        return $dataArray;
    }
    public function getSupportedTypes(?string $format = null): array
    {
        return [\Jane\Component\JsonSchema\Tests\Expected\TestDefault\Model\Test::class => false];
    }
}