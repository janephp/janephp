...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    private function initNormalizer(string $normalizerClass)
    {
        $normalizer = match ($normalizerClass) {
            \Jane\Component\JsonSchema\Tests\Expected\DeepObject\Normalizer\TestNormalizer::class => new \Jane\Component\JsonSchema\Tests\Expected\DeepObject\Normalizer\TestNormalizer(),
            \Jane\Component\JsonSchema\Tests\Expected\DeepObject\Normalizer\TestFooItemNormalizer::class => new \Jane\Component\JsonSchema\Tests\Expected\DeepObject\Normalizer\TestFooItemNormalizer(),
            \Jane\Component\JsonSchema\Tests\Expected\DeepObject\Runtime\Normalizer\ReferenceNormalizer::class => new \Jane\Component\JsonSchema\Tests\Expected\DeepObject\Runtime\Normalizer\ReferenceNormalizer(),
