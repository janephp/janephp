...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    private function initNormalizer(string $normalizerClass)
    {
        $normalizer = match ($normalizerClass) {
            \Jane\Component\JsonSchema\Tests\Expected\ArrayObjectNullable\Normalizer\DocumentNormalizer::class => new \Jane\Component\JsonSchema\Tests\Expected\ArrayObjectNullable\Normalizer\DocumentNormalizer(),
            \Jane\Component\JsonSchema\Tests\Expected\ArrayObjectNullable\Normalizer\AttributesNormalizer::class => new \Jane\Component\JsonSchema\Tests\Expected\ArrayObjectNullable\Normalizer\AttributesNormalizer(),
            \Jane\Component\JsonSchema\Tests\Expected\ArrayObjectNullable\Runtime\Normalizer\ReferenceNormalizer::class => new \Jane\Component\JsonSchema\Tests\Expected\ArrayObjectNullable\Runtime\Normalizer\ReferenceNormalizer(),
