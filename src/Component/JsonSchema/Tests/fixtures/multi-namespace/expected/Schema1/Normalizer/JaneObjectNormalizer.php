...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    private function initNormalizer(string $normalizerClass)
    {
        $normalizer = match ($normalizerClass) {
            \Jane\Component\JsonSchema\Tests\Expected\Schema1\Normalizer\TestNormalizer::class => new \Jane\Component\JsonSchema\Tests\Expected\Schema1\Normalizer\TestNormalizer(),
            \Jane\Component\JsonSchema\Tests\Expected\Schema2\Normalizer\FooNormalizer::class => new \Jane\Component\JsonSchema\Tests\Expected\Schema2\Normalizer\FooNormalizer(),
            \Jane\Component\JsonSchema\Tests\Expected\Schema3\Normalizer\BarNormalizer::class => new \Jane\Component\JsonSchema\Tests\Expected\Schema3\Normalizer\BarNormalizer(),
