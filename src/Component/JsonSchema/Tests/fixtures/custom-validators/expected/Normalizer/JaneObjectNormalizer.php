...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    private function initNormalizer(string $normalizerClass)
    {
        $normalizer = match ($normalizerClass) {
            \Jane\JsonSchema\Tests\Expected\CustomValidators\Normalizer\PriceNormalizer::class => new \Jane\JsonSchema\Tests\Expected\CustomValidators\Normalizer\PriceNormalizer(),
            \Jane\JsonSchema\Tests\Expected\CustomValidators\Runtime\Normalizer\ReferenceNormalizer::class => new \Jane\JsonSchema\Tests\Expected\CustomValidators\Runtime\Normalizer\ReferenceNormalizer(),
