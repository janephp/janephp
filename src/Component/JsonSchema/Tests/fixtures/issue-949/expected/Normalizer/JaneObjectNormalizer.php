...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    private function initNormalizer(string $normalizerClass)
    {
        $normalizer = match ($normalizerClass) {
            \Jane\Component\JsonSchema\Tests\Expected\Issue949\Normalizer\ProjectProposalNormalizer::class => new \Jane\Component\JsonSchema\Tests\Expected\Issue949\Normalizer\ProjectProposalNormalizer(),
            \Jane\Component\JsonSchema\Tests\Expected\Issue949\Normalizer\GlobalEcoScoreNormalizer::class => new \Jane\Component\JsonSchema\Tests\Expected\Issue949\Normalizer\GlobalEcoScoreNormalizer(),
            \Jane\Component\JsonSchema\Tests\Expected\Issue949\Runtime\Normalizer\ReferenceNormalizer::class => new \Jane\Component\JsonSchema\Tests\Expected\Issue949\Runtime\Normalizer\ReferenceNormalizer(),
