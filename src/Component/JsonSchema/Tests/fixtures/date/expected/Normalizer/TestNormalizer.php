...
namespace Jane\Component\JsonSchema\Tests\Expected\Date\Normalizer;

use Jane\Component\JsonSchemaRuntime\Reference;
use Jane\Component\JsonSchema\Tests\Expected\Date\Runtime\Normalizer\CheckArray;
use Jane\Component\JsonSchema\Tests\Expected\Date\Runtime\Normalizer\ValidatorTrait;
...
class TestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\JsonSchema\Tests\Expected\Date\Model\Test::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return $data instanceof \Jane\Component\JsonSchema\Tests\Expected\Date\Model\Test;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Component\JsonSchema\Tests\Expected\Date\Model\Test();
        ...
        if (\array_key_exists('date', $data)) {
            ...
            if (false === $date) {
                throw new \Jane\Component\JsonSchema\Tests\Expected\Date\Runtime\Normalizer\InvalidDateException($data['date'], 'Y-m-d');
            }
        ...
        if (\array_key_exists('dateOrNull', $data) && $data['dateOrNull'] !== null) {
            ...
            if (false === $date_1) {
                throw new \Jane\Component\JsonSchema\Tests\Expected\Date\Runtime\Normalizer\InvalidDateException($data['dateOrNull'], 'Y-m-d');
            }
        ...
        if (\array_key_exists('dateOrNullOrInt', $data) && $data['dateOrNullOrInt'] !== null) {
            ...
            if (is_string($data['dateOrNullOrInt']) and false !== \DateTime::createFromFormat('Y-m-d', $data['dateOrNullOrInt'])) {
                ...
                if (false === $date_2) {
                    throw new \Jane\Component\JsonSchema\Tests\Expected\Date\Runtime\Normalizer\InvalidDateException($data['dateOrNullOrInt'], 'Y-m-d');
                }
    ...
    {
        return [\Jane\Component\JsonSchema\Tests\Expected\Date\Model\Test::class => false];
    }
}