...
class SimpleTypeGuesser implements GuesserInterface, TypeGuesserInterface
{
    ...
    public function supportObject($object): bool
    {
        ...
        return ($object instanceof $class)
            && \in_array($object->type ?? null, $this->typesSupported)
            && (
                !\array_key_exists($object->type ?? null, $this->excludeFormat)
                || !\in_array($object->format ?? null, $this->excludeFormat[$object->type ?? null])
            )
        ;
    }
    ...
    {
        return new Type($object, $this->phpTypesMapping[$object->type ?? null]);
    }
}
