...
class ObjectType extends Type
{
    ...
    public function createConditionStatement(Expr $input): Expr
    {
        ...
        foreach ($this->discriminants as $key => $values) {
            $keyExistsCondition = new Expr\FuncCall(
            ...
            if (null !== $logicalOr) {
                $conditionStatement = new Expr\BinaryOp\LogicalAnd($conditionStatement, new Expr\BinaryOp\LogicalAnd($keyExistsCondition, $logicalOr));
            } else {
                $conditionStatement = new Expr\BinaryOp\LogicalAnd($conditionStatement, $keyExistsCondition);
            }
        }
