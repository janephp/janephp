...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    private function initNormalizer(string $normalizerClass)
    {
        $normalizer = match ($normalizerClass) {
            \Jane\Component\JsonSchema\JsonSchema\Normalizer\JsonSchemaNormalizer::class => new \Jane\Component\JsonSchema\JsonSchema\Normalizer\JsonSchemaNormalizer(),
            \Jane\Component\JsonSchema\JsonSchema\Runtime\Normalizer\ReferenceNormalizer::class => new \Jane\Component\JsonSchema\JsonSchema\Runtime\Normalizer\ReferenceNormalizer(),
