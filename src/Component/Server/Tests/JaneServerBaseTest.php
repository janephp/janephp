...
use Jane\Component\Server\Console\Command\GenerateCommand;
use Jane\Component\Server\Console\Loader\ConfigLoader;
use Jane\Component\Server\Console\Loader\ServerLoader;
...
class JaneServerBaseTest extends TestCase
{
    ...
    {
        // 1. Generate
        $command = new GenerateCommand(new ConfigLoader(), new ServerLoader());
        $inputArray = new ArrayInput([
            '--config-file' => $testDirectory->getRealPath() . \DIRECTORY_SEPARATOR . '.jane-server',
