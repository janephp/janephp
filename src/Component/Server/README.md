# Jane JsonSchema Server

Generate controllers for your API given a [OpenAPI (Swagger) specification](https://github.com/OAI/OpenAPI-Specification/blob/master/versions/2.0.md).
