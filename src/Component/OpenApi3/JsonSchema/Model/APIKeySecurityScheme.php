...
class APIKeySecurityScheme implements AdditionalPropertiesInterface
{
    ...
    {
        return ['type' => ['type', 'getType', 'setType'], 'name' => ['name', 'getName', 'setName'], 'in' => ['in', 'getIn', 'setIn'], 'description' => ['description', 'getDescription', 'setDescription']];
    }
}