...
class RequestBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\JsonSchema\Model\RequestBody::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('content', $data) && $data['content'] !== null) {
            ...
            foreach ($data['content'] as $key => $value) {
                $values[$key] = $this->denormalizer->denormalize($value, \Jane\Component\OpenApi3\JsonSchema\Model\MediaType::class, 'json', $context);
            }
    ...
    {
        return [\Jane\Component\OpenApi3\JsonSchema\Model\RequestBody::class => false];
    }
}
