...
class ExternalDocumentationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\Component\\OpenApi3\\JsonSchema\\Model\\ExternalDocumentation';
    }
    public function supportsNormalization($data, $format = null, array $context = []) : bool
    {
        return $data instanceof \Jane\Component\OpenApi3\JsonSchema\Model\ExternalDocumentation;
    }
    /**
     * @return mixed
     */
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []) : mixed
    {
        ...
        $object = new \Jane\Component\OpenApi3\JsonSchema\Model\ExternalDocumentation();
    ...
    {
        return ['Jane\\Component\\OpenApi3\\JsonSchema\\Model\\ExternalDocumentation' => false];
    }
}