...
class ExternalDocumentationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\JsonSchema\Model\ExternalDocumentation::class;
    }
    ...
    {
        return [\Jane\Component\OpenApi3\JsonSchema\Model\ExternalDocumentation::class => false];
    }
}
