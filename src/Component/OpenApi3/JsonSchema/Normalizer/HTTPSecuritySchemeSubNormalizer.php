...
class HTTPSecuritySchemeSubNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\JsonSchema\Model\HTTPSecuritySchemeSub::class;
    }
    ...
    {
        return [\Jane\Component\OpenApi3\JsonSchema\Model\HTTPSecuritySchemeSub::class => false];
    }
}
