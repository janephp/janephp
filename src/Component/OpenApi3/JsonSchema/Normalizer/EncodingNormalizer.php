...
class EncodingNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\JsonSchema\Model\Encoding::class;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('headers', $data) && $data['headers'] !== null) {
            ...
            foreach ($data['headers'] as $key => $value) {
                $values[$key] = $this->denormalizer->denormalize($value, \Jane\Component\OpenApi3\JsonSchema\Model\Header::class, 'json', $context);
            }
    ...
    {
        return [\Jane\Component\OpenApi3\JsonSchema\Model\Encoding::class => false];
    }
}
