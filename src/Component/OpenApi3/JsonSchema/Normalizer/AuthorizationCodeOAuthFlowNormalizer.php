...
class AuthorizationCodeOAuthFlowNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\JsonSchema\Model\AuthorizationCodeOAuthFlow::class;
    }
    ...
    {
        return [\Jane\Component\OpenApi3\JsonSchema\Model\AuthorizationCodeOAuthFlow::class => false];
    }
}
