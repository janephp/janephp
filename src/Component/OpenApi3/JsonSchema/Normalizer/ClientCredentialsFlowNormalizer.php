...
class ClientCredentialsFlowNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\JsonSchema\Model\ClientCredentialsFlow::class;
    }
    ...
    {
        return [\Jane\Component\OpenApi3\JsonSchema\Model\ClientCredentialsFlow::class => false];
    }
}
