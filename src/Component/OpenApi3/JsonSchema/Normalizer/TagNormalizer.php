...
class TagNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof \Jane\Component\OpenApi3\JsonSchema\Model\Tag;
    }
    /**
     * @return mixed
     */
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []) : mixed
    {
        ...
        $object = new \Jane\Component\OpenApi3\JsonSchema\Model\Tag();
    ...
    {
        return ['Jane\\Component\\OpenApi3\\JsonSchema\\Model\\Tag' => false];
    }
}