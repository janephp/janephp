 ...
 *
 * Unlike MultipartEncodingRuntimeTest which calls getBody() directly, this
 * test generates a client from the issue-1036 specification and pushes the
 * request through the full generated client stack, capturing the PSR-7
 * request handed to an injected PSR-18 client: method, URI, headers,
 * boundary and the assembled multipart body actually sent on the wire.
 *
...
class MultipartEncodingFunctionalTest extends TestCase
{
    ...
    private const NAMESPACE_PREFIX = 'Jane\Component\OpenApi3\Tests\Issue1036Functional';
     ...
     *
     * Operations map form parameter names to descriptors: ['type' => 'string'|'realfile',
     * 'value' => mixed], optional key 'inMemoryValue' (a stream created by the caller
     * cannot cross the process boundary: instead pass content under 'value' together
     * with type 'inmemory').
     *
...
PHP;
    ...
    {
        return sys_get_temp_dir() . '/janephp-issue-1036-functional-openapi3';
    }
