...
class Client extends \Jane\Component\OpenApi3\Tests\Expected\Runtime\Client\Client
{
     ...
     *
     * @return ($fetch is 'object' ? null|\Jane\Component\OpenApi3\Tests\Expected\Model\BarItem[] : \Psr\Http\Message\ResponseInterface)
     */
    public function testSimple(string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi3\Tests\Expected\Endpoint\TestSimple(), $fetch);
    }
