...
class ReposOwnerRepoPagesPutBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        $dataArray = [];
        if ($data->isInitialized('cname') && null !== $data->getCname()) {
            $dataArray['cname'] = $data->getCname();
        }
        ...
        if (!($context['skip_validation'] ?? false)) {
            $this->validate($dataArray, new \Github\Validator\ReposOwnerRepoPagesPutBodyConstraint());
        }
        return $dataArray;
    }
