...
class IssueEventDismissedReviewNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $dataArray['dismissal_message'] = $data->getDismissalMessage();
        if ($data->isInitialized('dismissalCommitId')) {
        ...
        if (!($context['skip_validation'] ?? false)) {
            $this->validate($dataArray, new \Github\Validator\IssueEventDismissedReviewConstraint());
        }
        return $dataArray;
    }
