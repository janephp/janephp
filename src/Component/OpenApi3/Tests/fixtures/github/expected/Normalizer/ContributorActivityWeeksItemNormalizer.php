...
class ContributorActivityWeeksItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('d') && null !== $data->getD()) {
            $dataArray['d'] = $data->getD();
        }
        if ($data->isInitialized('c') && null !== $data->getC()) {
        ...
        if (!($context['skip_validation'] ?? false)) {
            $this->validate($dataArray, new \Github\Validator\ContributorActivityWeeksItemConstraint());
        }
        return $dataArray;
    }
