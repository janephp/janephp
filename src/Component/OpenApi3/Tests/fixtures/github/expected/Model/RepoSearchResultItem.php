...
class RepoSearchResultItem implements AdditionalPropertiesInterface
{
    ...
    {
        return ['id' => ['id', 'getId', 'setId'], 'nodeId' => ['node_id', 'getNodeId', 'setNodeId'], 'name' => ['name', 'getName', 'setName'], 'fullName' => ['full_name', 'getFullName', 'setFullName'], 'owner' => ['owner', 'getOwner', 'setOwner'], 'private' => ['private', 'getPrivate', 'setPrivate'], 'htmlUrl' => ['html_url', 'getHtmlUrl', 'setHtmlUrl'], 'description' => ['description', 'getDescription', 'setDescription'], 'fork' => ['fork', 'getFork', 'setFork'], 'url' => ['url', 'getUrl', 'setUrl'], 'createdAt' => ['created_at', 'getCreatedAt', 'setCreatedAt'], 'updatedAt' => ['updated_at', 'getUpdatedAt', 'setUpdatedAt'], 'pushedAt' => ['pushed_at', 'getPushedAt', 'setPushedAt'], 'homepage' => ['homepage', 'getHomepage', 'setHomepage'], 'size' => ['size', 'getSize', 'setSize'], 'stargazersCount' => ['stargazers_count', 'getStargazersCount', 'setStargazersCount'], 'watchersCount' => ['watchers_count', 'getWatchersCount', 'setWatchersCount'], 'language' => ['language', 'getLanguage', 'setLanguage'], 'forksCount' => ['forks_count', 'getForksCount', 'setForksCount'], 'openIssuesCount' => ['open_issues_count', 'getOpenIssuesCount', 'setOpenIssuesCount'], 'masterBranch' => ['master_branch', 'getMasterBranch', 'setMasterBranch'], 'defaultBranch' => ['default_branch', 'getDefaultBranch', 'setDefaultBranch'], 'score' => ['score', 'getScore', 'setScore'], 'forksUrl' => ['forks_url', 'getForksUrl', 'setForksUrl'], 'keysUrl' => ['keys_url', 'getKeysUrl', 'setKeysUrl'], 'collaboratorsUrl' => ['collaborators_url', 'getCollaboratorsUrl', 'setCollaboratorsUrl'], 'teamsUrl' => ['teams_url', 'getTeamsUrl', 'setTeamsUrl'], 'hooksUrl' => ['hooks_url', 'getHooksUrl', 'setHooksUrl'], 'issueEventsUrl' => ['issue_events_url', 'getIssueEventsUrl', 'setIssueEventsUrl'], 'eventsUrl' => ['events_url', 'getEventsUrl', 'setEventsUrl'], 'assigneesUrl' => ['assignees_url', 'getAssigneesUrl', 'setAssigneesUrl'], 'branchesUrl' => ['branches_url', 'getBranchesUrl', 'setBranchesUrl'], 'tagsUrl' => ['tags_url', 'getTagsUrl', 'setTagsUrl'], 'blobsUrl' => ['blobs_url', 'getBlobsUrl', 'setBlobsUrl'], 'gitTagsUrl' => ['git_tags_url', 'getGitTagsUrl', 'setGitTagsUrl'], 'gitRefsUrl' => ['git_refs_url', 'getGitRefsUrl', 'setGitRefsUrl'], 'treesUrl' => ['trees_url', 'getTreesUrl', 'setTreesUrl'], 'statusesUrl' => ['statuses_url', 'getStatusesUrl', 'setStatusesUrl'], 'languagesUrl' => ['languages_url', 'getLanguagesUrl', 'setLanguagesUrl'], 'stargazersUrl' => ['stargazers_url', 'getStargazersUrl', 'setStargazersUrl'], 'contributorsUrl' => ['contributors_url', 'getContributorsUrl', 'setContributorsUrl'], 'subscribersUrl' => ['subscribers_url', 'getSubscribersUrl', 'setSubscribersUrl'], 'subscriptionUrl' => ['subscription_url', 'getSubscriptionUrl', 'setSubscriptionUrl'], 'commitsUrl' => ['commits_url', 'getCommitsUrl', 'setCommitsUrl'], 'gitCommitsUrl' => ['git_commits_url', 'getGitCommitsUrl', 'setGitCommitsUrl'], 'commentsUrl' => ['comments_url', 'getCommentsUrl', 'setCommentsUrl'], 'issueCommentUrl' => ['issue_comment_url', 'getIssueCommentUrl', 'setIssueCommentUrl'], 'contentsUrl' => ['contents_url', 'getContentsUrl', 'setContentsUrl'], 'compareUrl' => ['compare_url', 'getCompareUrl', 'setCompareUrl'], 'mergesUrl' => ['merges_url', 'getMergesUrl', 'setMergesUrl'], 'archiveUrl' => ['archive_url', 'getArchiveUrl', 'setArchiveUrl'], 'downloadsUrl' => ['downloads_url', 'getDownloadsUrl', 'setDownloadsUrl'], 'issuesUrl' => ['issues_url', 'getIssuesUrl', 'setIssuesUrl'], 'pullsUrl' => ['pulls_url', 'getPullsUrl', 'setPullsUrl'], 'milestonesUrl' => ['milestones_url', 'getMilestonesUrl', 'setMilestonesUrl'], 'notificationsUrl' => ['notifications_url', 'getNotificationsUrl', 'setNotificationsUrl'], 'labelsUrl' => ['labels_url', 'getLabelsUrl', 'setLabelsUrl'], 'releasesUrl' => ['releases_url', 'getReleasesUrl', 'setReleasesUrl'], 'deploymentsUrl' => ['deployments_url', 'getDeploymentsUrl', 'setDeploymentsUrl'], 'gitUrl' => ['git_url', 'getGitUrl', 'setGitUrl'], 'sshUrl' => ['ssh_url', 'getSshUrl', 'setSshUrl'], 'cloneUrl' => ['clone_url', 'getCloneUrl', 'setCloneUrl'], 'svnUrl' => ['svn_url', 'getSvnUrl', 'setSvnUrl'], 'forks' => ['forks', 'getForks', 'setForks'], 'openIssues' => ['open_issues', 'getOpenIssues', 'setOpenIssues'], 'watchers' => ['watchers', 'getWatchers', 'setWatchers'], 'topics' => ['topics', 'getTopics', 'setTopics'], 'mirrorUrl' => ['mirror_url', 'getMirrorUrl', 'setMirrorUrl'], 'hasIssues' => ['has_issues', 'getHasIssues', 'setHasIssues'], 'hasProjects' => ['has_projects', 'getHasProjects', 'setHasProjects'], 'hasPages' => ['has_pages', 'getHasPages', 'setHasPages'], 'hasWiki' => ['has_wiki', 'getHasWiki', 'setHasWiki'], 'hasDownloads' => ['has_downloads', 'getHasDownloads', 'setHasDownloads'], 'archived' => ['archived', 'getArchived', 'setArchived'], 'disabled' => ['disabled', 'getDisabled', 'setDisabled'], 'license' => ['license', 'getLicense', 'setLicense'], 'permissions' => ['permissions', 'getPermissions', 'setPermissions'], 'textMatches' => ['text_matches', 'getTextMatches', 'setTextMatches'], 'tempCloneToken' => ['temp_clone_token', 'getTempCloneToken', 'setTempCloneToken'], 'allowMergeCommit' => ['allow_merge_commit', 'getAllowMergeCommit', 'setAllowMergeCommit'], 'allowSquashMerge' => ['allow_squash_merge', 'getAllowSquashMerge', 'setAllowSquashMerge'], 'allowRebaseMerge' => ['allow_rebase_merge', 'getAllowRebaseMerge', 'setAllowRebaseMerge'], 'deleteBranchOnMerge' => ['delete_branch_on_merge', 'getDeleteBranchOnMerge', 'setDeleteBranchOnMerge']];
    }
}