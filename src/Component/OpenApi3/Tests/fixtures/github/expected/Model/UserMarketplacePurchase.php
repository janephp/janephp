...
class UserMarketplacePurchase implements AdditionalPropertiesInterface
{
    ...
    {
        return ['billingCycle' => ['billing_cycle', 'getBillingCycle', 'setBillingCycle'], 'nextBillingDate' => ['next_billing_date', 'getNextBillingDate', 'setNextBillingDate'], 'unitCount' => ['unit_count', 'getUnitCount', 'setUnitCount'], 'onFreeTrial' => ['on_free_trial', 'getOnFreeTrial', 'setOnFreeTrial'], 'freeTrialEndsOn' => ['free_trial_ends_on', 'getFreeTrialEndsOn', 'setFreeTrialEndsOn'], 'updatedAt' => ['updated_at', 'getUpdatedAt', 'setUpdatedAt'], 'account' => ['account', 'getAccount', 'setAccount'], 'plan' => ['plan', 'getPlan', 'setPlan']];
    }
}