...
class PullRequestHeadRepo implements AdditionalPropertiesInterface
{
    ...
    {
        return ['archiveUrl' => ['archive_url', 'getArchiveUrl', 'setArchiveUrl'], 'assigneesUrl' => ['assignees_url', 'getAssigneesUrl', 'setAssigneesUrl'], 'blobsUrl' => ['blobs_url', 'getBlobsUrl', 'setBlobsUrl'], 'branchesUrl' => ['branches_url', 'getBranchesUrl', 'setBranchesUrl'], 'collaboratorsUrl' => ['collaborators_url', 'getCollaboratorsUrl', 'setCollaboratorsUrl'], 'commentsUrl' => ['comments_url', 'getCommentsUrl', 'setCommentsUrl'], 'commitsUrl' => ['commits_url', 'getCommitsUrl', 'setCommitsUrl'], 'compareUrl' => ['compare_url', 'getCompareUrl', 'setCompareUrl'], 'contentsUrl' => ['contents_url', 'getContentsUrl', 'setContentsUrl'], 'contributorsUrl' => ['contributors_url', 'getContributorsUrl', 'setContributorsUrl'], 'deploymentsUrl' => ['deployments_url', 'getDeploymentsUrl', 'setDeploymentsUrl'], 'description' => ['description', 'getDescription', 'setDescription'], 'downloadsUrl' => ['downloads_url', 'getDownloadsUrl', 'setDownloadsUrl'], 'eventsUrl' => ['events_url', 'getEventsUrl', 'setEventsUrl'], 'fork' => ['fork', 'getFork', 'setFork'], 'forksUrl' => ['forks_url', 'getForksUrl', 'setForksUrl'], 'fullName' => ['full_name', 'getFullName', 'setFullName'], 'gitCommitsUrl' => ['git_commits_url', 'getGitCommitsUrl', 'setGitCommitsUrl'], 'gitRefsUrl' => ['git_refs_url', 'getGitRefsUrl', 'setGitRefsUrl'], 'gitTagsUrl' => ['git_tags_url', 'getGitTagsUrl', 'setGitTagsUrl'], 'hooksUrl' => ['hooks_url', 'getHooksUrl', 'setHooksUrl'], 'htmlUrl' => ['html_url', 'getHtmlUrl', 'setHtmlUrl'], 'id' => ['id', 'getId', 'setId'], 'nodeId' => ['node_id', 'getNodeId', 'setNodeId'], 'issueCommentUrl' => ['issue_comment_url', 'getIssueCommentUrl', 'setIssueCommentUrl'], 'issueEventsUrl' => ['issue_events_url', 'getIssueEventsUrl', 'setIssueEventsUrl'], 'issuesUrl' => ['issues_url', 'getIssuesUrl', 'setIssuesUrl'], 'keysUrl' => ['keys_url', 'getKeysUrl', 'setKeysUrl'], 'labelsUrl' => ['labels_url', 'getLabelsUrl', 'setLabelsUrl'], 'languagesUrl' => ['languages_url', 'getLanguagesUrl', 'setLanguagesUrl'], 'mergesUrl' => ['merges_url', 'getMergesUrl', 'setMergesUrl'], 'milestonesUrl' => ['milestones_url', 'getMilestonesUrl', 'setMilestonesUrl'], 'name' => ['name', 'getName', 'setName'], 'notificationsUrl' => ['notifications_url', 'getNotificationsUrl', 'setNotificationsUrl'], 'owner' => ['owner', 'getOwner', 'setOwner'], 'private' => ['private', 'getPrivate', 'setPrivate'], 'pullsUrl' => ['pulls_url', 'getPullsUrl', 'setPullsUrl'], 'releasesUrl' => ['releases_url', 'getReleasesUrl', 'setReleasesUrl'], 'stargazersUrl' => ['stargazers_url', 'getStargazersUrl', 'setStargazersUrl'], 'statusesUrl' => ['statuses_url', 'getStatusesUrl', 'setStatusesUrl'], 'subscribersUrl' => ['subscribers_url', 'getSubscribersUrl', 'setSubscribersUrl'], 'subscriptionUrl' => ['subscription_url', 'getSubscriptionUrl', 'setSubscriptionUrl'], 'tagsUrl' => ['tags_url', 'getTagsUrl', 'setTagsUrl'], 'teamsUrl' => ['teams_url', 'getTeamsUrl', 'setTeamsUrl'], 'treesUrl' => ['trees_url', 'getTreesUrl', 'setTreesUrl'], 'url' => ['url', 'getUrl', 'setUrl'], 'cloneUrl' => ['clone_url', 'getCloneUrl', 'setCloneUrl'], 'defaultBranch' => ['default_branch', 'getDefaultBranch', 'setDefaultBranch'], 'forks' => ['forks', 'getForks', 'setForks'], 'forksCount' => ['forks_count', 'getForksCount', 'setForksCount'], 'gitUrl' => ['git_url', 'getGitUrl', 'setGitUrl'], 'hasDownloads' => ['has_downloads', 'getHasDownloads', 'setHasDownloads'], 'hasIssues' => ['has_issues', 'getHasIssues', 'setHasIssues'], 'hasProjects' => ['has_projects', 'getHasProjects', 'setHasProjects'], 'hasWiki' => ['has_wiki', 'getHasWiki', 'setHasWiki'], 'hasPages' => ['has_pages', 'getHasPages', 'setHasPages'], 'homepage' => ['homepage', 'getHomepage', 'setHomepage'], 'language' => ['language', 'getLanguage', 'setLanguage'], 'masterBranch' => ['master_branch', 'getMasterBranch', 'setMasterBranch'], 'archived' => ['archived', 'getArchived', 'setArchived'], 'disabled' => ['disabled', 'getDisabled', 'setDisabled'], 'mirrorUrl' => ['mirror_url', 'getMirrorUrl', 'setMirrorUrl'], 'openIssues' => ['open_issues', 'getOpenIssues', 'setOpenIssues'], 'openIssuesCount' => ['open_issues_count', 'getOpenIssuesCount', 'setOpenIssuesCount'], 'permissions' => ['permissions', 'getPermissions', 'setPermissions'], 'tempCloneToken' => ['temp_clone_token', 'getTempCloneToken', 'setTempCloneToken'], 'allowMergeCommit' => ['allow_merge_commit', 'getAllowMergeCommit', 'setAllowMergeCommit'], 'allowSquashMerge' => ['allow_squash_merge', 'getAllowSquashMerge', 'setAllowSquashMerge'], 'allowRebaseMerge' => ['allow_rebase_merge', 'getAllowRebaseMerge', 'setAllowRebaseMerge'], 'license' => ['license', 'getLicense', 'setLicense'], 'pushedAt' => ['pushed_at', 'getPushedAt', 'setPushedAt'], 'size' => ['size', 'getSize', 'setSize'], 'sshUrl' => ['ssh_url', 'getSshUrl', 'setSshUrl'], 'stargazersCount' => ['stargazers_count', 'getStargazersCount', 'setStargazersCount'], 'svnUrl' => ['svn_url', 'getSvnUrl', 'setSvnUrl'], 'topics' => ['topics', 'getTopics', 'setTopics'], 'watchers' => ['watchers', 'getWatchers', 'setWatchers'], 'watchersCount' => ['watchers_count', 'getWatchersCount', 'setWatchersCount'], 'createdAt' => ['created_at', 'getCreatedAt', 'setCreatedAt'], 'updatedAt' => ['updated_at', 'getUpdatedAt', 'setUpdatedAt']];
    }
}