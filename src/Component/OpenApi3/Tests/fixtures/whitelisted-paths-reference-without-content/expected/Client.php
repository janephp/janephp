...
class Client extends \Jane\Component\OpenApi3\Tests\Expected\WhitelistedPathsReferenceWithoutContent\Runtime\Client\Client
{
     ...
     *
     * @return ($fetch is 'object' ? null|\Jane\Component\OpenApi3\Tests\Expected\WhitelistedPathsReferenceWithoutContent\Model\Foo : \Psr\Http\Message\ResponseInterface)
     */
    public function getFoo(string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi3\Tests\Expected\WhitelistedPathsReferenceWithoutContent\Endpoint\GetFoo(), $fetch);
    }
