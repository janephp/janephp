...
class Schema implements AdditionalPropertiesInterface
{
    ...
    {
        return ['stringProperty' => 'stringProperty', 'integerProperty' => 'integerProperty', 'floatProperty' => 'floatProperty', 'arrayProperty' => 'arrayProperty', 'mapProperty' => 'mapProperty', 'objectProperty' => 'objectProperty', 'objectRefProperty' => 'objectRefProperty'];
    }
}