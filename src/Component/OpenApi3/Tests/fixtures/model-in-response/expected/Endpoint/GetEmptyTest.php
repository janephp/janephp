...
class GetEmptyTest extends \Jane\Component\OpenApi3\Tests\Expected\ModelInResponse\Runtime\Client\BaseEndpoint implements \Jane\Component\OpenApi3\Tests\Expected\ModelInResponse\Runtime\Client\Endpoint
{
    ...
    protected function transformResponseBody(\Symfony\Contracts\HttpClient\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if ($contentType !== null && (200 === $status && stripos(strtolower($contentType), 'application/json') !== false)) {
            return $serializer->deserialize($body, 'Jane\Component\OpenApi3\Tests\Expected\ModelInResponse\Model\EmptySpace', 'json');
        }
    ...
    {
        return \Jane\Component\OpenApi3\Tests\Expected\ModelInResponse\Model\EmptySpace::class;
    }
}