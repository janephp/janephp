...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    private function initNormalizer(string $normalizerClass)
    {
        $normalizer = match ($normalizerClass) {
            \Jane\Component\OpenApi3\Tests\Expected\AllOfMerge\Normalizer\BarNormalizer::class => new \Jane\Component\OpenApi3\Tests\Expected\AllOfMerge\Normalizer\BarNormalizer(),
            \Jane\Component\OpenApi3\Tests\Expected\AllOfMerge\Normalizer\FooNormalizer::class => new \Jane\Component\OpenApi3\Tests\Expected\AllOfMerge\Normalizer\FooNormalizer(),
            \Jane\Component\OpenApi3\Tests\Expected\AllOfMerge\Normalizer\FuzNormalizer::class => new \Jane\Component\OpenApi3\Tests\Expected\AllOfMerge\Normalizer\FuzNormalizer(),
            \Jane\Component\OpenApi3\Tests\Expected\AllOfMerge\Runtime\Normalizer\ReferenceNormalizer::class => new \Jane\Component\OpenApi3\Tests\Expected\AllOfMerge\Runtime\Normalizer\ReferenceNormalizer(),
