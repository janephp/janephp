...
class ParchmentJsonhalLinksNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'ApiPlatform\\Demo\\Model\\ParchmentJsonhalLinks';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('self', $data)) {
            $object->setSelf($this->denormalizer->denormalize($data['self'], 'ApiPlatform\\Demo\\Model\\ParchmentJsonhalLinksSelf', 'json', $context));
            unset($data['self']);
        }
    ...
    {
        return array('ApiPlatform\\Demo\\Model\\ParchmentJsonhalLinks' => false);
    }
}