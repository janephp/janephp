...
class BookJsonhalNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'ApiPlatform\\Demo\\Model\\BookJsonhal';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('_links', $data)) {
            $object->setLinks($this->denormalizer->denormalize($data['_links'], 'ApiPlatform\\Demo\\Model\\BookJsonhalLinks', 'json', $context));
            unset($data['_links']);
        }
    ...
    {
        return array('ApiPlatform\\Demo\\Model\\BookJsonhal' => false);
    }
}