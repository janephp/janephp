...
class ConnectionExceptionProblem implements AdditionalPropertiesInterface
{
    ...
    {
        return ['type' => ['type', 'getType', 'setType'], 'connectionIssue' => ['connection_issue', 'getConnectionIssue', 'setConnectionIssue'], 'title' => ['title', 'getTitle', 'setTitle'], 'detail' => ['detail', 'getDetail', 'setDetail']];
    }
}