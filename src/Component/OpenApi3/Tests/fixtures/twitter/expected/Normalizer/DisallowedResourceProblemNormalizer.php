...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DisallowedResourceProblemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'Jane\\Component\\OpenApi3\\Tests\\Expected\\Model\\DisallowedResourceProblem';
        }
        ...
        {
            return ['Jane\\Component\\OpenApi3\\Tests\\Expected\\Model\\DisallowedResourceProblem' => false];
        }
    }
} else {
    class DisallowedResourceProblemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
