...
class Client extends \Jane\Component\OpenApi3\Tests\Expected\AnyOfDiscriminator\Runtime\Client\Client
{
     ...
     *
     * @return ($fetch is 'object' ? null|\Jane\Component\OpenApi3\Tests\Expected\AnyOfDiscriminator\Model\FooBar : \Psr\Http\Message\ResponseInterface)
     */
    public function testAnyOfWithDiscriminator(string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi3\Tests\Expected\AnyOfDiscriminator\Endpoint\TestAnyOfWithDiscriminator(), $fetch);
    }
