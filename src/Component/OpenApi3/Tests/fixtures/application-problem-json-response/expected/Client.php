...
class Client extends \Jane\Component\OpenApi3\Tests\Expected\ApplicationProblemJsonResponse\Runtime\Client\Client
{
     ...
     */
    public function postFoo(?\Jane\Component\OpenApi3\Tests\Expected\ApplicationProblemJsonResponse\Model\FooPayload $requestBody = null, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi3\Tests\Expected\ApplicationProblemJsonResponse\Endpoint\PostFoo($requestBody), $fetch);
    }
