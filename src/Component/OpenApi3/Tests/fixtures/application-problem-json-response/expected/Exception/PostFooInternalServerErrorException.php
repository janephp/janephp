...
class PostFooInternalServerErrorException extends InternalServerErrorException
{
     ...
     */
    private $response;
    public function __construct(\Jane\Component\OpenApi3\Tests\Expected\ApplicationProblemJsonResponse\Model\ResponseProblemDetailsResponse500 $responseProblemDetailsResponse500, \Psr\Http\Message\ResponseInterface $response)
    {
