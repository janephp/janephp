...
class Client extends \Jane\Component\OpenApi3\Tests\Expected\Issue787\Runtime\Client\Client
{
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi3\Tests\Expected\Issue787\Endpoint\GetFoo($queryParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi3\Tests\Expected\Issue787\Endpoint\PostFoo($requestBody), $fetch);
    }
