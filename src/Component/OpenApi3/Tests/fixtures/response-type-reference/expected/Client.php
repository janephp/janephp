...
class Client extends \Jane\Component\OpenApi3\Tests\Expected\ResponseTypeReference\Runtime\Client\Client
{
     ...
     *
     * @return ($fetch is 'object' ? null|\Jane\Component\OpenApi3\Tests\Expected\ResponseTypeReference\Model\FooGetResponse200 : \Psr\Http\Message\ResponseInterface)
     */
    public function foo(string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi3\Tests\Expected\ResponseTypeReference\Endpoint\Foo(), $fetch);
    }
