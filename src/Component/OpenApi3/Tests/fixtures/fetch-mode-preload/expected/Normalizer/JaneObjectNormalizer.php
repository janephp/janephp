...
namespace Jane\Component\OpenApi3\Tests\FetchModePreload\Normalizer;

use Jane\Component\OpenApi3\Tests\FetchModePreload\Runtime\Normalizer\CheckArray;
use Jane\Component\OpenApi3\Tests\FetchModePreload\Runtime\Normalizer\ValidatorTrait;
...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    private function initNormalizer(string $normalizerClass)
    {
        $normalizer = match ($normalizerClass) {
            \Jane\Component\OpenApi3\Tests\FetchModePreload\Normalizer\PetsGetResponse200Normalizer::class => new \Jane\Component\OpenApi3\Tests\FetchModePreload\Normalizer\PetsGetResponse200Normalizer(),
            \Jane\Component\OpenApi3\Tests\FetchModePreload\Normalizer\PetsGetResponse404Normalizer::class => new \Jane\Component\OpenApi3\Tests\FetchModePreload\Normalizer\PetsGetResponse404Normalizer(),
            \Jane\Component\OpenApi3\Tests\FetchModePreload\Runtime\Normalizer\ReferenceNormalizer::class => new \Jane\Component\OpenApi3\Tests\FetchModePreload\Runtime\Normalizer\ReferenceNormalizer(),
