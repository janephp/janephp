...
class Client extends \Jane\Component\OpenApi3\Tests\Expected\AnyOfNullableReferenceProperty\Runtime\Client\Client
{
     ...
     *
     * @return ($fetch is 'object' ? null|\Jane\Component\OpenApi3\Tests\Expected\AnyOfNullableReferenceProperty\Model\Account : \Psr\Http\Message\ResponseInterface)
     */
    public function getUser(string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi3\Tests\Expected\AnyOfNullableReferenceProperty\Endpoint\GetUser(), $fetch);
    }
