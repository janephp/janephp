...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    private function initNormalizer(string $normalizerClass)
    {
        $normalizer = match ($normalizerClass) {
            \Jane\Component\OpenApi3\Tests\Expected\Parameters\Normalizer\TestFormPostBodyNormalizer::class => new \Jane\Component\OpenApi3\Tests\Expected\Parameters\Normalizer\TestFormPostBodyNormalizer(),
            \Jane\Component\OpenApi3\Tests\Expected\Parameters\Normalizer\TestFormFilePostBodyNormalizer::class => new \Jane\Component\OpenApi3\Tests\Expected\Parameters\Normalizer\TestFormFilePostBodyNormalizer(),
            \Jane\Component\OpenApi3\Tests\Expected\Parameters\Runtime\Normalizer\ReferenceNormalizer::class => new \Jane\Component\OpenApi3\Tests\Expected\Parameters\Runtime\Normalizer\ReferenceNormalizer(),
