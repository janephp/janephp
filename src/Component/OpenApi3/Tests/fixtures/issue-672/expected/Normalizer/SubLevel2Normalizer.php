...
class SubLevel2Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('subLevel-3', $data)) {
            $object->setSubLevel3($this->denormalizer->denormalize($data['subLevel-3'], \Jane\Component\OpenApi3\Tests\Expected\Issue672\Model\SubLevel3::class, 'json', $context));
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('subLevel3') && null !== $data->getSubLevel3()) {
            $dataArray['subLevel-3'] = $data->getSubLevel3() === null ? null : new \Jane\Component\OpenApi3\Tests\Expected\Issue672\Runtime\JsonObject($this->normalizer->normalize($data->getSubLevel3(), 'json', $context));
        }
