...
class Endpoint3GetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\Tests\Expected\Issue672\Model\Endpoint3GetResponse200::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Component\OpenApi3\Tests\Expected\Issue672\Model\Endpoint3GetResponse200::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Component\OpenApi3\Tests\Expected\Issue672\Model\Endpoint3GetResponse200();
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('field3', get_object_vars($data)) && null !== ($data->field3 ?? null)) {
            $dataArray['field-3'] = $data->field3 ?? null;
        }
    ...
    {
        return [\Jane\Component\OpenApi3\Tests\Expected\Issue672\Model\Endpoint3GetResponse200::class => false];
    }
}