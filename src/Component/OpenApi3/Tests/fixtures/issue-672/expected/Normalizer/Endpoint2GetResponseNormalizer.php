...
class Endpoint2GetResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('field-2', $data)) {
            $object->setField2($this->denormalizer->denormalize($data['field-2'], \Jane\Component\OpenApi3\Tests\Expected\Issue672\Model\SubLevel1::class, 'json', $context));
            unset($data['field-2']);
        }
        if (\array_key_exists('field-2-bis', $data)) {
            $object->setField2Bis($this->denormalizer->denormalize($data['field-2-bis'], \Jane\Component\OpenApi3\Tests\Expected\Issue672\Model\SubLevel2::class, 'json', $context));
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('field2') && null !== $data->getField2()) {
            $dataArray['field-2'] = $data->getField2() === null ? null : new \Jane\Component\OpenApi3\Tests\Expected\Issue672\Runtime\JsonObject($this->normalizer->normalize($data->getField2(), 'json', $context));
        }
        if ($data->isInitialized('field2Bis') && null !== $data->getField2Bis()) {
            $dataArray['field-2-bis'] = $data->getField2Bis() === null ? null : new \Jane\Component\OpenApi3\Tests\Expected\Issue672\Runtime\JsonObject($this->normalizer->normalize($data->getField2Bis(), 'json', $context));
        }
