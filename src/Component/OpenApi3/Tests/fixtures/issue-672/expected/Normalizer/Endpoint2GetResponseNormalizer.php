...
class Endpoint2GetResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('field2', get_object_vars($data)) && null !== ($data->field2 ?? null)) {
            $dataArray['field-2'] = $data->field2 === null ? null : new \Jane\Component\OpenApi3\Tests\Expected\Issue672\Runtime\JsonObject($this->normalizer->normalize($data->field2, 'json', $context));
        }
        if (array_key_exists('field2Bis', get_object_vars($data)) && null !== ($data->field2Bis ?? null)) {
            $dataArray['field-2-bis'] = $data->field2Bis === null ? null : new \Jane\Component\OpenApi3\Tests\Expected\Issue672\Runtime\JsonObject($this->normalizer->normalize($data->field2Bis, 'json', $context));
        }
