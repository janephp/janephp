...
class TestGetBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('bar', get_object_vars($data)) && null !== ($data->bar ?? null)) {
            ...
            $dataArray['Bar'] = \is_iterable($normalized) ? new \Jane\Component\OpenApi3\Tests\Expected\NoReferenceBody\Runtime\JsonObject($normalized) : $normalized;
        }
        if (array_key_exists('baz', get_object_vars($data)) && null !== ($data->baz ?? null)) {
            ...
            $dataArray['Baz'] = \is_iterable($normalized_1) ? new \Jane\Component\OpenApi3\Tests\Expected\NoReferenceBody\Runtime\JsonObject($normalized_1) : $normalized_1;
        }
