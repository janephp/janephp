...
class Client extends \Jane\Component\OpenApi3\Tests\Expected\Runtime\Client\Client
{
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi3\Tests\Expected\Endpoint\TestReferenceResponse());
    }
    /**
     *
     * @return null|array
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi3\Tests\Expected\Endpoint\TestRefArray());
    }
