...
class GbPeopleReportReponseReportDirectorshipsPreviousItem implements AdditionalPropertiesInterface
{
    ...
    {
        return ['companyName' => ['companyName', 'getCompanyName', 'setCompanyName'], 'companyRegistrationNumber' => ['companyRegistrationNumber', 'getCompanyRegistrationNumber', 'setCompanyRegistrationNumber'], 'status' => ['status', 'getStatus', 'setStatus'], 'position' => ['position', 'getPosition', 'setPosition'], 'companyRegistrationDate' => ['companyRegistrationDate', 'getCompanyRegistrationDate', 'setCompanyRegistrationDate'], 'latestTurnoverFigure' => ['latestTurnoverFigure', 'getLatestTurnoverFigure', 'setLatestTurnoverFigure'], 'netWorth' => ['netWorth', 'getNetWorth', 'setNetWorth'], 'legalCount' => ['legalCount', 'getLegalCount', 'setLegalCount'], 'creditScore' => ['creditScore', 'getCreditScore', 'setCreditScore'], 'additionalData' => ['additionalData', 'getAdditionalData', 'setAdditionalData']];
    }
}