...
class BankMatchValidate implements AdditionalPropertiesInterface
{
    ...
    {
        return ['accountNumber' => 'accountNumber', 'iban' => 'iban', 'ibanResult' => 'ibanResult', 'ibanText' => 'ibanText', 'logDate' => 'logDate', 'safeNumber' => 'safeNumber', 'scanResult' => 'scanResult', 'scanText' => 'scanText', 'sortCode' => 'sortCode', 'statusResult' => 'statusResult', 'statusText' => 'statusText', 'vatResult' => 'vatResult', 'vatText' => 'vatText'];
    }
}