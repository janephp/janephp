...
class ComplianceSearchResultDataBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('searchResult', $data)) {
            $object->searchResult = $this->denormalizer->denormalize($data['searchResult'], \CreditSafe\API\Model\ComplianceSearchResultDataBodySearchResult::class, 'json', $context);
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('searchResult', get_object_vars($data)) && null !== ($data->searchResult ?? null)) {
            $normalized = $this->normalizer->normalize($data->searchResult, 'json', $context);
            $dataArray['searchResult'] = \is_iterable($normalized) ? new \CreditSafe\API\Runtime\JsonObject($normalized) : $normalized;
        }
