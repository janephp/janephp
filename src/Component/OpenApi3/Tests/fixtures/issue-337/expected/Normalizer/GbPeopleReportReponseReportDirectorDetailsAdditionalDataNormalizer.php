...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class GbPeopleReportReponseReportDirectorDetailsAdditionalDataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'CreditSafe\\API\\Model\\GbPeopleReportReponseReportDirectorDetailsAdditionalData';
        }
        ...
        {
            return ['CreditSafe\\API\\Model\\GbPeopleReportReponseReportDirectorDetailsAdditionalData' => false];
        }
    }
} else {
    class GbPeopleReportReponseReportDirectorDetailsAdditionalDataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
