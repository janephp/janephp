...
class GbPeopleReportReponseReportDirectorshipsPreviousItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('position', $data)) {
            $object->position = $this->denormalizer->denormalize($data['position'], \CreditSafe\API\Model\GbPeopleReportReponseReportDirectorshipsPreviousItemPosition::class, 'json', $context);
            unset($data['position']);
        }
        ...
        if (\array_key_exists('latestTurnoverFigure', $data)) {
            $object->latestTurnoverFigure = $this->denormalizer->denormalize($data['latestTurnoverFigure'], \CreditSafe\API\Model\GbPeopleReportReponseReportDirectorshipsPreviousItemLatestTurnoverFigure::class, 'json', $context);
            unset($data['latestTurnoverFigure']);
        }
        if (\array_key_exists('netWorth', $data)) {
            $object->netWorth = $this->denormalizer->denormalize($data['netWorth'], \CreditSafe\API\Model\GbPeopleReportReponseReportDirectorshipsPreviousItemNetWorth::class, 'json', $context);
            unset($data['netWorth']);
        }
        ...
        if (\array_key_exists('creditScore', $data)) {
            $object->creditScore = $this->denormalizer->denormalize($data['creditScore'], \CreditSafe\API\Model\GbPeopleReportReponseReportDirectorshipsPreviousItemCreditScore::class, 'json', $context);
            unset($data['creditScore']);
        }
        if (\array_key_exists('additionalData', $data)) {
            $object->additionalData = $this->denormalizer->denormalize($data['additionalData'], \CreditSafe\API\Model\GbPeopleReportReponseReportDirectorshipsPreviousItemAdditionalData::class, 'json', $context);
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('latestTurnoverFigure', get_object_vars($data)) && null !== ($data->latestTurnoverFigure ?? null)) {
            $normalized_1 = $this->normalizer->normalize($data->latestTurnoverFigure, 'json', $context);
            $dataArray['latestTurnoverFigure'] = \is_iterable($normalized_1) ? new \CreditSafe\API\Runtime\JsonObject($normalized_1) : $normalized_1;
        }
        if (array_key_exists('netWorth', get_object_vars($data)) && null !== ($data->netWorth ?? null)) {
            $normalized_2 = $this->normalizer->normalize($data->netWorth, 'json', $context);
            $dataArray['netWorth'] = \is_iterable($normalized_2) ? new \CreditSafe\API\Runtime\JsonObject($normalized_2) : $normalized_2;
        }
        ...
        if (array_key_exists('creditScore', get_object_vars($data)) && null !== ($data->creditScore ?? null)) {
            $normalized_3 = $this->normalizer->normalize($data->creditScore, 'json', $context);
            $dataArray['creditScore'] = \is_iterable($normalized_3) ? new \CreditSafe\API\Runtime\JsonObject($normalized_3) : $normalized_3;
        }
        if (array_key_exists('additionalData', get_object_vars($data)) && null !== ($data->additionalData ?? null)) {
            $normalized_4 = $this->normalizer->normalize($data->additionalData, 'json', $context);
            $dataArray['additionalData'] = \is_iterable($normalized_4) ? new \CreditSafe\API\Runtime\JsonObject($normalized_4) : $normalized_4;
        }
