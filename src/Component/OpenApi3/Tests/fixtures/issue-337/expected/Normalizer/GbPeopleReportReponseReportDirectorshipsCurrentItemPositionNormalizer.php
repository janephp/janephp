...
class GbPeopleReportReponseReportDirectorshipsCurrentItemPositionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'CreditSafe\\API\\Model\\GbPeopleReportReponseReportDirectorshipsCurrentItemPosition';
    }
    ...
    {
        return array('CreditSafe\\API\\Model\\GbPeopleReportReponseReportDirectorshipsCurrentItemPosition' => false);
    }
}