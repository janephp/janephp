...
namespace Jane\Component\OpenApi3\Tests\ArrayItemsValidation;
...
class Client extends \Jane\Component\OpenApi3\Tests\ArrayItemsValidation\Runtime\Client\Client
{
    public static function create(?\Psr\Http\Client\ClientInterface $httpClient = null, array $additionalPlugins = [], array $additionalNormalizers = [])
    {
        ...
        $normalizers = [new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \Jane\Component\OpenApi3\Tests\ArrayItemsValidation\Normalizer\JaneObjectNormalizer()];
