...
class ConnectionPool implements AdditionalPropertiesInterface
{
     ...
     */
    public ConnectionPoolConnection $connection;
    /**
     * @var ConnectionPoolPrivateConnection
     */
    public ConnectionPoolPrivateConnection $privateConnection;
    /**
     * @var ConnectionPoolStandbyConnection
     */
    public ConnectionPoolStandbyConnection $standbyConnection;
    /**
     * @var ConnectionPoolStandbyPrivateConnection
     */
    public ConnectionPoolStandbyPrivateConnection $standbyPrivateConnection;
    public function definedProperties(): array
    {
        return ['name' => 'name', 'mode' => 'mode', 'size' => 'size', 'db' => 'db', 'user' => 'user', 'connection' => 'connection', 'privateConnection' => 'private_connection', 'standbyConnection' => 'standby_connection', 'standbyPrivateConnection' => 'standby_private_connection'];
    }
}