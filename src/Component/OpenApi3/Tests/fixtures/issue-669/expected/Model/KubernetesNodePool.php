...
class KubernetesNodePool implements AdditionalPropertiesInterface
{
    ...
    {
        return ['size' => 'size', 'id' => 'id', 'name' => 'name', 'count' => 'count', 'tags' => 'tags', 'labels' => 'labels', 'taints' => 'taints', 'autoScale' => 'auto_scale', 'minNodes' => 'min_nodes', 'maxNodes' => 'max_nodes', 'nodes' => 'nodes'];
    }
}