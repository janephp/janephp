...
class Project implements AdditionalPropertiesInterface
{
    ...
    {
        return ['id' => 'id', 'ownerUuid' => 'owner_uuid', 'ownerId' => 'owner_id', 'name' => 'name', 'description' => 'description', 'purpose' => 'purpose', 'environment' => 'environment', 'createdAt' => 'created_at', 'updatedAt' => 'updated_at', 'isDefault' => 'is_default'];
    }
}