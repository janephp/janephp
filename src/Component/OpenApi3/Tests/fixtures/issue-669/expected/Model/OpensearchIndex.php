...
class OpensearchIndex implements AdditionalPropertiesInterface
{
    ...
    {
        return ['indexName' => 'index_name', 'numberOfShards' => 'number_of_shards', 'numberOfReplicas' => 'number_of_replicas', 'size' => 'size', 'createdTime' => 'created_time', 'status' => 'status', 'health' => 'health'];
    }
}