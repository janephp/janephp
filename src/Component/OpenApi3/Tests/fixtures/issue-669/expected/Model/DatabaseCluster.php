...
class DatabaseCluster implements AdditionalPropertiesInterface
{
     ...
     *
     * @var DatabaseClusterUiConnection
     */
    protected $uiConnection;
    /**
     * The connection details for Schema Registry.
     *
     * @var DatabaseClusterSchemaRegistryConnection
     */
    protected $schemaRegistryConnection;
    /**
     * @var DatabaseClusterConnection
     */
    protected $connection;
    /**
     * @var DatabaseClusterPrivateConnection
     */
    protected $privateConnection;
    /**
     * @var DatabaseClusterStandbyConnection
     */
    protected $standbyConnection;
    /**
     * @var DatabaseClusterStandbyPrivateConnection
     */
    ...
    protected $users;
    /**
     * @var DatabaseClusterMaintenanceWindow
     */
     ...
     * The connection details for OpenSearch dashboard.
     *
     * @return DatabaseClusterUiConnection
     */
     ...
     * The connection details for OpenSearch dashboard. 
     *
     * @param DatabaseClusterUiConnection $uiConnection
     *
     * @return self
     */
     ...
     * The connection details for Schema Registry.
     *
     * @return DatabaseClusterSchemaRegistryConnection
     */
     ...
     * The connection details for Schema Registry.
     *
     * @param DatabaseClusterSchemaRegistryConnection $schemaRegistryConnection
     *
     * @return self
     */
    ...
    /**
     * @return DatabaseClusterConnection
     */
    ...
    /**
     * @param DatabaseClusterConnection $connection
     *
     * @return self
     */
    ...
    /**
     * @return DatabaseClusterPrivateConnection
     */
    ...
    /**
     * @param DatabaseClusterPrivateConnection $privateConnection
     *
     * @return self
     */
    ...
    /**
     * @return DatabaseClusterStandbyConnection
     */
    ...
    /**
     * @param DatabaseClusterStandbyConnection $standbyConnection
     *
     * @return self
     */
    ...
    /**
     * @return DatabaseClusterStandbyPrivateConnection
     */
    ...
    /**
     * @param DatabaseClusterStandbyPrivateConnection $standbyPrivateConnection
     *
     * @return self
     */
    ...
    /**
     * @param DatabaseClusterMaintenanceWindow $maintenanceWindow
     *
     * @return self
     */
     ...
     * Autoscaling configuration for the database cluster. Currently only supports storage autoscaling. If null, autoscaling is not configured for the cluster.
     *
     * @return DatabaseClusterAutoscale
     */
     ...
     * Autoscaling configuration for the database cluster. Currently only supports storage autoscaling. If null, autoscaling is not configured for the cluster.
     *
     * @param DatabaseClusterAutoscale $autoscale
     *
     * @return self
     */
