...
class ApiLinkAgentFunctionInputPublic implements AdditionalPropertiesInterface
{
    ...
    {
        return ['agentUuid' => 'agent_uuid', 'description' => 'description', 'faasName' => 'faas_name', 'faasNamespace' => 'faas_namespace', 'functionName' => 'function_name', 'inputSchema' => 'input_schema', 'outputSchema' => 'output_schema'];
    }
}