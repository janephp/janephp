...
class ResponseVolumeSnapshots implements AdditionalPropertiesInterface
{
    ...
    {
        return ['snapshots' => ['snapshots', 'getSnapshots', 'setSnapshots'], 'links' => ['links', 'getLinks', 'setLinks'], 'meta' => ['meta', 'getMeta', 'setMeta']];
    }
}