...
class V2DatabasesPostBody implements AdditionalPropertiesInterface
{
     ...
     */
    public DatabaseClusterUiConnection $uiConnection;
    /**
     * The connection details for Schema Registry.
     *
     * @var DatabaseClusterSchemaRegistryConnection
     */
    public DatabaseClusterSchemaRegistryConnection $schemaRegistryConnection;
    /**
     * @var DatabaseClusterConnection
     */
    public DatabaseClusterConnection $connection;
    /**
     * @var DatabaseClusterPrivateConnection
     */
    public DatabaseClusterPrivateConnection $privateConnection;
    /**
     * @var DatabaseClusterStandbyConnection
     */
    public DatabaseClusterStandbyConnection $standbyConnection;
    /**
     * @var DatabaseClusterStandbyPrivateConnection
     */
    public DatabaseClusterStandbyPrivateConnection $standbyPrivateConnection;
    /**
     ...
     */
    public DatabaseClusterMaintenanceWindow $maintenanceWindow;
    /**
