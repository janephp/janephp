...
class RedisAdvancedConfig implements AdditionalPropertiesInterface
{
     ...
     * @var string
     */
    public string $redisMaxmemoryPolicy;
    /**
     * Set output buffer limit for pub / sub clients in MB. The value is the hard limit, the soft limit is 1/4 of the hard limit. When setting the limit, be mindful of the available memory in the selected service plan.
     *
     * @var int
     */
    public int $redisPubsubClientOutputBufferLimit;
    /**
     * Set number of redis databases. Changing this will cause a restart of redis service.
     *
     * @var int
     */
    public int $redisNumberOfDatabases;
    /**
     * Caching IO thread count
     *
     * @var int
     */
    public int $redisIoThreads;
    /**
     * Counter logarithm factor for volatile-lfu and allkeys-lfu maxmemory-policies
     *
     * @var int
     */
    public int $redisLfuLogFactor = 10;
    /**
     * LFU maxmemory-policy counter decay time in minutes
     *
     * @var int
     */
    public int $redisLfuDecayTime = 1;
    /**
     ...
     * @var bool
     */
    public bool $redisSsl = true;
    /**
     * Caching idle connection timeout in seconds
     *
     * @var int
     */
    public int $redisTimeout = 300;
    /**
     ...
     * @var string
     */
    public string $redisNotifyKeyspaceEvents = '';
    /**
     ...
     * @var string
     */
    public string $redisPersistence;
    /**
     ...
     * @var string
     */
    public string $redisAclChannelsDefault;
    public function definedProperties(): array
    {
        return ['redisMaxmemoryPolicy' => 'redis_maxmemory_policy', 'redisPubsubClientOutputBufferLimit' => 'redis_pubsub_client_output_buffer_limit', 'redisNumberOfDatabases' => 'redis_number_of_databases', 'redisIoThreads' => 'redis_io_threads', 'redisLfuLogFactor' => 'redis_lfu_log_factor', 'redisLfuDecayTime' => 'redis_lfu_decay_time', 'redisSsl' => 'redis_ssl', 'redisTimeout' => 'redis_timeout', 'redisNotifyKeyspaceEvents' => 'redis_notify_keyspace_events', 'redisPersistence' => 'redis_persistence', 'redisAclChannelsDefault' => 'redis_acl_channels_default'];
    }
}