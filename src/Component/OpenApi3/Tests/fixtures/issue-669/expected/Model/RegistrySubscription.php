...
class RegistrySubscription implements AdditionalPropertiesInterface
{
    ...
    {
        return ['tier' => ['tier', 'getTier', 'setTier'], 'createdAt' => ['created_at', 'getCreatedAt', 'setCreatedAt'], 'updatedAt' => ['updated_at', 'getUpdatedAt', 'setUpdatedAt']];
    }
}