...
class VolumeFull implements AdditionalPropertiesInterface
{
     ...
     */
    public VolumeFullRegion $region;
    /**
    ...
    {
        return ['id' => 'id', 'dropletIds' => 'droplet_ids', 'name' => 'name', 'description' => 'description', 'sizeGigabytes' => 'size_gigabytes', 'createdAt' => 'created_at', 'tags' => 'tags', 'region' => 'region', 'filesystemType' => 'filesystem_type', 'filesystemLabel' => 'filesystem_label'];
    }
}