...
class Registry implements AdditionalPropertiesInterface
{
     ...
     */
    public RegistrySubscription $subscription;
    public function definedProperties(): array
    {
        return ['name' => 'name', 'createdAt' => 'created_at', 'region' => 'region', 'storageUsageBytes' => 'storage_usage_bytes', 'storageUsageBytesUpdatedAt' => 'storage_usage_bytes_updated_at', 'subscription' => 'subscription'];
    }
}