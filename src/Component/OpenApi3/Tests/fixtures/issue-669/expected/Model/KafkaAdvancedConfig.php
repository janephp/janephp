...
class KafkaAdvancedConfig implements AdditionalPropertiesInterface
{
    ...
    {
        return ['compressionType' => ['compression_type', 'getCompressionType', 'setCompressionType'], 'groupInitialRebalanceDelayMs' => ['group_initial_rebalance_delay_ms', 'getGroupInitialRebalanceDelayMs', 'setGroupInitialRebalanceDelayMs'], 'groupMinSessionTimeoutMs' => ['group_min_session_timeout_ms', 'getGroupMinSessionTimeoutMs', 'setGroupMinSessionTimeoutMs'], 'groupMaxSessionTimeoutMs' => ['group_max_session_timeout_ms', 'getGroupMaxSessionTimeoutMs', 'setGroupMaxSessionTimeoutMs'], 'connectionsMaxIdleMs' => ['connections_max_idle_ms', 'getConnectionsMaxIdleMs', 'setConnectionsMaxIdleMs'], 'maxIncrementalFetchSessionCacheSlots' => ['max_incremental_fetch_session_cache_slots', 'getMaxIncrementalFetchSessionCacheSlots', 'setMaxIncrementalFetchSessionCacheSlots'], 'messageMaxBytes' => ['message_max_bytes', 'getMessageMaxBytes', 'setMessageMaxBytes'], 'offsetsRetentionMinutes' => ['offsets_retention_minutes', 'getOffsetsRetentionMinutes', 'setOffsetsRetentionMinutes'], 'logCleanerDeleteRetentionMs' => ['log_cleaner_delete_retention_ms', 'getLogCleanerDeleteRetentionMs', 'setLogCleanerDeleteRetentionMs'], 'logCleanerMinCleanableRatio' => ['log_cleaner_min_cleanable_ratio', 'getLogCleanerMinCleanableRatio', 'setLogCleanerMinCleanableRatio'], 'logCleanerMaxCompactionLagMs' => ['log_cleaner_max_compaction_lag_ms', 'getLogCleanerMaxCompactionLagMs', 'setLogCleanerMaxCompactionLagMs'], 'logCleanerMinCompactionLagMs' => ['log_cleaner_min_compaction_lag_ms', 'getLogCleanerMinCompactionLagMs', 'setLogCleanerMinCompactionLagMs'], 'logCleanupPolicy' => ['log_cleanup_policy', 'getLogCleanupPolicy', 'setLogCleanupPolicy'], 'logFlushIntervalMessages' => ['log_flush_interval_messages', 'getLogFlushIntervalMessages', 'setLogFlushIntervalMessages'], 'logFlushIntervalMs' => ['log_flush_interval_ms', 'getLogFlushIntervalMs', 'setLogFlushIntervalMs'], 'logIndexIntervalBytes' => ['log_index_interval_bytes', 'getLogIndexIntervalBytes', 'setLogIndexIntervalBytes'], 'logIndexSizeMaxBytes' => ['log_index_size_max_bytes', 'getLogIndexSizeMaxBytes', 'setLogIndexSizeMaxBytes'], 'logMessageDownconversionEnable' => ['log_message_downconversion_enable', 'getLogMessageDownconversionEnable', 'setLogMessageDownconversionEnable'], 'logMessageTimestampType' => ['log_message_timestamp_type', 'getLogMessageTimestampType', 'setLogMessageTimestampType'], 'logMessageTimestampDifferenceMaxMs' => ['log_message_timestamp_difference_max_ms', 'getLogMessageTimestampDifferenceMaxMs', 'setLogMessageTimestampDifferenceMaxMs'], 'logPreallocate' => ['log_preallocate', 'getLogPreallocate', 'setLogPreallocate'], 'logRetentionBytes' => ['log_retention_bytes', 'getLogRetentionBytes', 'setLogRetentionBytes'], 'logRetentionHours' => ['log_retention_hours', 'getLogRetentionHours', 'setLogRetentionHours'], 'logRetentionMs' => ['log_retention_ms', 'getLogRetentionMs', 'setLogRetentionMs'], 'logRollJitterMs' => ['log_roll_jitter_ms', 'getLogRollJitterMs', 'setLogRollJitterMs'], 'logRollMs' => ['log_roll_ms', 'getLogRollMs', 'setLogRollMs'], 'logSegmentBytes' => ['log_segment_bytes', 'getLogSegmentBytes', 'setLogSegmentBytes'], 'logSegmentDeleteDelayMs' => ['log_segment_delete_delay_ms', 'getLogSegmentDeleteDelayMs', 'setLogSegmentDeleteDelayMs'], 'autoCreateTopicsEnable' => ['auto_create_topics_enable', 'getAutoCreateTopicsEnable', 'setAutoCreateTopicsEnable'], 'minInsyncReplicas' => ['min_insync_replicas', 'getMinInsyncReplicas', 'setMinInsyncReplicas'], 'numPartitions' => ['num_partitions', 'getNumPartitions', 'setNumPartitions'], 'defaultReplicationFactor' => ['default_replication_factor', 'getDefaultReplicationFactor', 'setDefaultReplicationFactor'], 'replicaFetchMaxBytes' => ['replica_fetch_max_bytes', 'getReplicaFetchMaxBytes', 'setReplicaFetchMaxBytes'], 'replicaFetchResponseMaxBytes' => ['replica_fetch_response_max_bytes', 'getReplicaFetchResponseMaxBytes', 'setReplicaFetchResponseMaxBytes'], 'maxConnectionsPerIp' => ['max_connections_per_ip', 'getMaxConnectionsPerIp', 'setMaxConnectionsPerIp'], 'producerPurgatoryPurgeIntervalRequests' => ['producer_purgatory_purge_interval_requests', 'getProducerPurgatoryPurgeIntervalRequests', 'setProducerPurgatoryPurgeIntervalRequests'], 'socketRequestMaxBytes' => ['socket_request_max_bytes', 'getSocketRequestMaxBytes', 'setSocketRequestMaxBytes'], 'transactionStateLogSegmentBytes' => ['transaction_state_log_segment_bytes', 'getTransactionStateLogSegmentBytes', 'setTransactionStateLogSegmentBytes'], 'transactionRemoveExpiredTransactionCleanupIntervalMs' => ['transaction_remove_expired_transaction_cleanup_interval_ms', 'getTransactionRemoveExpiredTransactionCleanupIntervalMs', 'setTransactionRemoveExpiredTransactionCleanupIntervalMs'], 'schemaRegistry' => ['schema_registry', 'getSchemaRegistry', 'setSchemaRegistry']];
    }
}