...
class PostgresAdvancedConfig implements AdditionalPropertiesInterface
{
    ...
    {
        return ['autovacuumFreezeMaxAge' => ['autovacuum_freeze_max_age', 'getAutovacuumFreezeMaxAge', 'setAutovacuumFreezeMaxAge'], 'autovacuumMaxWorkers' => ['autovacuum_max_workers', 'getAutovacuumMaxWorkers', 'setAutovacuumMaxWorkers'], 'autovacuumNaptime' => ['autovacuum_naptime', 'getAutovacuumNaptime', 'setAutovacuumNaptime'], 'autovacuumVacuumThreshold' => ['autovacuum_vacuum_threshold', 'getAutovacuumVacuumThreshold', 'setAutovacuumVacuumThreshold'], 'autovacuumAnalyzeThreshold' => ['autovacuum_analyze_threshold', 'getAutovacuumAnalyzeThreshold', 'setAutovacuumAnalyzeThreshold'], 'autovacuumVacuumScaleFactor' => ['autovacuum_vacuum_scale_factor', 'getAutovacuumVacuumScaleFactor', 'setAutovacuumVacuumScaleFactor'], 'autovacuumAnalyzeScaleFactor' => ['autovacuum_analyze_scale_factor', 'getAutovacuumAnalyzeScaleFactor', 'setAutovacuumAnalyzeScaleFactor'], 'autovacuumVacuumCostDelay' => ['autovacuum_vacuum_cost_delay', 'getAutovacuumVacuumCostDelay', 'setAutovacuumVacuumCostDelay'], 'autovacuumVacuumCostLimit' => ['autovacuum_vacuum_cost_limit', 'getAutovacuumVacuumCostLimit', 'setAutovacuumVacuumCostLimit'], 'backupHour' => ['backup_hour', 'getBackupHour', 'setBackupHour'], 'backupMinute' => ['backup_minute', 'getBackupMinute', 'setBackupMinute'], 'bgwriterDelay' => ['bgwriter_delay', 'getBgwriterDelay', 'setBgwriterDelay'], 'bgwriterFlushAfter' => ['bgwriter_flush_after', 'getBgwriterFlushAfter', 'setBgwriterFlushAfter'], 'bgwriterLruMaxpages' => ['bgwriter_lru_maxpages', 'getBgwriterLruMaxpages', 'setBgwriterLruMaxpages'], 'bgwriterLruMultiplier' => ['bgwriter_lru_multiplier', 'getBgwriterLruMultiplier', 'setBgwriterLruMultiplier'], 'deadlockTimeout' => ['deadlock_timeout', 'getDeadlockTimeout', 'setDeadlockTimeout'], 'defaultToastCompression' => ['default_toast_compression', 'getDefaultToastCompression', 'setDefaultToastCompression'], 'idleInTransactionSessionTimeout' => ['idle_in_transaction_session_timeout', 'getIdleInTransactionSessionTimeout', 'setIdleInTransactionSessionTimeout'], 'jit' => ['jit', 'getJit', 'setJit'], 'logAutovacuumMinDuration' => ['log_autovacuum_min_duration', 'getLogAutovacuumMinDuration', 'setLogAutovacuumMinDuration'], 'logErrorVerbosity' => ['log_error_verbosity', 'getLogErrorVerbosity', 'setLogErrorVerbosity'], 'logLinePrefix' => ['log_line_prefix', 'getLogLinePrefix', 'setLogLinePrefix'], 'logMinDurationStatement' => ['log_min_duration_statement', 'getLogMinDurationStatement', 'setLogMinDurationStatement'], 'maxFilesPerProcess' => ['max_files_per_process', 'getMaxFilesPerProcess', 'setMaxFilesPerProcess'], 'maxPreparedTransactions' => ['max_prepared_transactions', 'getMaxPreparedTransactions', 'setMaxPreparedTransactions'], 'maxPredLocksPerTransaction' => ['max_pred_locks_per_transaction', 'getMaxPredLocksPerTransaction', 'setMaxPredLocksPerTransaction'], 'maxLocksPerTransaction' => ['max_locks_per_transaction', 'getMaxLocksPerTransaction', 'setMaxLocksPerTransaction'], 'maxStackDepth' => ['max_stack_depth', 'getMaxStackDepth', 'setMaxStackDepth'], 'maxStandbyArchiveDelay' => ['max_standby_archive_delay', 'getMaxStandbyArchiveDelay', 'setMaxStandbyArchiveDelay'], 'maxStandbyStreamingDelay' => ['max_standby_streaming_delay', 'getMaxStandbyStreamingDelay', 'setMaxStandbyStreamingDelay'], 'maxReplicationSlots' => ['max_replication_slots', 'getMaxReplicationSlots', 'setMaxReplicationSlots'], 'maxLogicalReplicationWorkers' => ['max_logical_replication_workers', 'getMaxLogicalReplicationWorkers', 'setMaxLogicalReplicationWorkers'], 'maxParallelWorkers' => ['max_parallel_workers', 'getMaxParallelWorkers', 'setMaxParallelWorkers'], 'maxParallelWorkersPerGather' => ['max_parallel_workers_per_gather', 'getMaxParallelWorkersPerGather', 'setMaxParallelWorkersPerGather'], 'maxWorkerProcesses' => ['max_worker_processes', 'getMaxWorkerProcesses', 'setMaxWorkerProcesses'], 'pgPartmanBgwRole' => ['pg_partman_bgw.role', 'getPgPartmanBgwRole', 'setPgPartmanBgwRole'], 'pgPartmanBgwInterval' => ['pg_partman_bgw.interval', 'getPgPartmanBgwInterval', 'setPgPartmanBgwInterval'], 'pgStatStatementsTrack' => ['pg_stat_statements.track', 'getPgStatStatementsTrack', 'setPgStatStatementsTrack'], 'tempFileLimit' => ['temp_file_limit', 'getTempFileLimit', 'setTempFileLimit'], 'timezone' => ['timezone', 'getTimezone', 'setTimezone'], 'trackActivityQuerySize' => ['track_activity_query_size', 'getTrackActivityQuerySize', 'setTrackActivityQuerySize'], 'trackCommitTimestamp' => ['track_commit_timestamp', 'getTrackCommitTimestamp', 'setTrackCommitTimestamp'], 'trackFunctions' => ['track_functions', 'getTrackFunctions', 'setTrackFunctions'], 'trackIoTiming' => ['track_io_timing', 'getTrackIoTiming', 'setTrackIoTiming'], 'maxWalSenders' => ['max_wal_senders', 'getMaxWalSenders', 'setMaxWalSenders'], 'walSenderTimeout' => ['wal_sender_timeout', 'getWalSenderTimeout', 'setWalSenderTimeout'], 'walWriterDelay' => ['wal_writer_delay', 'getWalWriterDelay', 'setWalWriterDelay'], 'sharedBuffersPercentage' => ['shared_buffers_percentage', 'getSharedBuffersPercentage', 'setSharedBuffersPercentage'], 'pgbouncer' => ['pgbouncer', 'getPgbouncer', 'setPgbouncer'], 'workMem' => ['work_mem', 'getWorkMem', 'setWorkMem'], 'timescaledb' => ['timescaledb', 'getTimescaledb', 'setTimescaledb'], 'synchronousReplication' => ['synchronous_replication', 'getSynchronousReplication', 'setSynchronousReplication'], 'statMonitorEnable' => ['stat_monitor_enable', 'getStatMonitorEnable', 'setStatMonitorEnable'], 'maxFailoverReplicationTimeLag' => ['max_failover_replication_time_lag', 'getMaxFailoverReplicationTimeLag', 'setMaxFailoverReplicationTimeLag'], 'maxConnections' => ['max_connections', 'getMaxConnections', 'setMaxConnections'], 'maxSlotWalKeepSize' => ['max_slot_wal_keep_size', 'getMaxSlotWalKeepSize', 'setMaxSlotWalKeepSize']];
    }
}