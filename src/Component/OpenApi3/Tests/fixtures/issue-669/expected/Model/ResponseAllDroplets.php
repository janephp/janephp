...
class ResponseAllDroplets implements AdditionalPropertiesInterface
{
    ...
    {
        return ['droplets' => ['droplets', 'getDroplets', 'setDroplets'], 'links' => ['links', 'getLinks', 'setLinks'], 'meta' => ['meta', 'getMeta', 'setMeta']];
    }
}