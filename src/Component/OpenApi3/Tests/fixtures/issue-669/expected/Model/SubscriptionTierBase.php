...
class SubscriptionTierBase implements AdditionalPropertiesInterface
{
    ...
    {
        return ['name' => 'name', 'slug' => 'slug', 'includedRepositories' => 'included_repositories', 'includedStorageBytes' => 'included_storage_bytes', 'allowStorageOverage' => 'allow_storage_overage', 'includedBandwidthBytes' => 'included_bandwidth_bytes', 'monthlyPriceInCents' => 'monthly_price_in_cents', 'storageOveragePriceInCents' => 'storage_overage_price_in_cents'];
    }
}