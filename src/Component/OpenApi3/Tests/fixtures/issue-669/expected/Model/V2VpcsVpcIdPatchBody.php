...
class V2VpcsVpcIdPatchBody implements AdditionalPropertiesInterface
{
    ...
    {
        return ['name' => ['name', 'getName', 'setName'], 'description' => ['description', 'getDescription', 'setDescription'], 'default' => ['default', 'getDefault', 'setDefault']];
    }
}