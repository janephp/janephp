...
class DropletMultiCreate implements AdditionalPropertiesInterface
{
    ...
    {
        return ['names' => 'names', 'region' => 'region', 'size' => 'size', 'image' => 'image', 'sshKeys' => 'ssh_keys', 'backups' => 'backups', 'backupPolicy' => 'backup_policy', 'ipv6' => 'ipv6', 'monitoring' => 'monitoring', 'tags' => 'tags', 'userData' => 'user_data', 'privateNetworking' => 'private_networking', 'volumes' => 'volumes', 'vpcUuid' => 'vpc_uuid', 'withDropletAgent' => 'with_droplet_agent'];
    }
}