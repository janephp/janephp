...
class VpcNatGatewayUpdate implements AdditionalPropertiesInterface
{
    ...
    {
        return ['name' => 'name', 'size' => 'size', 'vpcs' => 'vpcs', 'udpTimeoutSeconds' => 'udp_timeout_seconds', 'icmpTimeoutSeconds' => 'icmp_timeout_seconds', 'tcpTimeoutSeconds' => 'tcp_timeout_seconds'];
    }
}