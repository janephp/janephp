...
class ResponseFloatingIpListNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Generated\DigitalOcean\Model\ResponseFloatingIpList::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Generated\DigitalOcean\Model\ResponseFloatingIpList::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Generated\DigitalOcean\Model\ResponseFloatingIpList();
        ...
        if (\array_key_exists('floating_ips', $data)) {
            ...
            foreach ($data['floating_ips'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Jane\Generated\DigitalOcean\Model\FloatingIp::class, 'json', $context);
            }
    ...
    {
        return [\Jane\Generated\DigitalOcean\Model\ResponseFloatingIpList::class => false];
    }
}