...
class ResponseListFirewallsResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Generated\DigitalOcean\Model\ResponseListFirewallsResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Generated\DigitalOcean\Model\ResponseListFirewallsResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Generated\DigitalOcean\Model\ResponseListFirewallsResponse();
    ...
    {
        $dataArray = [];
        if (array_key_exists('firewalls', get_object_vars($data)) && null !== ($data->firewalls ?? null)) {
            $values = [];
            foreach ($data->firewalls as $value) {
                $values_1 = new \Jane\Generated\DigitalOcean\Runtime\JsonObject();
                foreach ($value as $key => $value_1) {
    ...
    {
        return [\Jane\Generated\DigitalOcean\Model\ResponseListFirewallsResponse::class => false];
    }
}