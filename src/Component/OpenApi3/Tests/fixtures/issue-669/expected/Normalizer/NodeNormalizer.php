...
class NodeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('status', $data)) {
            $object->status = $this->denormalizer->denormalize($data['status'], \Jane\Generated\DigitalOcean\Model\NodeStatus::class, 'json', $context);
            unset($data['status']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('status', get_object_vars($data)) && null !== ($data->status ?? null)) {
            $normalized = $this->normalizer->normalize($data->status, 'json', $context);
            $dataArray['status'] = \is_iterable($normalized) ? new \Jane\Generated\DigitalOcean\Runtime\JsonObject($normalized) : $normalized;
        }
