...
class V2MonitoringSinksPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Generated\DigitalOcean\Model\V2MonitoringSinksPostBody::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Generated\DigitalOcean\Model\V2MonitoringSinksPostBody::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Generated\DigitalOcean\Model\V2MonitoringSinksPostBody();
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('destinationUuid', get_object_vars($data)) && null !== ($data->destinationUuid ?? null)) {
            $dataArray['destination_uuid'] = $data->destinationUuid;
        }
    ...
    {
        return [\Jane\Generated\DigitalOcean\Model\V2MonitoringSinksPostBody::class => false];
    }
}