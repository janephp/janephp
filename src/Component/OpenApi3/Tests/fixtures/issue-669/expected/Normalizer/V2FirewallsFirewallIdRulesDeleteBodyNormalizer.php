...
class V2FirewallsFirewallIdRulesDeleteBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Generated\DigitalOcean\Model\V2FirewallsFirewallIdRulesDeleteBody::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Generated\DigitalOcean\Model\V2FirewallsFirewallIdRulesDeleteBody::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Generated\DigitalOcean\Model\V2FirewallsFirewallIdRulesDeleteBody();
    ...
    {
        return [\Jane\Generated\DigitalOcean\Model\V2FirewallsFirewallIdRulesDeleteBody::class => false];
    }
}