...
class DatabaseClusterReadNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('ui_connection', $data)) {
            $object->uiConnection = $this->denormalizer->denormalize($data['ui_connection'], \Jane\Generated\DigitalOcean\Model\DatabaseClusterReadUiConnection::class, 'json', $context);
            unset($data['ui_connection']);
        }
        if (\array_key_exists('schema_registry_connection', $data)) {
            $object->schemaRegistryConnection = $this->denormalizer->denormalize($data['schema_registry_connection'], \Jane\Generated\DigitalOcean\Model\DatabaseClusterReadSchemaRegistryConnection::class, 'json', $context);
            unset($data['schema_registry_connection']);
        }
        if (\array_key_exists('connection', $data)) {
            $object->connection = $this->denormalizer->denormalize($data['connection'], \Jane\Generated\DigitalOcean\Model\DatabaseClusterReadConnection::class, 'json', $context);
            unset($data['connection']);
        }
        if (\array_key_exists('private_connection', $data)) {
            $object->privateConnection = $this->denormalizer->denormalize($data['private_connection'], \Jane\Generated\DigitalOcean\Model\DatabaseClusterReadPrivateConnection::class, 'json', $context);
            unset($data['private_connection']);
        }
        if (\array_key_exists('standby_connection', $data)) {
            $object->standbyConnection = $this->denormalizer->denormalize($data['standby_connection'], \Jane\Generated\DigitalOcean\Model\DatabaseClusterReadStandbyConnection::class, 'json', $context);
            unset($data['standby_connection']);
        }
        if (\array_key_exists('standby_private_connection', $data)) {
            $object->standbyPrivateConnection = $this->denormalizer->denormalize($data['standby_private_connection'], \Jane\Generated\DigitalOcean\Model\DatabaseClusterReadStandbyPrivateConnection::class, 'json', $context);
        ...
        if (\array_key_exists('maintenance_window', $data)) {
            $object->maintenanceWindow = $this->denormalizer->denormalize($data['maintenance_window'], \Jane\Generated\DigitalOcean\Model\DatabaseClusterReadMaintenanceWindow::class, 'json', $context);
