...
class UserNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Generated\DigitalOcean\Model\User::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Generated\DigitalOcean\Model\User::class;
    }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('kubernetesClusterUser', get_object_vars($data)) && null !== ($data->kubernetesClusterUser ?? null)) {
            $normalized = $this->normalizer->normalize($data->kubernetesClusterUser, 'json', $context);
            $dataArray['kubernetes_cluster_user'] = \is_iterable($normalized) ? new \Jane\Generated\DigitalOcean\Runtime\JsonObject($normalized) : $normalized;
        }
    ...
    {
        return [\Jane\Generated\DigitalOcean\Model\User::class => false];
    }
}