...
class ApiUpdateAgentFunctionInputPublicNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Generated\DigitalOcean\Model\ApiUpdateAgentFunctionInputPublic::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Generated\DigitalOcean\Model\ApiUpdateAgentFunctionInputPublic::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Generated\DigitalOcean\Model\ApiUpdateAgentFunctionInputPublic();
        ...
        if (\array_key_exists('function_uuid', $data)) {
            $object->setFunctionUuid($data['function_uuid']);
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('functionUuid') && null !== $data->getFunctionUuid()) {
    ...
    {
        return [\Jane\Generated\DigitalOcean\Model\ApiUpdateAgentFunctionInputPublic::class => false];
    }
}