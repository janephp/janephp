...
class RepositoryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('latest_tag', $data)) {
            $object->latestTag = $this->denormalizer->denormalize($data['latest_tag'], \Jane\Generated\DigitalOcean\Model\RepositoryTag::class, 'json', $context);
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('latestTag', get_object_vars($data)) && null !== ($data->latestTag ?? null)) {
            $normalized = $this->normalizer->normalize($data->latestTag, 'json', $context);
            $dataArray['latest_tag'] = \is_iterable($normalized) ? new \Jane\Generated\DigitalOcean\Runtime\JsonObject($normalized) : $normalized;
        }
