...
class ResponseHistoryEventsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Generated\DigitalOcean\Model\ResponseHistoryEvents::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Generated\DigitalOcean\Model\ResponseHistoryEvents::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Generated\DigitalOcean\Model\ResponseHistoryEvents();
        ...
        if (\array_key_exists('history', $data)) {
            ...
            foreach ($data['history'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Jane\Generated\DigitalOcean\Model\History::class, 'json', $context);
            }
            $object->history = $values;
            unset($data['history']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('history', get_object_vars($data)) && null !== ($data->history ?? null)) {
            $values = [];
            foreach ($data->history ?? null as $value) {
    ...
    {
        return [\Jane\Generated\DigitalOcean\Model\ResponseHistoryEvents::class => false];
    }
}