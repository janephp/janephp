...
class AppWorkerSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('termination', $data)) {
            $object->termination = $this->denormalizer->denormalize($data['termination'], \Jane\Generated\DigitalOcean\Model\AppWorkerSpecTermination::class, 'json', $context);
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('livenessHealthCheck', get_object_vars($data)) && null !== ($data->livenessHealthCheck ?? null)) {
            $normalized_9 = $this->normalizer->normalize($data->livenessHealthCheck, 'json', $context);
            $dataArray['liveness_health_check'] = \is_iterable($normalized_9) ? new \Jane\Generated\DigitalOcean\Runtime\JsonObject($normalized_9) : $normalized_9;
        }
