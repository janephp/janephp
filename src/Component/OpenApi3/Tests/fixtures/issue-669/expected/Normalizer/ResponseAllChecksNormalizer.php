...
class ResponseAllChecksNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Generated\DigitalOcean\Model\ResponseAllChecks::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Generated\DigitalOcean\Model\ResponseAllChecks::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Generated\DigitalOcean\Model\ResponseAllChecks();
    ...
    {
        $dataArray = [];
        if (array_key_exists('checks', get_object_vars($data)) && null !== ($data->checks ?? null)) {
            $values = [];
            foreach ($data->checks as $value) {
                $values_1 = new \Jane\Generated\DigitalOcean\Runtime\JsonObject();
                foreach ($value as $key => $value_1) {
    ...
    {
        return [\Jane\Generated\DigitalOcean\Model\ResponseAllChecks::class => false];
    }
}