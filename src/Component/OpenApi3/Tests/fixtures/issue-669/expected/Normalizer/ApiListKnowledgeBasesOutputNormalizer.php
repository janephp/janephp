...
class ApiListKnowledgeBasesOutputNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Generated\DigitalOcean\Model\ApiListKnowledgeBasesOutput::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Generated\DigitalOcean\Model\ApiListKnowledgeBasesOutput::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Generated\DigitalOcean\Model\ApiListKnowledgeBasesOutput();
        ...
        if (\array_key_exists('knowledge_bases', $data)) {
            ...
            foreach ($data['knowledge_bases'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Jane\Generated\DigitalOcean\Model\ApiKnowledgeBase::class, 'json', $context);
            }
            $object->knowledgeBases = $values;
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('knowledgeBases', get_object_vars($data)) && null !== ($data->knowledgeBases ?? null)) {
            $values = [];
            foreach ($data->knowledgeBases ?? null as $value) {
    ...
    {
        return [\Jane\Generated\DigitalOcean\Model\ApiListKnowledgeBasesOutput::class => false];
    }
}