...
class ResponseAllLoadBalancersNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Generated\DigitalOcean\Model\ResponseAllLoadBalancers::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Generated\DigitalOcean\Model\ResponseAllLoadBalancers::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jane\Generated\DigitalOcean\Model\ResponseAllLoadBalancers();
        ...
        if (\array_key_exists('load_balancers', $data)) {
            ...
            foreach ($data['load_balancers'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Jane\Generated\DigitalOcean\Model\LoadBalancer::class, 'json', $context);
            }
    ...
    {
        return [\Jane\Generated\DigitalOcean\Model\ResponseAllLoadBalancers::class => false];
    }
}