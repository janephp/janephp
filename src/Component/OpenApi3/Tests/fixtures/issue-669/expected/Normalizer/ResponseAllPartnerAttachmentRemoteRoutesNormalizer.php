...
class ResponseAllPartnerAttachmentRemoteRoutesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Generated\DigitalOcean\Model\ResponseAllPartnerAttachmentRemoteRoutes::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Generated\DigitalOcean\Model\ResponseAllPartnerAttachmentRemoteRoutes::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Generated\DigitalOcean\Model\ResponseAllPartnerAttachmentRemoteRoutes();
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('remoteRoutes', get_object_vars($data)) && null !== ($data->remoteRoutes ?? null)) {
            $values = [];
            foreach ($data->remoteRoutes as $value) {
    ...
    {
        return [\Jane\Generated\DigitalOcean\Model\ResponseAllPartnerAttachmentRemoteRoutes::class => false];
    }
}