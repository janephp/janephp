...
class ResponseSshKeysAllNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Generated\DigitalOcean\Model\ResponseSshKeysAll::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Generated\DigitalOcean\Model\ResponseSshKeysAll::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jane\Generated\DigitalOcean\Model\ResponseSshKeysAll();
        ...
        if (\array_key_exists('ssh_keys', $data)) {
            ...
            foreach ($data['ssh_keys'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Jane\Generated\DigitalOcean\Model\SshKeys::class, 'json', $context);
            }
    ...
    {
        return [\Jane\Generated\DigitalOcean\Model\ResponseSshKeysAll::class => false];
    }
}