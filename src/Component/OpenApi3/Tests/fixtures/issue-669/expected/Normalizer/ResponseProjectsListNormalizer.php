...
class ResponseProjectsListNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Generated\DigitalOcean\Model\ResponseProjectsList::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Generated\DigitalOcean\Model\ResponseProjectsList::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Generated\DigitalOcean\Model\ResponseProjectsList();
        ...
        if (\array_key_exists('projects', $data)) {
            ...
            foreach ($data['projects'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Jane\Generated\DigitalOcean\Model\Project::class, 'json', $context);
            }
    ...
    {
        $dataArray = [];
        if (array_key_exists('projects', get_object_vars($data)) && null !== ($data->projects ?? null)) {
            $values = [];
    ...
    {
        return [\Jane\Generated\DigitalOcean\Model\ResponseProjectsList::class => false];
    }
}