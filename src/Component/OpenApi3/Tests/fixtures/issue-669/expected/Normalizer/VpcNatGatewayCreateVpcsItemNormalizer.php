...
class VpcNatGatewayCreateVpcsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Generated\DigitalOcean\Model\VpcNatGatewayCreateVpcsItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Generated\DigitalOcean\Model\VpcNatGatewayCreateVpcsItem::class;
    }
    ...
    {
        return [\Jane\Generated\DigitalOcean\Model\VpcNatGatewayCreateVpcsItem::class => false];
    }
}