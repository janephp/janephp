...
class ApiGetEvaluationRunResultsOutputNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Generated\DigitalOcean\Model\ApiGetEvaluationRunResultsOutput::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Generated\DigitalOcean\Model\ApiGetEvaluationRunResultsOutput::class;
    }
    ...
    {
        return [\Jane\Generated\DigitalOcean\Model\ApiGetEvaluationRunResultsOutput::class => false];
    }
}