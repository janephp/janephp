...
class SearchBehaviorWithAggregationBaseResultOfBusinessRuleTraceLog implements AdditionalPropertiesInterface
{
    ...
    {
        return ['totalResults' => 'totalResults', 'results' => 'results', 'elapsedMilliseconds' => 'elapsedMilliseconds', 'pageToken' => 'pageToken', 'searchString' => 'searchString', 'isSearchStringRewritten' => 'isSearchStringRewritten', 'queryDebugInformation' => 'queryDebugInformation', 'aggregationResults' => 'aggregationResults'];
    }
}