...
class FieldStringArray extends FieldBase implements AdditionalPropertiesInterface
{
    ...
    {
        return ['template' => 'template', 'pattern' => 'pattern', 'minimumLength' => 'minimumLength', 'maximumLength' => 'maximumLength', 'indexAnalyzers' => 'indexAnalyzers', 'simpleSearchAnalyzers' => 'simpleSearchAnalyzers', 'multiLine' => 'multiLine', 'grantedValues' => 'grantedValues', 'boost' => 'boost', 'maximumItems' => 'maximumItems', 'minimumItems' => 'minimumItems'];
    }
}