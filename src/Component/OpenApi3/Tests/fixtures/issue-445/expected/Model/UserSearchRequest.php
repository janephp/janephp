...
class UserSearchRequest implements AdditionalPropertiesInterface
{
    ...
    {
        return ['searchString' => 'searchString', 'searchBehaviors' => 'searchBehaviors', 'filter' => 'filter', 'lifeCycleFilter' => 'lifeCycleFilter', 'userRightsFilter' => 'userRightsFilter', 'aggregationFilters' => 'aggregationFilters', 'includeServiceUser' => 'includeServiceUser', 'editableOnly' => 'editableOnly', 'sort' => 'sort', 'limit' => 'limit', 'pageToken' => 'pageToken', 'debugMode' => 'debugMode', 'aggregators' => 'aggregators'];
    }
}