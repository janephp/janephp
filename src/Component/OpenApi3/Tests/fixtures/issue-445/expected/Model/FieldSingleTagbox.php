...
class FieldSingleTagbox extends FieldBase implements AdditionalPropertiesInterface
{
    ...
    {
        return ['schemaId' => 'schemaId', 'schemaIndexingInfo' => 'schemaIndexingInfo', 'filter' => 'filter', 'listItemCreateTemplate' => 'listItemCreateTemplate', 'viewModeDisplayPatternType' => 'viewModeDisplayPatternType'];
    }
}