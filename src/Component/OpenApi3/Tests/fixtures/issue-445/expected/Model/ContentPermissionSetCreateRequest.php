...
class ContentPermissionSetCreateRequest implements AdditionalPropertiesInterface
{
    ...
    {
        return ['names' => 'names', 'userRolesRights' => 'userRolesRights', 'userRolesPermissionSetRights' => 'userRolesPermissionSetRights', 'exclusive' => 'exclusive', 'requestId' => 'requestId'];
    }
}