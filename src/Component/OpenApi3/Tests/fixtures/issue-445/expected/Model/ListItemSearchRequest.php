...
class ListItemSearchRequest implements AdditionalPropertiesInterface
{
    ...
    {
        return ['searchString' => 'searchString', 'searchBehaviors' => 'searchBehaviors', 'filter' => 'filter', 'aggregationFilters' => 'aggregationFilters', 'includeAllSchemaChildren' => 'includeAllSchemaChildren', 'brokenDependenciesFilter' => 'brokenDependenciesFilter', 'schemaIds' => 'schemaIds', 'searchLanguages' => 'searchLanguages', 'lifeCycleFilter' => 'lifeCycleFilter', 'sort' => 'sort', 'limit' => 'limit', 'pageToken' => 'pageToken', 'debugMode' => 'debugMode', 'resolveBehaviors' => 'resolveBehaviors', 'aggregators' => 'aggregators'];
    }
}