...
class TermsAggregator extends AggregatorBase implements AdditionalPropertiesInterface
{
    ...
    {
        return ['field' => 'field', 'size' => 'size', 'includes' => 'includes', 'excludes' => 'excludes', 'searchString' => 'searchString', 'searchFields' => 'searchFields'];
    }
}