...
class ShareSearchRequest implements AdditionalPropertiesInterface
{
    ...
    {
        return ['searchString' => 'searchString', 'searchBehaviors' => 'searchBehaviors', 'filter' => 'filter', 'aggregationFilters' => 'aggregationFilters', 'limit' => 'limit', 'sort' => 'sort', 'pageToken' => 'pageToken', 'debugMode' => 'debugMode', 'aggregators' => 'aggregators'];
    }
}