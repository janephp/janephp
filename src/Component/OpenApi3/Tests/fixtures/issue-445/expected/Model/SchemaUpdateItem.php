...
class SchemaUpdateItem implements AdditionalPropertiesInterface
{
    ...
    {
        return ['names' => 'names', 'descriptions' => 'descriptions', 'displayPatterns' => 'displayPatterns', 'fields' => 'fields', 'fieldsOverwrite' => 'fieldsOverwrite', 'aggregations' => 'aggregations', 'sort' => 'sort', 'viewForAll' => 'viewForAll', 'schemaPermissionSetIds' => 'schemaPermissionSetIds', 'layerSchemaIds' => 'layerSchemaIds', 'referencedInContentSchemaIds' => 'referencedInContentSchemaIds', 'id' => 'id'];
    }
}