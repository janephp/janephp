...
class CustomerBoostValuesUpdateTimeoutExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\CustomerBoostValuesUpdateTimeoutException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\CustomerBoostValuesUpdateTimeoutException' => false);
    }
}