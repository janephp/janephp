...
class SearchBehaviorBaseResultOfTransferNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\SearchBehaviorBaseResultOfTransfer';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('results', $data)) {
            ...
            foreach ($data['results'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'PicturePark\\API\\Model\\Transfer', 'json', $context);
            }
    ...
    {
        return array('PicturePark\\API\\Model\\SearchBehaviorBaseResultOfTransfer' => false);
    }
}