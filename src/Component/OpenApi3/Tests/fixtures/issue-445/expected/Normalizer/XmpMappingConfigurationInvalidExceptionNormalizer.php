...
class XmpMappingConfigurationInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('expectedConfiguration', $data) && $data['expectedConfiguration'] !== null) {
            $object->expectedConfiguration = $data['expectedConfiguration'];
            unset($data['expectedConfiguration']);
        }
        elseif (\array_key_exists('expectedConfiguration', $data)) {
            $object->expectedConfiguration = null;
            unset($data['expectedConfiguration']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('expectedConfiguration', get_object_vars($data)) && null !== ($data->expectedConfiguration ?? null)) {
            $dataArray['expectedConfiguration'] = $data->expectedConfiguration;
        }
