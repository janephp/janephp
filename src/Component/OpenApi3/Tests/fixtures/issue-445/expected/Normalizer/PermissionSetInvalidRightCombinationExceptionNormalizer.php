...
class PermissionSetInvalidRightCombinationExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\PermissionSetInvalidRightCombinationException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\PermissionSetInvalidRightCombinationException' => false);
    }
}