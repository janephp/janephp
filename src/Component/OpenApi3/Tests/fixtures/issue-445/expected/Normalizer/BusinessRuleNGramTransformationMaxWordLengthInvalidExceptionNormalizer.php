...
class BusinessRuleNGramTransformationMaxWordLengthInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\BusinessRuleNGramTransformationMaxWordLengthInvalidException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\BusinessRuleNGramTransformationMaxWordLengthInvalidException' => false);
    }
}