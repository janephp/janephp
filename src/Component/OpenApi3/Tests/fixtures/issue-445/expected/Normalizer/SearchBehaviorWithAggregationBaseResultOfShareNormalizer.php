...
class SearchBehaviorWithAggregationBaseResultOfShareNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\SearchBehaviorWithAggregationBaseResultOfShare';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\SearchBehaviorWithAggregationBaseResultOfShare' => false);
    }
}