...
class OutdatedMetadataUpdateInProgressExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\OutdatedMetadataUpdateInProgressException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\OutdatedMetadataUpdateInProgressException' => false);
    }
}