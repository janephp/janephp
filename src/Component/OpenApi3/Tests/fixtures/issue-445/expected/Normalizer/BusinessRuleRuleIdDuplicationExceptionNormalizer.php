...
class BusinessRuleRuleIdDuplicationExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\BusinessRuleRuleIdDuplicationException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\BusinessRuleRuleIdDuplicationException' => false);
    }
}