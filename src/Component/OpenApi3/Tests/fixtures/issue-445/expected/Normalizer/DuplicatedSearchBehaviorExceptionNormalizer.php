...
class DuplicatedSearchBehaviorExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('duplicatedSearchBehaviors', $data) && $data['duplicatedSearchBehaviors'] !== null) {
            $object->duplicatedSearchBehaviors = $data['duplicatedSearchBehaviors'];
            unset($data['duplicatedSearchBehaviors']);
        }
        elseif (\array_key_exists('duplicatedSearchBehaviors', $data)) {
            $object->duplicatedSearchBehaviors = null;
            unset($data['duplicatedSearchBehaviors']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('duplicatedSearchBehaviors', get_object_vars($data)) && null !== ($data->duplicatedSearchBehaviors ?? null)) {
            $dataArray['duplicatedSearchBehaviors'] = $data->duplicatedSearchBehaviors;
        }
