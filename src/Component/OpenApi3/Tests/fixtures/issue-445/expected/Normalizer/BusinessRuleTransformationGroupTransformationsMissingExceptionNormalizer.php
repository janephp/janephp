...
class BusinessRuleTransformationGroupTransformationsMissingExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\BusinessRuleTransformationGroupTransformationsMissingException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\BusinessRuleTransformationGroupTransformationsMissingException' => false);
    }
}