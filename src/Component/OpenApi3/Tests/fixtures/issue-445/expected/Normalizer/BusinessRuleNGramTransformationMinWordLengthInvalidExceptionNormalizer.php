...
class BusinessRuleNGramTransformationMinWordLengthInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\BusinessRuleNGramTransformationMinWordLengthInvalidException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\BusinessRuleNGramTransformationMinWordLengthInvalidException' => false);
    }
}