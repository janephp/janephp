...
class ContentFileReplaceTypeMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('originalContentType', $data)) {
            $object->originalContentType = $data['originalContentType'];
            unset($data['originalContentType']);
        }
        if (\array_key_exists('newContentType', $data)) {
            $object->newContentType = $data['newContentType'];
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('originalContentType', get_object_vars($data)) && null !== ($data->originalContentType ?? null)) {
            $dataArray['originalContentType'] = $data->originalContentType ?? null;
        }
        if (array_key_exists('newContentType', get_object_vars($data)) && null !== ($data->newContentType ?? null)) {
            $dataArray['newContentType'] = $data->newContentType ?? null;
        }
