...
class UserNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('missingUserId', $data) && $data['missingUserId'] !== null) {
            $object->missingUserId = $data['missingUserId'];
            unset($data['missingUserId']);
        }
        elseif (\array_key_exists('missingUserId', $data)) {
            $object->missingUserId = null;
            unset($data['missingUserId']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('missingUserId', get_object_vars($data)) && null !== ($data->missingUserId ?? null)) {
            $dataArray['missingUserId'] = $data->missingUserId;
        }
