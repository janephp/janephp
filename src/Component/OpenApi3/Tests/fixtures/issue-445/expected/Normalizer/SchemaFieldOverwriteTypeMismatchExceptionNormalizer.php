...
class SchemaFieldOverwriteTypeMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('fieldOverwriteType', $data) && $data['fieldOverwriteType'] !== null) {
            $object->fieldOverwriteType = $data['fieldOverwriteType'];
            unset($data['fieldOverwriteType']);
        }
        elseif (\array_key_exists('fieldOverwriteType', $data)) {
            $object->fieldOverwriteType = null;
            unset($data['fieldOverwriteType']);
        }
        if (\array_key_exists('fieldType', $data) && $data['fieldType'] !== null) {
            $object->fieldType = $data['fieldType'];
            unset($data['fieldType']);
        }
        elseif (\array_key_exists('fieldType', $data)) {
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('fieldOverwriteType', get_object_vars($data)) && null !== ($data->fieldOverwriteType ?? null)) {
            $dataArray['fieldOverwriteType'] = $data->fieldOverwriteType;
        }
        if (array_key_exists('fieldType', get_object_vars($data)) && null !== ($data->fieldType ?? null)) {
            $dataArray['fieldType'] = $data->fieldType;
        }
