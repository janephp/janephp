...
class DuplicateAggregatorExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('aggregatorName', $data) && $data['aggregatorName'] !== null) {
            $object->aggregatorName = $data['aggregatorName'];
            unset($data['aggregatorName']);
        }
        elseif (\array_key_exists('aggregatorName', $data)) {
            $object->aggregatorName = null;
            unset($data['aggregatorName']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('aggregatorName', get_object_vars($data)) && null !== ($data->aggregatorName ?? null)) {
            $dataArray['aggregatorName'] = $data->aggregatorName;
        }
