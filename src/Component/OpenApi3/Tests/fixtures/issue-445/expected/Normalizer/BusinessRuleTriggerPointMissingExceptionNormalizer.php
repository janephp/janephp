...
class BusinessRuleTriggerPointMissingExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\BusinessRuleTriggerPointMissingException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\BusinessRuleTriggerPointMissingException' => false);
    }
}