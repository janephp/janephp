...
class EnvironmentProcessWaitTimeoutExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('environmentProcessId', $data) && $data['environmentProcessId'] !== null) {
            $object->environmentProcessId = $data['environmentProcessId'];
            unset($data['environmentProcessId']);
        }
        elseif (\array_key_exists('environmentProcessId', $data)) {
            $object->environmentProcessId = null;
            unset($data['environmentProcessId']);
        }
        if (\array_key_exists('waitedLifecycles', $data) && $data['waitedLifecycles'] !== null) {
            $object->waitedLifecycles = $data['waitedLifecycles'];
            unset($data['waitedLifecycles']);
        }
        elseif (\array_key_exists('waitedLifecycles', $data)) {
            $object->waitedLifecycles = null;
            unset($data['waitedLifecycles']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('environmentProcessId', get_object_vars($data)) && null !== ($data->environmentProcessId ?? null)) {
            $dataArray['environmentProcessId'] = $data->environmentProcessId;
        }
        if (array_key_exists('waitedLifecycles', get_object_vars($data)) && null !== ($data->waitedLifecycles ?? null)) {
            $dataArray['waitedLifecycles'] = $data->waitedLifecycles;
        }
