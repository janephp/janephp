...
class UserAlreadyInRequestedLockStateExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('userIsLocked', $data)) {
            $object->userIsLocked = $data['userIsLocked'];
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('userIsLocked', get_object_vars($data)) && null !== ($data->userIsLocked ?? null)) {
            $dataArray['userIsLocked'] = $data->userIsLocked;
        }
