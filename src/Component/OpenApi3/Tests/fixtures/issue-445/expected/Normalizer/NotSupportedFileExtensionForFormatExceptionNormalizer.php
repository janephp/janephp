...
class NotSupportedFileExtensionForFormatExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('formatKind', $data) && $data['formatKind'] !== null) {
            $object->formatKind = $data['formatKind'];
            unset($data['formatKind']);
        }
        elseif (\array_key_exists('formatKind', $data)) {
            $object->formatKind = null;
            unset($data['formatKind']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('formatKind', get_object_vars($data)) && null !== ($data->formatKind ?? null)) {
            $dataArray['formatKind'] = $data->formatKind;
        }
