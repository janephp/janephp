...
class ListItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('contentSchemaId', get_object_vars($data)) && null !== ($data->contentSchemaId ?? null)) {
        ...
        if (array_key_exists('displayValues', get_object_vars($data)) && null !== ($data->displayValues ?? null)) {
            ...
            if (is_object($data->displayValues ?? null)) {
                $values = new \PicturePark\API\Runtime\JsonObject();
                foreach ($data->displayValues ?? null as $key => $value_2) {
                    $values[$key] = $value_2;
                }
                $value_1 = $values;
            }
        ...
        if (array_key_exists('content', get_object_vars($data)) && null !== ($data->content ?? null)) {
            $values_1 = new \PicturePark\API\Runtime\JsonObject();
            foreach ($data->content ?? null as $key_1 => $value_3) {
                $values_1[$key_1] = $value_3;
            }
        ...
        if (array_key_exists('brokenRelationTargetIds', get_object_vars($data)) && null !== ($data->brokenRelationTargetIds ?? null)) {
            $values_3 = [];
            foreach ($data->brokenRelationTargetIds ?? null as $value_5) {
                $values_3[] = $value_5;
            }
        ...
        if (array_key_exists('brokenIndirectReferenceIds', get_object_vars($data)) && null !== ($data->brokenIndirectReferenceIds ?? null)) {
            $values_4 = [];
            foreach ($data->brokenIndirectReferenceIds ?? null as $value_6) {
                $values_4[] = $value_6;
            }
