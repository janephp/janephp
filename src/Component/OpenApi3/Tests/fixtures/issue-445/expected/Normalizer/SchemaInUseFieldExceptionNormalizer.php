...
class SchemaInUseFieldExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('fieldNamespaces', get_object_vars($data)) && null !== ($data->fieldNamespaces ?? null)) {
            $values = [];
            foreach ($data->fieldNamespaces ?? null as $value) {
                $values[] = $value;
            }
