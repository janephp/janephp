...
class UnableToMapMultipleClaimTypesIntoSameAttributeExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\UnableToMapMultipleClaimTypesIntoSameAttributeException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\UnableToMapMultipleClaimTypesIntoSameAttributeException' => false);
    }
}