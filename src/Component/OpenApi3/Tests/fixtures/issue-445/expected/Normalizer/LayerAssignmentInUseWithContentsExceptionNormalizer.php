...
class LayerAssignmentInUseWithContentsExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('usedAssignmentSchemaIds', get_object_vars($data)) && null !== ($data->usedAssignmentSchemaIds ?? null)) {
            $values = [];
            foreach ($data->usedAssignmentSchemaIds ?? null as $value) {
                $values[] = $value;
            }
