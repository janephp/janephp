...
class ConfigurationIndexNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('configurationIndex', $data) && $data['configurationIndex'] !== null) {
            $object->configurationIndex = $data['configurationIndex'];
            unset($data['configurationIndex']);
        }
        elseif (\array_key_exists('configurationIndex', $data)) {
            $object->configurationIndex = null;
            unset($data['configurationIndex']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('configurationIndex', get_object_vars($data)) && null !== ($data->configurationIndex ?? null)) {
            $dataArray['configurationIndex'] = $data->configurationIndex;
        }
