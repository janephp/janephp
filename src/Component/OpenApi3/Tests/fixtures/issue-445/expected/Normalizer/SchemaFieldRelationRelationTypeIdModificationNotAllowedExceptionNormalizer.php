...
class SchemaFieldRelationRelationTypeIdModificationNotAllowedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\SchemaFieldRelationRelationTypeIdModificationNotAllowedException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\SchemaFieldRelationRelationTypeIdModificationNotAllowedException' => false);
    }
}