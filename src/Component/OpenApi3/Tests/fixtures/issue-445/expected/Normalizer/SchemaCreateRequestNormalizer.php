...
class SchemaCreateRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $values_3 = [];
        foreach ($data->displayPatterns as $value_5) {
            $normalized = $value_5 === null ? null : $this->normalizer->normalize($value_5, 'json', $context);
        ...
        if (array_key_exists('fields', get_object_vars($data)) && null !== ($data->fields ?? null)) {
            $values_4 = [];
            foreach ($data->fields as $value_6) {
                $normalized_1 = $value_6 === null ? null : $this->normalizer->normalize($value_6, 'json', $context);
                $values_4[] = \is_iterable($normalized_1) ? new \PicturePark\API\Runtime\JsonObject($normalized_1) : $normalized_1;
            }
        ...
        if (array_key_exists('fieldsOverwrite', get_object_vars($data)) && null !== ($data->fieldsOverwrite ?? null)) {
            ...
            foreach ($data->fieldsOverwrite as $value_7) {
                ...
                $values_5[] = \is_iterable($normalized_2) ? new \PicturePark\API\Runtime\JsonObject($normalized_2) : $normalized_2;
            }
        ...
        if (array_key_exists('aggregations', get_object_vars($data)) && null !== ($data->aggregations ?? null)) {
            $values_6 = [];
            foreach ($data->aggregations as $value_8) {
                $normalized_3 = $value_8 === null ? null : $this->normalizer->normalize($value_8, 'json', $context);
                $values_6[] = \is_iterable($normalized_3) ? new \PicturePark\API\Runtime\JsonObject($normalized_3) : $normalized_3;
            }
        ...
        if (array_key_exists('sort', get_object_vars($data)) && null !== ($data->sort ?? null)) {
            $values_7 = [];
            foreach ($data->sort as $value_9) {
                $normalized_4 = $value_9 === null ? null : $this->normalizer->normalize($value_9, 'json', $context);
                $values_7[] = \is_iterable($normalized_4) ? new \PicturePark\API\Runtime\JsonObject($normalized_4) : $normalized_4;
            }
