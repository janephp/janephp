...
class BusinessRuleArrayIndexInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\BusinessRuleArrayIndexInvalidException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\BusinessRuleArrayIndexInvalidException' => false);
    }
}