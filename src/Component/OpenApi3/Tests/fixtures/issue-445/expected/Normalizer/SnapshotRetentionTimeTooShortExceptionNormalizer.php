...
class SnapshotRetentionTimeTooShortExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('snapshotRetentionTime', $data)) {
            $object->snapshotRetentionTime = $data['snapshotRetentionTime'];
            unset($data['snapshotRetentionTime']);
        }
        if (\array_key_exists('minimumRetentionTime', $data)) {
            $object->minimumRetentionTime = $data['minimumRetentionTime'];
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('snapshotRetentionTime', get_object_vars($data)) && null !== ($data->snapshotRetentionTime ?? null)) {
            $dataArray['snapshotRetentionTime'] = $data->snapshotRetentionTime ?? null;
        }
        if (array_key_exists('minimumRetentionTime', get_object_vars($data)) && null !== ($data->minimumRetentionTime ?? null)) {
            $dataArray['minimumRetentionTime'] = $data->minimumRetentionTime ?? null;
        }
