...
class SchemaFieldImportRelatedSchemaMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('importingRelatedSchemaId', $data) && $data['importingRelatedSchemaId'] !== null) {
            $object->importingRelatedSchemaId = $data['importingRelatedSchemaId'];
            unset($data['importingRelatedSchemaId']);
        }
        elseif (\array_key_exists('importingRelatedSchemaId', $data)) {
            $object->importingRelatedSchemaId = null;
            unset($data['importingRelatedSchemaId']);
        }
        if (\array_key_exists('existingRelatedSchemaId', $data) && $data['existingRelatedSchemaId'] !== null) {
            $object->existingRelatedSchemaId = $data['existingRelatedSchemaId'];
            unset($data['existingRelatedSchemaId']);
        }
        elseif (\array_key_exists('existingRelatedSchemaId', $data)) {
            $object->existingRelatedSchemaId = null;
            unset($data['existingRelatedSchemaId']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('importingRelatedSchemaId', get_object_vars($data)) && null !== ($data->importingRelatedSchemaId ?? null)) {
            $dataArray['importingRelatedSchemaId'] = $data->importingRelatedSchemaId;
        }
        if (array_key_exists('existingRelatedSchemaId', get_object_vars($data)) && null !== ($data->existingRelatedSchemaId ?? null)) {
            $dataArray['existingRelatedSchemaId'] = $data->existingRelatedSchemaId;
        }
