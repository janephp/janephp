...
class SchemaFieldRelationTargetDocTypeModificationNotAllowedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\SchemaFieldRelationTargetDocTypeModificationNotAllowedException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\SchemaFieldRelationTargetDocTypeModificationNotAllowedException' => false);
    }
}