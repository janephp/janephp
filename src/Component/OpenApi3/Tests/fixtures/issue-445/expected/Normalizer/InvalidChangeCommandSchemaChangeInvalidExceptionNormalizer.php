...
class InvalidChangeCommandSchemaChangeInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\InvalidChangeCommandSchemaChangeInvalidException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\InvalidChangeCommandSchemaChangeInvalidException' => false);
    }
}