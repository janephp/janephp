...
class BusinessProcessLifeCycleNotHitExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('expected', get_object_vars($data)) && null !== ($data->expected ?? null)) {
            $values = [];
            foreach ($data->expected ?? null as $value) {
                $values[] = $value;
            }
            $dataArray['expected'] = $values;
        }
        if (array_key_exists('actual', get_object_vars($data)) && null !== ($data->actual ?? null)) {
            $dataArray['actual'] = $data->actual ?? null;
        }
