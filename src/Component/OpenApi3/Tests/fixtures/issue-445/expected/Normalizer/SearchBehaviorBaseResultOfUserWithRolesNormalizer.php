...
class SearchBehaviorBaseResultOfUserWithRolesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\SearchBehaviorBaseResultOfUserWithRoles';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\SearchBehaviorBaseResultOfUserWithRoles' => false);
    }
}