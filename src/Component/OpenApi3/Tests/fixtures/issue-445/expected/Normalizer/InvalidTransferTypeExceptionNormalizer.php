...
class InvalidTransferTypeExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('transferType', $data)) {
            $object->transferType = $data['transferType'];
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('transferType', get_object_vars($data)) && null !== ($data->transferType ?? null)) {
            $dataArray['transferType'] = $data->transferType ?? null;
        }
