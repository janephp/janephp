...
class SchemaFieldSchemaIndexInfoSimpleSearchNestingExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('relatedFieldId', $data) && $data['relatedFieldId'] !== null) {
            $object->relatedFieldId = $data['relatedFieldId'];
            unset($data['relatedFieldId']);
        }
        elseif (\array_key_exists('relatedFieldId', $data)) {
            $object->relatedFieldId = null;
            unset($data['relatedFieldId']);
        }
        if (\array_key_exists('relatedOuterFieldId', $data) && $data['relatedOuterFieldId'] !== null) {
            $object->relatedOuterFieldId = $data['relatedOuterFieldId'];
            unset($data['relatedOuterFieldId']);
        }
        elseif (\array_key_exists('relatedOuterFieldId', $data)) {
            $object->relatedOuterFieldId = null;
            unset($data['relatedOuterFieldId']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('relatedFieldId', get_object_vars($data)) && null !== ($data->relatedFieldId ?? null)) {
            $dataArray['relatedFieldId'] = $data->relatedFieldId;
        }
        if (array_key_exists('relatedOuterFieldId', get_object_vars($data)) && null !== ($data->relatedOuterFieldId ?? null)) {
            $dataArray['relatedOuterFieldId'] = $data->relatedOuterFieldId;
        }
