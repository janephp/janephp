...
class BusinessRuleProjectionTransformationsMissingExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\BusinessRuleProjectionTransformationsMissingException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\BusinessRuleProjectionTransformationsMissingException' => false);
    }
}