...
class OperationInProgressExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('leaseResourceType', $data)) {
            $object->leaseResourceType = $data['leaseResourceType'];
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('leaseResourceType', get_object_vars($data)) && null !== ($data->leaseResourceType ?? null)) {
            $dataArray['leaseResourceType'] = $data->leaseResourceType ?? null;
        }
