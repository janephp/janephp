...
class UserPropertyChangeNotSupportedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('propertyPath', $data) && $data['propertyPath'] !== null) {
            $object->propertyPath = $data['propertyPath'];
            unset($data['propertyPath']);
        }
        elseif (\array_key_exists('propertyPath', $data)) {
            $object->propertyPath = null;
            unset($data['propertyPath']);
        }
        if (\array_key_exists('affectedUserId', $data) && $data['affectedUserId'] !== null) {
            $object->affectedUserId = $data['affectedUserId'];
            unset($data['affectedUserId']);
        }
        elseif (\array_key_exists('affectedUserId', $data)) {
            $object->affectedUserId = null;
            unset($data['affectedUserId']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('propertyPath', get_object_vars($data)) && null !== ($data->propertyPath ?? null)) {
            $dataArray['propertyPath'] = $data->propertyPath;
        }
        if (array_key_exists('affectedUserId', get_object_vars($data)) && null !== ($data->affectedUserId ?? null)) {
            $dataArray['affectedUserId'] = $data->affectedUserId;
        }
