...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SearchBehaviorWithAggregationBaseResultOfUserWithRolesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'PicturePark\\API\\Model\\SearchBehaviorWithAggregationBaseResultOfUserWithRoles';
        }
        ...
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            if (\array_key_exists('results', $data)) {
                ...
                foreach ($data['results'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, 'PicturePark\\API\\Model\\UserWithRoles', 'json', $context);
                }
        ...
        {
            return ['PicturePark\\API\\Model\\SearchBehaviorWithAggregationBaseResultOfUserWithRoles' => false];
        }
    }
} else {
    class SearchBehaviorWithAggregationBaseResultOfUserWithRolesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
