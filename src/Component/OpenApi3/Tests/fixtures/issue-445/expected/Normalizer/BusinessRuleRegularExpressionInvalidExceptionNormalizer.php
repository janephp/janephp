...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class BusinessRuleRegularExpressionInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'PicturePark\\API\\Model\\BusinessRuleRegularExpressionInvalidException';
        }
        ...
        {
            return ['PicturePark\\API\\Model\\BusinessRuleRegularExpressionInvalidException' => false];
        }
    }
} else {
    class BusinessRuleRegularExpressionInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
