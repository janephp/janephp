...
class DisplayPatternTypeNotSupportedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\DisplayPatternTypeNotSupportedException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\DisplayPatternTypeNotSupportedException' => false);
    }
}