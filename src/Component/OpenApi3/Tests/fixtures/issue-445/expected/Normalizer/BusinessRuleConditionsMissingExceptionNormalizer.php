...
class BusinessRuleConditionsMissingExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\BusinessRuleConditionsMissingException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\BusinessRuleConditionsMissingException' => false);
    }
}