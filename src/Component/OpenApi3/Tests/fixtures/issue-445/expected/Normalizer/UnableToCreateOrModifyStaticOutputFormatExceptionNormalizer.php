...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class UnableToCreateOrModifyStaticOutputFormatExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'PicturePark\\API\\Model\\UnableToCreateOrModifyStaticOutputFormatException';
        }
        ...
        {
            return ['PicturePark\\API\\Model\\UnableToCreateOrModifyStaticOutputFormatException' => false];
        }
    }
} else {
    class UnableToCreateOrModifyStaticOutputFormatExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
