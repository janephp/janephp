...
class SuperAdminRolesNotAssignableToChannelExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\SuperAdminRolesNotAssignableToChannelException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\SuperAdminRolesNotAssignableToChannelException' => false);
    }
}