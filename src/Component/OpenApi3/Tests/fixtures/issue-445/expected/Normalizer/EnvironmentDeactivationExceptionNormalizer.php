...
class EnvironmentDeactivationExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('deactivationMessage', $data) && $data['deactivationMessage'] !== null) {
            $object->deactivationMessage = $data['deactivationMessage'];
            unset($data['deactivationMessage']);
        }
        elseif (\array_key_exists('deactivationMessage', $data)) {
            $object->deactivationMessage = null;
            unset($data['deactivationMessage']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('deactivationMessage', get_object_vars($data)) && null !== ($data->deactivationMessage ?? null)) {
            $dataArray['deactivationMessage'] = $data->deactivationMessage;
        }
