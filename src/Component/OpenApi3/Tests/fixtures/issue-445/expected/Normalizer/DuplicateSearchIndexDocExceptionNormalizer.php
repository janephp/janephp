...
class DuplicateSearchIndexDocExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('searchIndexDocId', $data) && $data['searchIndexDocId'] !== null) {
            $object->searchIndexDocId = $data['searchIndexDocId'];
            unset($data['searchIndexDocId']);
        }
        elseif (\array_key_exists('searchIndexDocId', $data)) {
            $object->searchIndexDocId = null;
            unset($data['searchIndexDocId']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('searchIndexDocId', get_object_vars($data)) && null !== ($data->searchIndexDocId ?? null)) {
            $dataArray['searchIndexDocId'] = $data->searchIndexDocId;
        }
