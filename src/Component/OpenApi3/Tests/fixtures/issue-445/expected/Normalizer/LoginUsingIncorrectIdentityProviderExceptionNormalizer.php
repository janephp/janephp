...
class LoginUsingIncorrectIdentityProviderExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\LoginUsingIncorrectIdentityProviderException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\LoginUsingIncorrectIdentityProviderException' => false);
    }
}