...
class ListItemNamedCacheSchemaIdInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\ListItemNamedCacheSchemaIdInvalidException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\ListItemNamedCacheSchemaIdInvalidException' => false);
    }
}