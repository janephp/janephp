...
class DuplicatedItemAssignedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        elseif (\array_key_exists('itemId', $data)) {
            $object->itemId = null;
            unset($data['itemId']);
        }
        if (\array_key_exists('itemPath', $data) && $data['itemPath'] !== null) {
            $object->itemPath = $data['itemPath'];
            unset($data['itemPath']);
        }
        elseif (\array_key_exists('itemPath', $data)) {
            $object->itemPath = null;
            unset($data['itemPath']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('itemPath', get_object_vars($data)) && null !== ($data->itemPath ?? null)) {
            $dataArray['itemPath'] = $data->itemPath;
        }
