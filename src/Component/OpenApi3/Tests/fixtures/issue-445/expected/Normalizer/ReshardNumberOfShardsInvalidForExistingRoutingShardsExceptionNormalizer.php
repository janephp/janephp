...
class ReshardNumberOfShardsInvalidForExistingRoutingShardsExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\ReshardNumberOfShardsInvalidForExistingRoutingShardsException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\ReshardNumberOfShardsInvalidForExistingRoutingShardsException' => false);
    }
}