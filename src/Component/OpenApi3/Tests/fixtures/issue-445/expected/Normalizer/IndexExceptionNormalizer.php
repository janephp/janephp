...
class IndexExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('indexName', $data) && $data['indexName'] !== null) {
            $object->indexName = $data['indexName'];
            unset($data['indexName']);
        }
        elseif (\array_key_exists('indexName', $data)) {
            $object->indexName = null;
            unset($data['indexName']);
        }
        if (\array_key_exists('debugInformation', $data) && $data['debugInformation'] !== null) {
            $object->debugInformation = $data['debugInformation'];
            unset($data['debugInformation']);
        }
        elseif (\array_key_exists('debugInformation', $data)) {
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('indexName', get_object_vars($data)) && null !== ($data->indexName ?? null)) {
            $dataArray['indexName'] = $data->indexName;
        }
        if (array_key_exists('debugInformation', get_object_vars($data)) && null !== ($data->debugInformation ?? null)) {
            $dataArray['debugInformation'] = $data->debugInformation;
        }
