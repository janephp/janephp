...
class ListItemSchemaMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('listItemId')) {
            $dataArray['listItemId'] = $data->getListItemId();
        }
        if ($data->isInitialized('listItemSchemaId')) {
            $dataArray['listItemSchemaId'] = $data->getListItemSchemaId();
        }
        if ($data->isInitialized('fieldSchemaId')) {
