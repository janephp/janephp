...
class ListItemSchemaMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('listItemId', $data) && $data['listItemId'] !== null) {
            $object->listItemId = $data['listItemId'];
            unset($data['listItemId']);
        }
        elseif (\array_key_exists('listItemId', $data)) {
            $object->listItemId = null;
            unset($data['listItemId']);
        }
        if (\array_key_exists('listItemSchemaId', $data) && $data['listItemSchemaId'] !== null) {
            $object->listItemSchemaId = $data['listItemSchemaId'];
            unset($data['listItemSchemaId']);
        }
        elseif (\array_key_exists('listItemSchemaId', $data)) {
            $object->listItemSchemaId = null;
            unset($data['listItemSchemaId']);
        }
        if (\array_key_exists('fieldSchemaId', $data) && $data['fieldSchemaId'] !== null) {
            $object->fieldSchemaId = $data['fieldSchemaId'];
            unset($data['fieldSchemaId']);
        }
        elseif (\array_key_exists('fieldSchemaId', $data)) {
            $object->fieldSchemaId = null;
            unset($data['fieldSchemaId']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('listItemId', get_object_vars($data)) && null !== ($data->listItemId ?? null)) {
            $dataArray['listItemId'] = $data->listItemId;
        }
        if (array_key_exists('listItemSchemaId', get_object_vars($data)) && null !== ($data->listItemSchemaId ?? null)) {
            $dataArray['listItemSchemaId'] = $data->listItemSchemaId;
        }
        if (array_key_exists('fieldSchemaId', get_object_vars($data)) && null !== ($data->fieldSchemaId ?? null)) {
            $dataArray['fieldSchemaId'] = $data->fieldSchemaId;
        }
