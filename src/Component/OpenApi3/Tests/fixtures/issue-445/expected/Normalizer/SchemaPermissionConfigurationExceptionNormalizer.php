...
class SchemaPermissionConfigurationExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\SchemaPermissionConfigurationException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\SchemaPermissionConfigurationException' => false);
    }
}