...
class BusinessProcessDefinitionCreateExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('processDefinitionIds', get_object_vars($data)) && null !== ($data->processDefinitionIds ?? null)) {
            $values = [];
            foreach ($data->processDefinitionIds ?? null as $value) {
                $values[] = $value;
            }
