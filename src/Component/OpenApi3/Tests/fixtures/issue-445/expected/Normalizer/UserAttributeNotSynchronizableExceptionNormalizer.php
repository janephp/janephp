...
class UserAttributeNotSynchronizableExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\UserAttributeNotSynchronizableException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\UserAttributeNotSynchronizableException' => false);
    }
}