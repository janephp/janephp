...
class SchemaInheritanceTypeDeviationExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\SchemaInheritanceTypeDeviationException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\SchemaInheritanceTypeDeviationException' => false);
    }
}