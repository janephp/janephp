...
class SchemaMissingTypeExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('expectedSchemaTypes', get_object_vars($data)) && null !== ($data->expectedSchemaTypes ?? null)) {
            $values = [];
            foreach ($data->expectedSchemaTypes ?? null as $value) {
                $values[] = $value;
            }
