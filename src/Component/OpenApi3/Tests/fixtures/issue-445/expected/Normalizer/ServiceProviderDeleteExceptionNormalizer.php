...
class ServiceProviderDeleteExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('detailedErrorMessage', get_object_vars($data)) && null !== ($data->detailedErrorMessage ?? null)) {
            $dataArray['detailedErrorMessage'] = $data->detailedErrorMessage ?? null;
        }
