...
class UnsupportedListItemChangeCommandExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\UnsupportedListItemChangeCommandException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\UnsupportedListItemChangeCommandException' => false);
    }
}