...
class IllegalAuthorizationStateTransitionExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('requestedUserId', $data) && $data['requestedUserId'] !== null) {
            $object->requestedUserId = $data['requestedUserId'];
            unset($data['requestedUserId']);
        }
        elseif (\array_key_exists('requestedUserId', $data)) {
            $object->requestedUserId = null;
            unset($data['requestedUserId']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('requestedUserId', get_object_vars($data)) && null !== ($data->requestedUserId ?? null)) {
            $dataArray['requestedUserId'] = $data->requestedUserId;
        }
        if (array_key_exists('authorizationState', get_object_vars($data)) && null !== ($data->authorizationState ?? null)) {
            $dataArray['authorizationState'] = $data->authorizationState;
        }
        if (array_key_exists('transition', get_object_vars($data)) && null !== ($data->transition ?? null)) {
            $dataArray['transition'] = $data->transition;
        }
