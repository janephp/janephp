...
class DisplayValueRerenderingInProgressExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\DisplayValueRerenderingInProgressException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\DisplayValueRerenderingInProgressException' => false);
    }
}