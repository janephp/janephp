...
class BusinessRulePermissionSetIdInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\BusinessRulePermissionSetIdInvalidException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\BusinessRulePermissionSetIdInvalidException' => false);
    }
}