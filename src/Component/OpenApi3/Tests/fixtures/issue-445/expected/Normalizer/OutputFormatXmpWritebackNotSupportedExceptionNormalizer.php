...
class OutputFormatXmpWritebackNotSupportedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\OutputFormatXmpWritebackNotSupportedException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\OutputFormatXmpWritebackNotSupportedException' => false);
    }
}