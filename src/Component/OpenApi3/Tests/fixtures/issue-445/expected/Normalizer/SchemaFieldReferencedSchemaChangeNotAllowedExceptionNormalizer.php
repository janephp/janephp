...
class SchemaFieldReferencedSchemaChangeNotAllowedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('oldReferencedSchemaId', $data) && $data['oldReferencedSchemaId'] !== null) {
            $object->oldReferencedSchemaId = $data['oldReferencedSchemaId'];
            unset($data['oldReferencedSchemaId']);
        }
        elseif (\array_key_exists('oldReferencedSchemaId', $data)) {
            $object->oldReferencedSchemaId = null;
            unset($data['oldReferencedSchemaId']);
        }
        if (\array_key_exists('newReferencedSchemaId', $data) && $data['newReferencedSchemaId'] !== null) {
            $object->newReferencedSchemaId = $data['newReferencedSchemaId'];
            unset($data['newReferencedSchemaId']);
        }
        elseif (\array_key_exists('newReferencedSchemaId', $data)) {
            $object->newReferencedSchemaId = null;
            unset($data['newReferencedSchemaId']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('oldReferencedSchemaId', get_object_vars($data)) && null !== ($data->oldReferencedSchemaId ?? null)) {
            $dataArray['oldReferencedSchemaId'] = $data->oldReferencedSchemaId;
        }
        if (array_key_exists('newReferencedSchemaId', get_object_vars($data)) && null !== ($data->newReferencedSchemaId ?? null)) {
            $dataArray['newReferencedSchemaId'] = $data->newReferencedSchemaId;
        }
