...
class SearchBehaviorWithAggregationBaseResultOfBusinessRuleTraceLogNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\SearchBehaviorWithAggregationBaseResultOfBusinessRuleTraceLog';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\SearchBehaviorWithAggregationBaseResultOfBusinessRuleTraceLog' => false);
    }
}