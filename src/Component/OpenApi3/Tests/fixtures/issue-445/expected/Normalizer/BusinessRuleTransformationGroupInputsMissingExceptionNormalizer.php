...
class BusinessRuleTransformationGroupInputsMissingExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\BusinessRuleTransformationGroupInputsMissingException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\BusinessRuleTransformationGroupInputsMissingException' => false);
    }
}