...
class UnableToDeleteUserRoleReferencedInIdentityProviderGroupMappingExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\UnableToDeleteUserRoleReferencedInIdentityProviderGroupMappingException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\UnableToDeleteUserRoleReferencedInIdentityProviderGroupMappingException' => false);
    }
}