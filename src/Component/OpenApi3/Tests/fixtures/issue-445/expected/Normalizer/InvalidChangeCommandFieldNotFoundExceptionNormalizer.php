...
class InvalidChangeCommandFieldNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('commandTypeName', $data) && $data['commandTypeName'] !== null) {
            $object->commandTypeName = $data['commandTypeName'];
            unset($data['commandTypeName']);
        }
        elseif (\array_key_exists('commandTypeName', $data)) {
            $object->commandTypeName = null;
            unset($data['commandTypeName']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('commandTypeName', get_object_vars($data)) && null !== ($data->commandTypeName ?? null)) {
            $dataArray['commandTypeName'] = $data->commandTypeName;
        }
