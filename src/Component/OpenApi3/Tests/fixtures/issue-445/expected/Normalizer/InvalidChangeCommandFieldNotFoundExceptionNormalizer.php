...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class InvalidChangeCommandFieldNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'PicturePark\\API\\Model\\InvalidChangeCommandFieldNotFoundException';
        }
        ...
        {
            return ['PicturePark\\API\\Model\\InvalidChangeCommandFieldNotFoundException' => false];
        }
    }
} else {
    class InvalidChangeCommandFieldNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
