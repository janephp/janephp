...
class ListItemPermissionExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('metadataRight', $data)) {
            $object->metadataRight = $data['metadataRight'];
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('metadataRight', get_object_vars($data)) && null !== ($data->metadataRight ?? null)) {
            $dataArray['metadataRight'] = $data->metadataRight;
        }
