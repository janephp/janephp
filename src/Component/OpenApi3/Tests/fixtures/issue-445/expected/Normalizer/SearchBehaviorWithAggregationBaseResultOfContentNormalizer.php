...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SearchBehaviorWithAggregationBaseResultOfContentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'PicturePark\\API\\Model\\SearchBehaviorWithAggregationBaseResultOfContent';
        }
        ...
        {
            return ['PicturePark\\API\\Model\\SearchBehaviorWithAggregationBaseResultOfContent' => false];
        }
    }
} else {
    class SearchBehaviorWithAggregationBaseResultOfContentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
