...
class SchemaInheritanceFieldIndexDeviationExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\SchemaInheritanceFieldIndexDeviationException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\SchemaInheritanceFieldIndexDeviationException' => false);
    }
}