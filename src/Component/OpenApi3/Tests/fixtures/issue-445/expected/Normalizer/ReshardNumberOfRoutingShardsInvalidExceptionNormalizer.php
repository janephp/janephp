...
class ReshardNumberOfRoutingShardsInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\ReshardNumberOfRoutingShardsInvalidException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\ReshardNumberOfRoutingShardsInvalidException' => false);
    }
}