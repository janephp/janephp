...
class SchemaTagboxFilterLookupNamedCacheSchemaIdInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\SchemaTagboxFilterLookupNamedCacheSchemaIdInvalidException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\SchemaTagboxFilterLookupNamedCacheSchemaIdInvalidException' => false);
    }
}