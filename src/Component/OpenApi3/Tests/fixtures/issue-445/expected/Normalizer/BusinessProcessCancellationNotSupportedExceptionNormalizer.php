...
class BusinessProcessCancellationNotSupportedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\BusinessProcessCancellationNotSupportedException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\BusinessProcessCancellationNotSupportedException' => false);
    }
}