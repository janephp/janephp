...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SchemaFieldIdAlreadyExistsInSchemaHierarchyExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'PicturePark\\API\\Model\\SchemaFieldIdAlreadyExistsInSchemaHierarchyException';
        }
        ...
        {
            return ['PicturePark\\API\\Model\\SchemaFieldIdAlreadyExistsInSchemaHierarchyException' => false];
        }
    }
} else {
    class SchemaFieldIdAlreadyExistsInSchemaHierarchyExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
