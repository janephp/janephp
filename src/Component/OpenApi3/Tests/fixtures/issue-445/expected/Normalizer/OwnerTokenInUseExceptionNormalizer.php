...
class OwnerTokenInUseExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('ownerTokenUserId', $data) && $data['ownerTokenUserId'] !== null) {
            $object->ownerTokenUserId = $data['ownerTokenUserId'];
            unset($data['ownerTokenUserId']);
        }
        elseif (\array_key_exists('ownerTokenUserId', $data)) {
            $object->ownerTokenUserId = null;
            unset($data['ownerTokenUserId']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('ownerTokenUserId', get_object_vars($data)) && null !== ($data->ownerTokenUserId ?? null)) {
            $dataArray['ownerTokenUserId'] = $data->ownerTokenUserId;
        }
