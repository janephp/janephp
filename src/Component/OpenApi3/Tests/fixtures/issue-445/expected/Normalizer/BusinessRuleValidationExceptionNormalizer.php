...
class BusinessRuleValidationExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('ruleId', get_object_vars($data)) && null !== ($data->ruleId ?? null)) {
            $dataArray['ruleId'] = $data->ruleId ?? null;
        }
        if (array_key_exists('innerExceptions', get_object_vars($data)) && null !== ($data->innerExceptions ?? null)) {
            $values = [];
            foreach ($data->innerExceptions ?? null as $value) {
