...
class CustomerAliasInUseExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('existingCustomerId', get_object_vars($data)) && null !== ($data->existingCustomerId ?? null)) {
            $dataArray['existingCustomerId'] = $data->existingCustomerId ?? null;
        }
        if (array_key_exists('alias', get_object_vars($data)) && null !== ($data->alias ?? null)) {
            $dataArray['alias'] = $data->alias ?? null;
        }
