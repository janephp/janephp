...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class BusinessRuleNGramTransformationSizeInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'PicturePark\\API\\Model\\BusinessRuleNGramTransformationSizeInvalidException';
        }
        ...
        {
            return ['PicturePark\\API\\Model\\BusinessRuleNGramTransformationSizeInvalidException' => false];
        }
    }
} else {
    class BusinessRuleNGramTransformationSizeInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
