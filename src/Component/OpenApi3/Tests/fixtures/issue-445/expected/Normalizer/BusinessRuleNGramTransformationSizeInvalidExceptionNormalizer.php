...
class BusinessRuleNGramTransformationSizeInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('minSize', $data)) {
            $object->minSize = $data['minSize'];
            unset($data['minSize']);
        }
        if (\array_key_exists('maxSize', $data)) {
            $object->maxSize = $data['maxSize'];
            unset($data['maxSize']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('minSize', get_object_vars($data)) && null !== ($data->minSize ?? null)) {
            $dataArray['minSize'] = $data->minSize ?? null;
        }
        if (array_key_exists('maxSize', get_object_vars($data)) && null !== ($data->maxSize ?? null)) {
            $dataArray['maxSize'] = $data->maxSize ?? null;
        }
