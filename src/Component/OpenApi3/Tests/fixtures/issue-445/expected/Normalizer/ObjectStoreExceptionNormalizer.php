...
class ObjectStoreExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('rowErrorMessages', $data) && $data['rowErrorMessages'] !== null) {
            $object->rowErrorMessages = $data['rowErrorMessages'];
            unset($data['rowErrorMessages']);
        }
        elseif (\array_key_exists('rowErrorMessages', $data)) {
            $object->rowErrorMessages = null;
            unset($data['rowErrorMessages']);
        }
        ...
        elseif (\array_key_exists('errorMessage', $data)) {
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('rowErrorMessages', get_object_vars($data)) && null !== ($data->rowErrorMessages ?? null)) {
            $dataArray['rowErrorMessages'] = $data->rowErrorMessages;
        }
