...
class MissingDependenciesExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('itemIds', $data) && $data['itemIds'] !== null) {
            $object->itemIds = $data['itemIds'];
            unset($data['itemIds']);
        }
        elseif (\array_key_exists('itemIds', $data)) {
            $object->itemIds = null;
            unset($data['itemIds']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('itemIds', get_object_vars($data)) && null !== ($data->itemIds ?? null)) {
            $dataArray['itemIds'] = $data->itemIds;
        }
