...
class SchemaFieldImportTypeMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('importingFieldType', $data) && $data['importingFieldType'] !== null) {
            $object->importingFieldType = $data['importingFieldType'];
            unset($data['importingFieldType']);
        }
        elseif (\array_key_exists('importingFieldType', $data)) {
            $object->importingFieldType = null;
            unset($data['importingFieldType']);
        }
        if (\array_key_exists('existingFieldType', $data) && $data['existingFieldType'] !== null) {
            $object->existingFieldType = $data['existingFieldType'];
            unset($data['existingFieldType']);
        }
        elseif (\array_key_exists('existingFieldType', $data)) {
            $object->existingFieldType = null;
            unset($data['existingFieldType']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('importingFieldType', get_object_vars($data)) && null !== ($data->importingFieldType ?? null)) {
            $dataArray['importingFieldType'] = $data->importingFieldType;
        }
        if (array_key_exists('existingFieldType', get_object_vars($data)) && null !== ($data->existingFieldType ?? null)) {
            $dataArray['existingFieldType'] = $data->existingFieldType;
        }
