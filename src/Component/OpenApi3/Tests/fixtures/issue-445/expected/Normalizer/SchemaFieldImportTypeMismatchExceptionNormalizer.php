...
class SchemaFieldImportTypeMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('importingFieldType') && null !== $data->getImportingFieldType()) {
            $dataArray['importingFieldType'] = $data->getImportingFieldType();
        }
        if ($data->isInitialized('existingFieldType') && null !== $data->getExistingFieldType()) {
            $dataArray['existingFieldType'] = $data->getExistingFieldType();
        }
        foreach ($data as $key => $value) {
            if (preg_match('/.*/', (string) $key)) {
                $dataArray[$key] = $value;
