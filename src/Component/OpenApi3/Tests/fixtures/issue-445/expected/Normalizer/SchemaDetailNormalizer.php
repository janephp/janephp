...
class SchemaDetailNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('searchFieldCount', $data) && $data['searchFieldCount'] !== null) {
            ...
            if (is_array($data['searchFieldCount']) and isset($data['searchFieldCount']['indexedField']) and isset($data['searchFieldCount']['simpleSearchField']) and isset($data['searchFieldCount']['sortableField'])) {
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('sort')) {
            ...
            foreach ($data->getSort() as $value_9) {
                $values_7[] = $this->normalizer->normalize($value_9, 'json', $context);
            }
        ...
        if ($data->isInitialized('aggregations')) {
            ...
            foreach ($data->getAggregations() as $value_10) {
                $values_8[] = $this->normalizer->normalize($value_10, 'json', $context);
            }
        ...
        if ($data->isInitialized('descendantSchemaIds')) {
            $values_11 = [];
        ...
        if ($data->isInitialized('audit')) {
            ...
            if (is_object($data->getAudit())) {
                $value_14 = $this->normalizer->normalize($data->getAudit(), 'json', $context);
            }
            $dataArray['audit'] = $value_14;
        }
        if ($data->isInitialized('searchFieldCount')) {
            $value_15 = $data->getSearchFieldCount();
            if (is_object($data->getSearchFieldCount())) {
                $value_15 = $this->normalizer->normalize($data->getSearchFieldCount(), 'json', $context);
            }
