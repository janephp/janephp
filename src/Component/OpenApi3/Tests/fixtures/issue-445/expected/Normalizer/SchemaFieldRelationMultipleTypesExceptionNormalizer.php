...
class SchemaFieldRelationMultipleTypesExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\SchemaFieldRelationMultipleTypesException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\SchemaFieldRelationMultipleTypesException' => false);
    }
}