...
class ServiceProviderNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('missingServiceProviderId', $data) && $data['missingServiceProviderId'] !== null) {
            $object->missingServiceProviderId = $data['missingServiceProviderId'];
            unset($data['missingServiceProviderId']);
        }
        elseif (\array_key_exists('missingServiceProviderId', $data)) {
            $object->missingServiceProviderId = null;
            unset($data['missingServiceProviderId']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('missingServiceProviderId', get_object_vars($data)) && null !== ($data->missingServiceProviderId ?? null)) {
            $dataArray['missingServiceProviderId'] = $data->missingServiceProviderId;
        }
