...
class ActivityMappingInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('activityMapping', $data) && $data['activityMapping'] !== null) {
            $object->activityMapping = $data['activityMapping'];
            unset($data['activityMapping']);
        }
        elseif (\array_key_exists('activityMapping', $data)) {
            $object->activityMapping = null;
            unset($data['activityMapping']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('activityMapping', get_object_vars($data)) && null !== ($data->activityMapping ?? null)) {
            $dataArray['activityMapping'] = $data->activityMapping;
        }
