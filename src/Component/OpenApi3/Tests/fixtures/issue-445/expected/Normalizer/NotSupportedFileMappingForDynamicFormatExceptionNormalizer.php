...
class NotSupportedFileMappingForDynamicFormatExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('inputExtension', $data) && $data['inputExtension'] !== null) {
            $object->inputExtension = $data['inputExtension'];
            unset($data['inputExtension']);
        }
        elseif (\array_key_exists('inputExtension', $data)) {
            $object->inputExtension = null;
            unset($data['inputExtension']);
        }
        if (\array_key_exists('targetFormatKind', $data) && $data['targetFormatKind'] !== null) {
            $object->targetFormatKind = $data['targetFormatKind'];
            unset($data['targetFormatKind']);
        }
        elseif (\array_key_exists('targetFormatKind', $data)) {
            $object->targetFormatKind = null;
            unset($data['targetFormatKind']);
        }
        if (\array_key_exists('formatId', $data) && $data['formatId'] !== null) {
            $object->formatId = $data['formatId'];
            unset($data['formatId']);
        }
        elseif (\array_key_exists('formatId', $data)) {
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('inputExtension', get_object_vars($data)) && null !== ($data->inputExtension ?? null)) {
            $dataArray['inputExtension'] = $data->inputExtension;
        }
        if (array_key_exists('targetFormatKind', get_object_vars($data)) && null !== ($data->targetFormatKind ?? null)) {
            $dataArray['targetFormatKind'] = $data->targetFormatKind;
        }
        if (array_key_exists('formatId', get_object_vars($data)) && null !== ($data->formatId ?? null)) {
            $dataArray['formatId'] = $data->formatId;
        }
