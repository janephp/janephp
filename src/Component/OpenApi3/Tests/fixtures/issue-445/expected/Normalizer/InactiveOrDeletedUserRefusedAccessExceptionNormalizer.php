...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class InactiveOrDeletedUserRefusedAccessExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'PicturePark\\API\\Model\\InactiveOrDeletedUserRefusedAccessException';
        }
        ...
        {
            return ['PicturePark\\API\\Model\\InactiveOrDeletedUserRefusedAccessException' => false];
        }
    }
} else {
    class InactiveOrDeletedUserRefusedAccessExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
