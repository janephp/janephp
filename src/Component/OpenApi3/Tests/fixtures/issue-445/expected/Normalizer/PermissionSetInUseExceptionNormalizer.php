...
class PermissionSetInUseExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('referenceCount', $data)) {
            $object->referenceCount = $data['referenceCount'];
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('referenceCount', get_object_vars($data)) && null !== ($data->referenceCount ?? null)) {
            $dataArray['referenceCount'] = $data->referenceCount;
        }
