...
class XmpMappingFieldToLayerWithRequiredFieldsNotAllowedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\XmpMappingFieldToLayerWithRequiredFieldsNotAllowedException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\XmpMappingFieldToLayerWithRequiredFieldsNotAllowedException' => false);
    }
}