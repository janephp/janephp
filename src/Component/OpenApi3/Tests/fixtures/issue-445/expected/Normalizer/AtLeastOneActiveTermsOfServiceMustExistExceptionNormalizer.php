...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class AtLeastOneActiveTermsOfServiceMustExistExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'PicturePark\\API\\Model\\AtLeastOneActiveTermsOfServiceMustExistException';
        }
        ...
        {
            return ['PicturePark\\API\\Model\\AtLeastOneActiveTermsOfServiceMustExistException' => false];
        }
    }
} else {
    class AtLeastOneActiveTermsOfServiceMustExistExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
