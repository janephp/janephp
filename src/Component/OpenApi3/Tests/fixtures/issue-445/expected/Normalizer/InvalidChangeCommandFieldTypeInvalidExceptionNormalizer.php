...
class InvalidChangeCommandFieldTypeInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('commandType', $data) && $data['commandType'] !== null) {
            $object->commandType = $data['commandType'];
            unset($data['commandType']);
        }
        elseif (\array_key_exists('commandType', $data)) {
        ...
        if (\array_key_exists('fieldActualType', $data) && $data['fieldActualType'] !== null) {
            $object->fieldActualType = $data['fieldActualType'];
            unset($data['fieldActualType']);
        }
        elseif (\array_key_exists('fieldActualType', $data)) {
            $object->fieldActualType = null;
            unset($data['fieldActualType']);
        }
        if (\array_key_exists('fieldExpectedType', $data) && $data['fieldExpectedType'] !== null) {
            $object->fieldExpectedType = $data['fieldExpectedType'];
            unset($data['fieldExpectedType']);
        }
        elseif (\array_key_exists('fieldExpectedType', $data)) {
            $object->fieldExpectedType = null;
            unset($data['fieldExpectedType']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('commandType', get_object_vars($data)) && null !== ($data->commandType ?? null)) {
            $dataArray['commandType'] = $data->commandType;
        }
        ...
        if (array_key_exists('fieldActualType', get_object_vars($data)) && null !== ($data->fieldActualType ?? null)) {
            $dataArray['fieldActualType'] = $data->fieldActualType;
        }
        if (array_key_exists('fieldExpectedType', get_object_vars($data)) && null !== ($data->fieldExpectedType ?? null)) {
            $dataArray['fieldExpectedType'] = $data->fieldExpectedType;
        }
