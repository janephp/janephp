...
class InvalidChangeCommandFieldTypeInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('commandType') && null !== $data->getCommandType()) {
            $dataArray['commandType'] = $data->getCommandType();
        }
        ...
        if ($data->isInitialized('fieldActualType') && null !== $data->getFieldActualType()) {
            $dataArray['fieldActualType'] = $data->getFieldActualType();
        }
