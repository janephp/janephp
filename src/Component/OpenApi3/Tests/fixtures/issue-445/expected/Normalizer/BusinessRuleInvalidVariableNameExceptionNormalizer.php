...
class BusinessRuleInvalidVariableNameExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\BusinessRuleInvalidVariableNameException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\BusinessRuleInvalidVariableNameException' => false);
    }
}