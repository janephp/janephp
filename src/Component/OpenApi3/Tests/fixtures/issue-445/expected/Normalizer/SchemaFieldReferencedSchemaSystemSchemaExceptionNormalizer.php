...
class SchemaFieldReferencedSchemaSystemSchemaExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('referencedSchemaId', $data) && $data['referencedSchemaId'] !== null) {
            $object->referencedSchemaId = $data['referencedSchemaId'];
            unset($data['referencedSchemaId']);
        }
        elseif (\array_key_exists('referencedSchemaId', $data)) {
            $object->referencedSchemaId = null;
            unset($data['referencedSchemaId']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('referencedSchemaId', get_object_vars($data)) && null !== ($data->referencedSchemaId ?? null)) {
            $dataArray['referencedSchemaId'] = $data->referencedSchemaId;
        }
