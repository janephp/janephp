...
class SchemaFieldReferencedSchemaSystemSchemaExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\SchemaFieldReferencedSchemaSystemSchemaException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\SchemaFieldReferencedSchemaSystemSchemaException' => false);
    }
}