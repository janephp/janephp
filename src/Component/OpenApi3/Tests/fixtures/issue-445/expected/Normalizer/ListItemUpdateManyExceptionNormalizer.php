...
class ListItemUpdateManyExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('failedItemsCount', $data)) {
            $object->failedItemsCount = $data['failedItemsCount'];
            unset($data['failedItemsCount']);
        }
        if (\array_key_exists('totalItemsCount', $data)) {
            $object->totalItemsCount = $data['totalItemsCount'];
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('failedItemsCount', get_object_vars($data)) && null !== ($data->failedItemsCount ?? null)) {
            $dataArray['failedItemsCount'] = $data->failedItemsCount ?? null;
        }
        if (array_key_exists('totalItemsCount', get_object_vars($data)) && null !== ($data->totalItemsCount ?? null)) {
            $dataArray['totalItemsCount'] = $data->totalItemsCount ?? null;
        }
