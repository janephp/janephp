...
class SchemaCreateManyRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\SchemaCreateManyRequest';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        if (\array_key_exists('schemas', $data)) {
            ...
            foreach ($data['schemas'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'PicturePark\\API\\Model\\SchemaCreateRequest', 'json', $context);
            }
    ...
    {
        return array('PicturePark\\API\\Model\\SchemaCreateManyRequest' => false);
    }
}