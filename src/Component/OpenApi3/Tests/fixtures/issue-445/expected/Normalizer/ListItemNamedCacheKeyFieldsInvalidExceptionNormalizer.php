...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ListItemNamedCacheKeyFieldsInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'PicturePark\\API\\Model\\ListItemNamedCacheKeyFieldsInvalidException';
        }
        ...
        {
            return ['PicturePark\\API\\Model\\ListItemNamedCacheKeyFieldsInvalidException' => false];
        }
    }
} else {
    class ListItemNamedCacheKeyFieldsInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
