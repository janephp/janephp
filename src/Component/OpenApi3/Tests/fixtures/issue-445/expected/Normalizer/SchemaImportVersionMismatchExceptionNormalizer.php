...
class SchemaImportVersionMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('providedVersion', $data) && $data['providedVersion'] !== null) {
            $object->providedVersion = $data['providedVersion'];
            unset($data['providedVersion']);
        }
        elseif (\array_key_exists('providedVersion', $data)) {
            $object->providedVersion = null;
            unset($data['providedVersion']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('providedVersion', get_object_vars($data)) && null !== ($data->providedVersion ?? null)) {
            $dataArray['providedVersion'] = $data->providedVersion;
        }
        if (array_key_exists('expectedVersion', get_object_vars($data)) && null !== ($data->expectedVersion ?? null)) {
            $dataArray['expectedVersion'] = $data->expectedVersion;
        }
