...
class OutputFormatResizingNotSupportedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\OutputFormatResizingNotSupportedException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\OutputFormatResizingNotSupportedException' => false);
    }
}