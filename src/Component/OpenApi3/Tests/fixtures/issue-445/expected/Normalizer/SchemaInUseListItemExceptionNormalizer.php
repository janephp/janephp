...
class SchemaInUseListItemExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('listItemCount', $data)) {
            $object->listItemCount = $data['listItemCount'];
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('listItemCount', get_object_vars($data)) && null !== ($data->listItemCount ?? null)) {
            $dataArray['listItemCount'] = $data->listItemCount ?? null;
        }
