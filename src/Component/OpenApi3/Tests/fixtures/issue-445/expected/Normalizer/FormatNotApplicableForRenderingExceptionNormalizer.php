...
class FormatNotApplicableForRenderingExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('contentRenderingType', $data)) {
            $object->contentRenderingType = $data['contentRenderingType'];
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('contentRenderingType', get_object_vars($data)) && null !== ($data->contentRenderingType ?? null)) {
            $dataArray['contentRenderingType'] = $data->contentRenderingType ?? null;
        }
