...
class RelationNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('relationId', $data) && $data['relationId'] !== null) {
            $object->relationId = $data['relationId'];
            unset($data['relationId']);
        }
        elseif (\array_key_exists('relationId', $data)) {
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('relationId', get_object_vars($data)) && null !== ($data->relationId ?? null)) {
            $dataArray['relationId'] = $data->relationId;
        }
