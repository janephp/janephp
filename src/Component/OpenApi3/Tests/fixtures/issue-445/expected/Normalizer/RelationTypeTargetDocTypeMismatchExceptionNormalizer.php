...
class RelationTypeTargetDocTypeMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('relationType', $data) && $data['relationType'] !== null) {
            $object->relationType = $data['relationType'];
            unset($data['relationType']);
        }
        elseif (\array_key_exists('relationType', $data)) {
            $object->relationType = null;
            unset($data['relationType']);
        }
        if (\array_key_exists('targetDocType', $data) && $data['targetDocType'] !== null) {
            $object->targetDocType = $data['targetDocType'];
            unset($data['targetDocType']);
        }
        elseif (\array_key_exists('targetDocType', $data)) {
            $object->targetDocType = null;
            unset($data['targetDocType']);
        }
        if (\array_key_exists('expectedTargetDocType', $data) && $data['expectedTargetDocType'] !== null) {
            $object->expectedTargetDocType = $data['expectedTargetDocType'];
            unset($data['expectedTargetDocType']);
        }
        elseif (\array_key_exists('expectedTargetDocType', $data)) {
            $object->expectedTargetDocType = null;
            unset($data['expectedTargetDocType']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('relationType', get_object_vars($data)) && null !== ($data->relationType ?? null)) {
            $dataArray['relationType'] = $data->relationType;
        }
        if (array_key_exists('targetDocType', get_object_vars($data)) && null !== ($data->targetDocType ?? null)) {
            $dataArray['targetDocType'] = $data->targetDocType;
        }
        if (array_key_exists('expectedTargetDocType', get_object_vars($data)) && null !== ($data->expectedTargetDocType ?? null)) {
            $dataArray['expectedTargetDocType'] = $data->expectedTargetDocType;
        }
