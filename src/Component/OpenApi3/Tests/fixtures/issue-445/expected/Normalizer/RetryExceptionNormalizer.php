...
class RetryExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('innerExceptionDetail', $data) && $data['innerExceptionDetail'] !== null) {
            $object->innerExceptionDetail = $data['innerExceptionDetail'];
            unset($data['innerExceptionDetail']);
        }
        elseif (\array_key_exists('innerExceptionDetail', $data)) {
            $object->innerExceptionDetail = null;
            unset($data['innerExceptionDetail']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('innerExceptionDetail', get_object_vars($data)) && null !== ($data->innerExceptionDetail ?? null)) {
            $dataArray['innerExceptionDetail'] = $data->innerExceptionDetail;
        }
