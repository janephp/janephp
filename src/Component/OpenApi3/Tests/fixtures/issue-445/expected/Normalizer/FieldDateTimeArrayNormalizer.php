...
class FieldDateTimeArrayNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('initializeOnItemCreation', $data) && \is_int($data['initializeOnItemCreation'])) {
            $data['initializeOnItemCreation'] = (bool) $data['initializeOnItemCreation'];
        }
        ...
        if (\array_key_exists('initializeOnItemCreation', $data)) {
            $object->initializeOnItemCreation = $data['initializeOnItemCreation'];
