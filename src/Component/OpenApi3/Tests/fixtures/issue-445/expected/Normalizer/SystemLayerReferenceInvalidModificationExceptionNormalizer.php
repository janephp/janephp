...
class SystemLayerReferenceInvalidModificationExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'PicturePark\\API\\Model\\SystemLayerReferenceInvalidModificationException';
    }
    ...
    {
        return array('PicturePark\\API\\Model\\SystemLayerReferenceInvalidModificationException' => false);
    }
}