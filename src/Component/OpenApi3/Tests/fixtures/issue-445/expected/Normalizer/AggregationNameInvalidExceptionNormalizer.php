...
class AggregationNameInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('aggregationPrefix', $data) && $data['aggregationPrefix'] !== null) {
            $object->aggregationPrefix = $data['aggregationPrefix'];
            unset($data['aggregationPrefix']);
        }
        elseif (\array_key_exists('aggregationPrefix', $data)) {
            $object->aggregationPrefix = null;
            unset($data['aggregationPrefix']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('aggregationPrefix', get_object_vars($data)) && null !== ($data->aggregationPrefix ?? null)) {
            $dataArray['aggregationPrefix'] = $data->aggregationPrefix;
        }
