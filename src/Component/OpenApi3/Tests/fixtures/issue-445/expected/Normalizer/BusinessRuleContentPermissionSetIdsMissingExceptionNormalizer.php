...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class BusinessRuleContentPermissionSetIdsMissingExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === 'PicturePark\\API\\Model\\BusinessRuleContentPermissionSetIdsMissingException';
        }
        ...
        {
            return ['PicturePark\\API\\Model\\BusinessRuleContentPermissionSetIdsMissingException' => false];
        }
    }
} else {
    class BusinessRuleContentPermissionSetIdsMissingExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
