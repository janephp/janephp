...
class MissingCustomerDefaultLanguageExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('customerDefaultLanguage', $data) && $data['customerDefaultLanguage'] !== null) {
            $object->customerDefaultLanguage = $data['customerDefaultLanguage'];
            unset($data['customerDefaultLanguage']);
        }
        elseif (\array_key_exists('customerDefaultLanguage', $data)) {
            $object->customerDefaultLanguage = null;
            unset($data['customerDefaultLanguage']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('customerDefaultLanguage', get_object_vars($data)) && null !== ($data->customerDefaultLanguage ?? null)) {
            $dataArray['customerDefaultLanguage'] = $data->customerDefaultLanguage;
        }
