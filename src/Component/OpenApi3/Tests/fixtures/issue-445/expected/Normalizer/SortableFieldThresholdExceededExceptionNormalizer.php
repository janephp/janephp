...
class SortableFieldThresholdExceededExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('sortableFieldCount', $data)) {
            $object->sortableFieldCount = $data['sortableFieldCount'];
            unset($data['sortableFieldCount']);
        }
        if (\array_key_exists('sortableFieldThreshold', $data)) {
            $object->sortableFieldThreshold = $data['sortableFieldThreshold'];
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('sortableFieldCount', get_object_vars($data)) && null !== ($data->sortableFieldCount ?? null)) {
            $dataArray['sortableFieldCount'] = $data->sortableFieldCount ?? null;
        }
        if (array_key_exists('sortableFieldThreshold', get_object_vars($data)) && null !== ($data->sortableFieldThreshold ?? null)) {
            $dataArray['sortableFieldThreshold'] = $data->sortableFieldThreshold ?? null;
        }
