...
class SchemaParentChangeExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('oldSchemaParentId', $data) && $data['oldSchemaParentId'] !== null) {
            $object->oldSchemaParentId = $data['oldSchemaParentId'];
            unset($data['oldSchemaParentId']);
        }
        elseif (\array_key_exists('oldSchemaParentId', $data)) {
            $object->oldSchemaParentId = null;
            unset($data['oldSchemaParentId']);
        }
        if (\array_key_exists('newSchemaParentId', $data) && $data['newSchemaParentId'] !== null) {
            $object->newSchemaParentId = $data['newSchemaParentId'];
            unset($data['newSchemaParentId']);
        }
        elseif (\array_key_exists('newSchemaParentId', $data)) {
            $object->newSchemaParentId = null;
            unset($data['newSchemaParentId']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('oldSchemaParentId', get_object_vars($data)) && null !== ($data->oldSchemaParentId ?? null)) {
            $dataArray['oldSchemaParentId'] = $data->oldSchemaParentId;
        }
        if (array_key_exists('newSchemaParentId', get_object_vars($data)) && null !== ($data->newSchemaParentId ?? null)) {
            $dataArray['newSchemaParentId'] = $data->newSchemaParentId;
        }
