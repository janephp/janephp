...
class UserSearchRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $dataArray['includeServiceUser'] = $data->includeServiceUser;
        $dataArray['editableOnly'] = $data->editableOnly;
        if (array_key_exists('sort', get_object_vars($data)) && null !== ($data->sort ?? null)) {
            $values_3 = [];
            foreach ($data->sort as $value_5) {
                $normalized_2 = $value_5 === null ? null : $this->normalizer->normalize($value_5, 'json', $context);
        ...
        if (array_key_exists('aggregators', get_object_vars($data)) && null !== ($data->aggregators ?? null)) {
            $values_4 = [];
            foreach ($data->aggregators as $value_6) {
                $normalized_3 = $value_6 === null ? null : $this->normalizer->normalize($value_6, 'json', $context);
                $values_4[] = \is_iterable($normalized_3) ? new \PicturePark\API\Runtime\JsonObject($normalized_3) : $normalized_3;
            }
