...
class ReferenceUpdateExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        elseif (\array_key_exists('referenceItemId', $data)) {
        ...
        elseif (\array_key_exists('referenceType', $data)) {
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('referenceItemId', get_object_vars($data)) && null !== ($data->referenceItemId ?? null)) {
            $dataArray['referenceItemId'] = $data->referenceItemId;
        }
        if (array_key_exists('referenceType', get_object_vars($data)) && null !== ($data->referenceType ?? null)) {
            $dataArray['referenceType'] = $data->referenceType;
        }
