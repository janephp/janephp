...
class IndexedFieldThresholdExceededExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('indexedFieldCount', $data)) {
            $object->indexedFieldCount = $data['indexedFieldCount'];
            unset($data['indexedFieldCount']);
        }
        if (\array_key_exists('indexedFieldThreshold', $data)) {
            $object->indexedFieldThreshold = $data['indexedFieldThreshold'];
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('indexedFieldCount', get_object_vars($data)) && null !== ($data->indexedFieldCount ?? null)) {
            $dataArray['indexedFieldCount'] = $data->indexedFieldCount ?? null;
        }
        if (array_key_exists('indexedFieldThreshold', get_object_vars($data)) && null !== ($data->indexedFieldThreshold ?? null)) {
            $dataArray['indexedFieldThreshold'] = $data->indexedFieldThreshold ?? null;
        }
