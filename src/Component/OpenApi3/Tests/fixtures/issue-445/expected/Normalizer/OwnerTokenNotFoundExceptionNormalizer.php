...
class OwnerTokenNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('ownerTokenUserIds', get_object_vars($data)) && null !== ($data->ownerTokenUserIds ?? null)) {
            $values = [];
            foreach ($data->ownerTokenUserIds ?? null as $value) {
                $values[] = $value;
            }
