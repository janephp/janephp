...
class EnvironmentProcessAlreadyRunningExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('environmentProcessType', $data)) {
            $object->environmentProcessType = $data['environmentProcessType'];
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('environmentProcessType', get_object_vars($data)) && null !== ($data->environmentProcessType ?? null)) {
            $dataArray['environmentProcessType'] = $data->environmentProcessType ?? null;
        }
