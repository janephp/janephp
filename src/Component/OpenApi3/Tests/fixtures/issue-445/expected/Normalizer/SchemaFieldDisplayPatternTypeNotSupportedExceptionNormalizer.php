...
class SchemaFieldDisplayPatternTypeNotSupportedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('displayPatternType', $data)) {
            $object->displayPatternType = $data['displayPatternType'];
        ...
        if (\array_key_exists('supportedDisplayPatternTypes', $data) && $data['supportedDisplayPatternTypes'] !== null) {
            ...
            $object->supportedDisplayPatternTypes = $values;
        ...
        elseif (\array_key_exists('supportedDisplayPatternTypes', $data) && $data['supportedDisplayPatternTypes'] === null) {
            $object->supportedDisplayPatternTypes = null;
            unset($data['supportedDisplayPatternTypes']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('displayPatternType', get_object_vars($data)) && null !== ($data->displayPatternType ?? null)) {
            $dataArray['displayPatternType'] = $data->displayPatternType ?? null;
        }
        if (array_key_exists('supportedDisplayPatternTypes', get_object_vars($data)) && null !== ($data->supportedDisplayPatternTypes ?? null)) {
            $values = [];
            foreach ($data->supportedDisplayPatternTypes ?? null as $value) {
                $values[] = $value;
            }
