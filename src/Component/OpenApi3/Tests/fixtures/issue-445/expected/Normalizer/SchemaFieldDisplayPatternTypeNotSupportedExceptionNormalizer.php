...
class SchemaFieldDisplayPatternTypeNotSupportedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('displayPatternType') && null !== $data->getDisplayPatternType()) {
            $dataArray['displayPatternType'] = $data->getDisplayPatternType();
        }
        if ($data->isInitialized('supportedDisplayPatternTypes') && null !== $data->getSupportedDisplayPatternTypes()) {
            $values = [];
            foreach ($data->getSupportedDisplayPatternTypes() as $value) {
                $values[] = $value;
            }
