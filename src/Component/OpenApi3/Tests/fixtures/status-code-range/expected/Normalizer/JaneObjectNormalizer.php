...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    private function initNormalizer(string $normalizerClass)
    {
        $normalizer = match ($normalizerClass) {
            \Jane\Component\OpenApi3\Tests\StatusCodeRange\Normalizer\MessageNormalizer::class => new \Jane\Component\OpenApi3\Tests\StatusCodeRange\Normalizer\MessageNormalizer(),
            \Jane\Component\OpenApi3\Tests\StatusCodeRange\Runtime\Normalizer\ReferenceNormalizer::class => new \Jane\Component\OpenApi3\Tests\StatusCodeRange\Runtime\Normalizer\ReferenceNormalizer(),
