...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    private function initNormalizer(string $normalizerClass)
    {
        $normalizer = match ($normalizerClass) {
            \Jane\Component\OpenApi3\Tests\Expected\DiscriminatorSnakeCase\Normalizer\PetNormalizer::class => new \Jane\Component\OpenApi3\Tests\Expected\DiscriminatorSnakeCase\Normalizer\PetNormalizer(),
            \Jane\Component\OpenApi3\Tests\Expected\DiscriminatorSnakeCase\Normalizer\CatInSnakeCaseNormalizer::class => new \Jane\Component\OpenApi3\Tests\Expected\DiscriminatorSnakeCase\Normalizer\CatInSnakeCaseNormalizer(),
            \Jane\Component\OpenApi3\Tests\Expected\DiscriminatorSnakeCase\Normalizer\DogInSnakeCaseNormalizer::class => new \Jane\Component\OpenApi3\Tests\Expected\DiscriminatorSnakeCase\Normalizer\DogInSnakeCaseNormalizer(),
            \Jane\Component\OpenApi3\Tests\Expected\DiscriminatorSnakeCase\Runtime\Normalizer\ReferenceNormalizer::class => new \Jane\Component\OpenApi3\Tests\Expected\DiscriminatorSnakeCase\Runtime\Normalizer\ReferenceNormalizer(),
