...
class DetailedUserNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Model\DetailedUser::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Model\DetailedUser::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Model\DetailedUser();
        ...
        if (\array_key_exists('withheld', $data)) {
            $object->withheld = $this->denormalizer->denormalize($data['withheld'], \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Model\UserWithheld::class, 'json', $context);
            unset($data['withheld']);
        }
        ...
        if (\array_key_exists('entities', $data)) {
            $object->entities = $this->denormalizer->denormalize($data['entities'], \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Model\DefaultUserFieldsEntities::class, 'json', $context);
            unset($data['entities']);
        }
        ...
        if (\array_key_exists('stats', $data)) {
            $object->stats = $this->denormalizer->denormalize($data['stats'], \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Model\DetailedUserFieldsStats::class, 'json', $context);
            unset($data['stats']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('withheld', get_object_vars($data)) && null !== ($data->withheld ?? null)) {
            ...
            $dataArray['withheld'] = \is_iterable($normalized) ? new \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Runtime\JsonObject($normalized) : $normalized;
        }
        ...
        if (array_key_exists('entities', get_object_vars($data)) && null !== ($data->entities ?? null)) {
            ...
            $dataArray['entities'] = \is_iterable($normalized_1) ? new \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Runtime\JsonObject($normalized_1) : $normalized_1;
        }
        ...
        if (array_key_exists('stats', get_object_vars($data)) && null !== ($data->stats ?? null)) {
            ...
            $dataArray['stats'] = \is_iterable($normalized_2) ? new \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Runtime\JsonObject($normalized_2) : $normalized_2;
        }
    ...
    {
        return [\Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Model\DetailedUser::class => false];
    }
}