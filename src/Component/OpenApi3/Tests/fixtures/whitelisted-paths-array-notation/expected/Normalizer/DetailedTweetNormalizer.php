...
class DetailedTweetNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Model\DetailedTweet::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Model\DetailedTweet::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Model\DetailedTweet();
        ...
        if (\array_key_exists('created_at', $data)) {
            ...
            if (false === $date) {
                throw new \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Runtime\Normalizer\InvalidDateException($data['created_at'], 'Y-m-d\TH:i:sP');
            }
        ...
        if (\array_key_exists('referenced_tweets', $data)) {
            ...
            foreach ($data['referenced_tweets'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Model\CompactTweetFieldsReferencedTweetsItem::class, 'json', $context);
            }
            $object->referencedTweets = $values;
            unset($data['referenced_tweets']);
        }
        if (\array_key_exists('attachments', $data)) {
            $object->attachments = $this->denormalizer->denormalize($data['attachments'], \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Model\CompactTweetFieldsAttachments::class, 'json', $context);
            unset($data['attachments']);
        }
        if (\array_key_exists('withheld', $data)) {
            $object->withheld = $this->denormalizer->denormalize($data['withheld'], \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Model\TweetWithheld::class, 'json', $context);
            unset($data['withheld']);
        }
        if (\array_key_exists('geo', $data)) {
            $object->geo = $this->denormalizer->denormalize($data['geo'], \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Model\DefaultTweetFieldsGeo::class, 'json', $context);
            unset($data['geo']);
        }
        if (\array_key_exists('entities', $data)) {
            $object->entities = $this->denormalizer->denormalize($data['entities'], \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Model\FullTextEntities::class, 'json', $context);
            unset($data['entities']);
        }
        if (\array_key_exists('stats', $data)) {
            $object->stats = $this->denormalizer->denormalize($data['stats'], \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Model\DetailedTweetFieldsStats::class, 'json', $context);
            unset($data['stats']);
        }
        if (\array_key_exists('context_annotation', $data)) {
            $values_1 = [];
            foreach ($data['context_annotation'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Model\ContextAnnotation::class, 'json', $context);
            }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('referencedTweets', get_object_vars($data)) && null !== ($data->referencedTweets ?? null)) {
            ...
            foreach ($data->referencedTweets as $value) {
                ...
                $values[] = \is_iterable($normalized) ? new \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Runtime\JsonObject($normalized) : $normalized;
            }
        ...
        if (array_key_exists('attachments', get_object_vars($data)) && null !== ($data->attachments ?? null)) {
            ...
            $dataArray['attachments'] = \is_iterable($normalized_1) ? new \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Runtime\JsonObject($normalized_1) : $normalized_1;
        }
        if (array_key_exists('withheld', get_object_vars($data)) && null !== ($data->withheld ?? null)) {
            ...
            $dataArray['withheld'] = \is_iterable($normalized_2) ? new \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Runtime\JsonObject($normalized_2) : $normalized_2;
        }
        if (array_key_exists('geo', get_object_vars($data)) && null !== ($data->geo ?? null)) {
            ...
            $dataArray['geo'] = \is_iterable($normalized_3) ? new \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Runtime\JsonObject($normalized_3) : $normalized_3;
        }
        if (array_key_exists('entities', get_object_vars($data)) && null !== ($data->entities ?? null)) {
            ...
            $dataArray['entities'] = \is_iterable($normalized_4) ? new \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Runtime\JsonObject($normalized_4) : $normalized_4;
        }
        $normalized_5 = $data->stats === null ? null : $this->normalizer->normalize($data->stats, 'json', $context);
        $dataArray['stats'] = \is_iterable($normalized_5) ? new \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Runtime\JsonObject($normalized_5) : $normalized_5;
        if (array_key_exists('contextAnnotation', get_object_vars($data)) && null !== ($data->contextAnnotation ?? null)) {
            ...
            foreach ($data->contextAnnotation as $value_1) {
                ...
                $values_1[] = \is_iterable($normalized_6) ? new \Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Runtime\JsonObject($normalized_6) : $normalized_6;
            }
    ...
    {
        return [\Jane\OpenApi3\Tests\Expected\WhitelistedPathsArrayNotation\Model\DetailedTweet::class => false];
    }
}