...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    private function initNormalizer(string $normalizerClass)
    {
        $normalizer = match ($normalizerClass) {
            \Jane\Component\OpenApi3\Tests\Expected\AllOfNullableReferenceProperty\Normalizer\RootNormalizer::class => new \Jane\Component\OpenApi3\Tests\Expected\AllOfNullableReferenceProperty\Normalizer\RootNormalizer(),
            \Jane\Component\OpenApi3\Tests\Expected\AllOfNullableReferenceProperty\Normalizer\RootFooNormalizer::class => new \Jane\Component\OpenApi3\Tests\Expected\AllOfNullableReferenceProperty\Normalizer\RootFooNormalizer(),
            \Jane\Component\OpenApi3\Tests\Expected\AllOfNullableReferenceProperty\Normalizer\BarNormalizer::class => new \Jane\Component\OpenApi3\Tests\Expected\AllOfNullableReferenceProperty\Normalizer\BarNormalizer(),
            \Jane\Component\OpenApi3\Tests\Expected\AllOfNullableReferenceProperty\Runtime\Normalizer\ReferenceNormalizer::class => new \Jane\Component\OpenApi3\Tests\Expected\AllOfNullableReferenceProperty\Runtime\Normalizer\ReferenceNormalizer(),
