...
class CompactTweet implements AdditionalPropertiesInterface
{
    ...
    {
        return ['format' => 'format', 'id' => 'id', 'createdAt' => 'created_at', 'text' => 'text', 'authorId' => 'author_id', 'inReplyToUserId' => 'in_reply_to_user_id', 'referencedTweets' => 'referenced_tweets', 'attachments' => 'attachments', 'withheld' => 'withheld'];
    }
}