...
class DetailedPlaceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\Tests\Expected\WhitelistedPaths\Model\DetailedPlace::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Component\OpenApi3\Tests\Expected\WhitelistedPaths\Model\DetailedPlace::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Component\OpenApi3\Tests\Expected\WhitelistedPaths\Model\DetailedPlace();
        ...
        if (\array_key_exists('geo', $data)) {
            $object->geo = $this->denormalizer->denormalize($data['geo'], \Jane\Component\OpenApi3\Tests\Expected\WhitelistedPaths\Model\Geo::class, 'json', $context);
            unset($data['geo']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('geo', get_object_vars($data)) && null !== ($data->geo ?? null)) {
            ...
            $dataArray['geo'] = \is_iterable($normalized) ? new \Jane\Component\OpenApi3\Tests\Expected\WhitelistedPaths\Runtime\JsonObject($normalized) : $normalized;
        }
    ...
    {
        return [\Jane\Component\OpenApi3\Tests\Expected\WhitelistedPaths\Model\DetailedPlace::class => false];
    }
}