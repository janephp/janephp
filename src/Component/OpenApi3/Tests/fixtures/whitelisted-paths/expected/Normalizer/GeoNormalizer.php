...
class GeoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\Tests\Expected\WhitelistedPaths\Model\Geo::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Component\OpenApi3\Tests\Expected\WhitelistedPaths\Model\Geo::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Component\OpenApi3\Tests\Expected\WhitelistedPaths\Model\Geo();
        ...
        if (\array_key_exists('geometry', $data)) {
            $object->geometry = $this->denormalizer->denormalize($data['geometry'], \Jane\Component\OpenApi3\Tests\Expected\WhitelistedPaths\Model\Point::class, 'json', $context);
            unset($data['geometry']);
        }
        if (\array_key_exists('properties', $data)) {
            $values_1 = new \Jane\Component\OpenApi3\Tests\Expected\WhitelistedPaths\Runtime\JsonObject();
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('geometry', get_object_vars($data)) && null !== ($data->geometry ?? null)) {
            ...
            $dataArray['geometry'] = \is_iterable($normalized) ? new \Jane\Component\OpenApi3\Tests\Expected\WhitelistedPaths\Runtime\JsonObject($normalized) : $normalized;
        }
        $values_1 = new \Jane\Component\OpenApi3\Tests\Expected\WhitelistedPaths\Runtime\JsonObject();
        foreach ($data->properties as $key => $value_1) {
            $values_1[$key] = $value_1;
    ...
    {
        return [\Jane\Component\OpenApi3\Tests\Expected\WhitelistedPaths\Model\Geo::class => false];
    }
}