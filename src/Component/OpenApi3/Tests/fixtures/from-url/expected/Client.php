...
class Client extends \Jane\Component\OpenApi3\Tests\Expected\Runtime\Client\Client
{
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi3\Tests\Expected\Endpoint\ListPets($queryParameters));
    }
    /**
     ...
     */
    public function createPets(\Jane\Component\OpenApi3\Tests\Expected\Model\Pet $requestBody)
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi3\Tests\Expected\Endpoint\CreatePets($requestBody));
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi3\Tests\Expected\Endpoint\ShowPetById($petId));
    }
