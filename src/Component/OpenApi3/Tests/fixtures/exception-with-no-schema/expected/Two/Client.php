...
class Client extends \Jane\Component\OpenApi3\Tests\Expected\Two\Runtime\Client\Client
{
     ...
     * @throws \Jane\Component\OpenApi3\Tests\Expected\Two\Exception\BadResponseException
     *
     * @return null
     */
    ...
    public static function create(?\Symfony\Contracts\HttpClient\HttpClientInterface $httpClient = null, array $additionalPlugins = [], array $additionalNormalizers = [])
    {
        ...
        $normalizers = [new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \Jane\Component\OpenApi3\Tests\Expected\Two\Normalizer\JaneObjectNormalizer()];
