...
namespace Jane\Component\OpenApi3\Tests\Expected\Issue737\Endpoint;

class PostFile extends \Jane\Component\OpenApi3\Tests\Expected\Issue737\Runtime\Client\BaseEndpoint implements \Jane\Component\OpenApi3\Tests\Expected\Issue737\Runtime\Client\Endpoint
{
    /**
     * @param null|\Jane\Component\OpenApi3\Tests\Expected\Issue737\Model\FilePostBody $requestBody
     */
    public function __construct(?\Jane\Component\OpenApi3\Tests\Expected\Issue737\Model\FilePostBody $requestBody = null)
    {
        $this->body = $requestBody;
    }
    use \Jane\Component\OpenApi3\Tests\Expected\Issue737\Runtime\Client\EndpointTrait;
    ...
    protected function transformResponseBody(\Symfony\Contracts\HttpClient\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        throw new \Jane\Component\OpenApi3\Tests\Expected\Issue737\Exception\BadResponseException($status, $body, $response);
    }
