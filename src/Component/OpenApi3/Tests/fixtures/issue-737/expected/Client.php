...
class Client extends \Jane\Component\OpenApi3\Tests\Expected\Runtime\Client\Client
{
     ...
     * @return null|string
     */
    public function postFile(?\Jane\Component\OpenApi3\Tests\Expected\Model\FilePostBody $requestBody = null)
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi3\Tests\Expected\Endpoint\PostFile($requestBody));
    }
