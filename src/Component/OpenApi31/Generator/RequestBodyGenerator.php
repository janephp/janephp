...
use Jane\Component\OpenApi31\Generator\RequestBodyContent\AbstractBodyContentGenerator;
...
class RequestBodyGenerator
{
    ...
    public function generateMethodDocParameter($requestBody, string $reference, Context $context): string
    {
        ...
        return \sprintf(' * @param %s $%s', implode('|', $types), 'requestBody');
    }
