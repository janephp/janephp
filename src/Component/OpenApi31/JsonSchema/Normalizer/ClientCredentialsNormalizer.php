...
class ClientCredentialsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    use CheckArray;
    ...
    {
        return $type === \Jane\Component\OpenApi31\JsonSchema\Model\ClientCredentials::class;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return $data instanceof \Jane\Component\OpenApi31\JsonSchema\Model\ClientCredentials;
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jane\Component\OpenApi31\JsonSchema\Model\ClientCredentials();
    ...
    {
        return [\Jane\Component\OpenApi31\JsonSchema\Model\ClientCredentials::class => false];
    }
}
