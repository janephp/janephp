...
class SchemaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return $data instanceof \Jane\Component\OpenApi31\JsonSchema\Model\Schema;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Component\OpenApi31\JsonSchema\Model\Schema();
        ...
        if (\array_key_exists('$defs', $data) && $data['$defs'] !== null) {
            ...
            foreach ($data['$defs'] as $key_1 => $value_1) {
                $value_2 = $value_1;
                if (is_array($value_1)) {
                    $value_2 = $this->denormalizer->denormalize($value_1, \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('prefixItems', $data) && $data['prefixItems'] !== null) {
            ...
            foreach ($data['prefixItems'] as $value_3) {
                $value_4 = $value_3;
                if (is_array($value_3)) {
                    $value_4 = $this->denormalizer->denormalize($value_3, \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('items', $data) && $data['items'] !== null) {
            ...
            if (is_array($data['items'])) {
                $value_5 = $this->denormalizer->denormalize($data['items'], \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
                ...
                foreach ($data['items'] as $value_6) {
                    $value_7 = $value_6;
                    if (is_array($value_6)) {
                        $value_7 = $this->denormalizer->denormalize($value_6, \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('contains', $data) && $data['contains'] !== null) {
            ...
            if (is_array($data['contains'])) {
                $value_8 = $this->denormalizer->denormalize($data['contains'], \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('additionalProperties', $data) && $data['additionalProperties'] !== null) {
            ...
            if (is_array($data['additionalProperties'])) {
                $value_9 = $this->denormalizer->denormalize($data['additionalProperties'], \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('properties', $data) && $data['properties'] !== null) {
            ...
            foreach ($data['properties'] as $key_2 => $value_10) {
                ...
                if (is_array($value_10)) {
                    $value_11 = $this->denormalizer->denormalize($value_10, \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('patternProperties', $data) && $data['patternProperties'] !== null) {
            ...
            foreach ($data['patternProperties'] as $key_3 => $value_12) {
                ...
                if (is_array($value_12)) {
                    $value_13 = $this->denormalizer->denormalize($value_12, \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('dependentSchemas', $data) && $data['dependentSchemas'] !== null) {
            ...
            foreach ($data['dependentSchemas'] as $key_4 => $value_14) {
                ...
                if (is_array($value_14)) {
                    $value_15 = $this->denormalizer->denormalize($value_14, \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('propertyNames', $data) && $data['propertyNames'] !== null) {
            ...
            if (is_array($data['propertyNames'])) {
                $value_16 = $this->denormalizer->denormalize($data['propertyNames'], \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('if', $data) && $data['if'] !== null) {
            $value_17 = $data['if'];
            if (is_array($data['if'])) {
                $value_17 = $this->denormalizer->denormalize($data['if'], \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('then', $data) && $data['then'] !== null) {
            ...
            if (is_array($data['then'])) {
                $value_18 = $this->denormalizer->denormalize($data['then'], \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('else', $data) && $data['else'] !== null) {
            ...
            if (is_array($data['else'])) {
                $value_19 = $this->denormalizer->denormalize($data['else'], \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('allOf', $data) && $data['allOf'] !== null) {
            ...
            foreach ($data['allOf'] as $value_20) {
                ...
                if (is_array($value_20)) {
                    $value_21 = $this->denormalizer->denormalize($value_20, \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('anyOf', $data) && $data['anyOf'] !== null) {
            ...
            foreach ($data['anyOf'] as $value_22) {
                ...
                if (is_array($value_22)) {
                    $value_23 = $this->denormalizer->denormalize($value_22, \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('oneOf', $data) && $data['oneOf'] !== null) {
            ...
            foreach ($data['oneOf'] as $value_24) {
                ...
                if (is_array($value_24)) {
                    $value_25 = $this->denormalizer->denormalize($value_24, \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('not', $data) && $data['not'] !== null) {
            ...
            if (is_array($data['not'])) {
                $value_26 = $this->denormalizer->denormalize($data['not'], \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('unevaluatedItems', $data) && $data['unevaluatedItems'] !== null) {
            ...
            if (is_array($data['unevaluatedItems'])) {
                $value_27 = $this->denormalizer->denormalize($data['unevaluatedItems'], \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('unevaluatedProperties', $data) && $data['unevaluatedProperties'] !== null) {
            ...
            if (is_array($data['unevaluatedProperties'])) {
                $value_28 = $this->denormalizer->denormalize($data['unevaluatedProperties'], \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('contentSchema', $data) && $data['contentSchema'] !== null) {
            ...
            if (is_array($data['contentSchema'])) {
                $value_36 = $this->denormalizer->denormalize($data['contentSchema'], \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('definitions', $data) && $data['definitions'] !== null) {
            ...
            foreach ($data['definitions'] as $key_6 => $value_37) {
                ...
                if (is_array($value_37)) {
                    $value_38 = $this->denormalizer->denormalize($value_37, \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('dependencies', $data) && $data['dependencies'] !== null) {
            ...
            foreach ($data['dependencies'] as $key_7 => $value_39) {
                ...
                if (is_array($value_39)) {
                    $value_40 = $this->denormalizer->denormalize($value_39, \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('additionalItems', $data) && $data['additionalItems'] !== null) {
            ...
            if (is_array($data['additionalItems'])) {
                $value_42 = $this->denormalizer->denormalize($data['additionalItems'], \Jane\Component\OpenApi31\JsonSchema\Model\Schema::class, 'json', $context);
        ...
        if (\array_key_exists('discriminator', $data) && $data['discriminator'] !== null) {
            $object->discriminator = $this->denormalizer->denormalize($data['discriminator'], 'Jane\\Component\\OpenApi31\\JsonSchema\\Model\\Discriminator', 'json', $context);
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (\array_key_exists('discriminator', get_object_vars($data)) && null !== ($data->discriminator ?? null)) {
            $dataArray['discriminator'] = $this->normalizer->normalize(($data->discriminator ?? null), 'json', $context);
        }
        return $dataArray;
    }
    public function getSupportedTypes(?string $format = null): array
    {
        return [\Jane\Component\OpenApi31\JsonSchema\Model\Schema::class => false];
    }
}