...
class WhitelistedPathsMultipartBodyTest extends TestCase
{
    ...
    {
        $fixtureDirectory = sys_get_temp_dir() . '/jane-openapi31-whitelisted-multipart-' . bin2hex(random_bytes(8));
        ...
        file_put_contents($configFile, '<?php' . "\n\n" . 'return ' . var_export([
            ...
            'namespace' => 'Jane\Component\OpenApi31\Tests\WhitelistedMultipartExpected',
