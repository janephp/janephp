...
class Client extends \Jane\Component\OpenApi31\Tests\Expected\Runtime\Client\Client
{
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi31\Tests\Expected\Endpoint\ListPets($queryParameters));
    }
    /**
     ...
     * @return null|\Jane\Component\OpenApi31\Tests\Expected\Model\Pet
     */
    public function createPet(\Jane\Component\OpenApi31\Tests\Expected\Model\Pet $requestBody)
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi31\Tests\Expected\Endpoint\CreatePet($requestBody));
    }
    /**
     * @param string $petId
     *
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi31\Tests\Expected\Endpoint\ShowPetById($petId));
    }
