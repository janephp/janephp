...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    private function initNormalizer(string $normalizerClass)
    {
        $normalizer = match ($normalizerClass) {
            \Jane\Component\OpenApi31\Tests\Expected\Issue963\Normalizer\RequestErrorNormalizer::class => new \Jane\Component\OpenApi31\Tests\Expected\Issue963\Normalizer\RequestErrorNormalizer(),
            \Jane\Component\OpenApi31\Tests\Expected\Issue963\Normalizer\MemberDetailsNormalizer::class => new \Jane\Component\OpenApi31\Tests\Expected\Issue963\Normalizer\MemberDetailsNormalizer(),
            \Jane\Component\OpenApi31\Tests\Expected\Issue963\Runtime\Normalizer\ReferenceNormalizer::class => new \Jane\Component\OpenApi31\Tests\Expected\Issue963\Runtime\Normalizer\ReferenceNormalizer(),
