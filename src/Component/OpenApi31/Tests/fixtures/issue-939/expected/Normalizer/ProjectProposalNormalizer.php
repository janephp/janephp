    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('users') && null !== $data->getUsers()) {
            ...
            if (is_object($data->getUsers())) {
                $value = $data->getUsers() === null ? null : new \Jane\Component\OpenApi31\Tests\Expected\Issue939\Runtime\JsonObject($this->normalizer->normalize($data->getUsers(), 'json', $context));
