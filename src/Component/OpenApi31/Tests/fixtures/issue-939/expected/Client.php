...
class Client extends \Jane\Component\OpenApi31\Tests\Expected\Issue939\Runtime\Client\Client
{
     ...
     *
     * @return ($fetch is 'object' ? null|\Jane\Component\OpenApi31\Tests\Expected\Issue939\Model\ProjectProposal : \Psr\Http\Message\ResponseInterface)
     */
    public function getProposal(string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi31\Tests\Expected\Issue939\Endpoint\GetProposal(), $fetch);
    }
