...
class Client extends \Jane\Component\OpenApi31\Tests\ExpectedIssue1036\Runtime\Client\Client
{
     ...
     *
     * @return ($fetch is 'object' ? null|\Jane\Component\OpenApi31\Tests\ExpectedIssue1036\Model\Document : \Psr\Http\Message\ResponseInterface)
     */
    public function uploadDocument(\Jane\Component\OpenApi31\Tests\ExpectedIssue1036\Model\DocumentUpload $requestBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi31\Tests\ExpectedIssue1036\Endpoint\UploadDocument($requestBody), $fetch);
    }
