...
class Client extends \Jane\Component\OpenApi31\Tests\Expected\Issue1007\Runtime\Client\Client
{
     ...
     *
     * @return ($fetch is 'object' ? null|\Jane\Component\OpenApi31\Tests\Expected\Issue1007\Model\ThingCollection : \Psr\Http\Message\ResponseInterface)
     */
    public function getThings(string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi31\Tests\Expected\Issue1007\Endpoint\GetThings(), $fetch);
    }
