...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    private function initNormalizer(string $normalizerClass)
    {
        $normalizer = match ($normalizerClass) {
            \Jane\Component\OpenApi31\Tests\Expected\Issue966\Normalizer\OrderNormalizer::class => new \Jane\Component\OpenApi31\Tests\Expected\Issue966\Normalizer\OrderNormalizer(),
            \Jane\Component\OpenApi31\Tests\Expected\Issue966\Normalizer\OrderProductDataNormalizer::class => new \Jane\Component\OpenApi31\Tests\Expected\Issue966\Normalizer\OrderProductDataNormalizer(),
            \Jane\Component\OpenApi31\Tests\Expected\Issue966\Normalizer\OrderProductNormalizer::class => new \Jane\Component\OpenApi31\Tests\Expected\Issue966\Normalizer\OrderProductNormalizer(),
            \Jane\Component\OpenApi31\Tests\Expected\Issue966\Runtime\Normalizer\ReferenceNormalizer::class => new \Jane\Component\OpenApi31\Tests\Expected\Issue966\Runtime\Normalizer\ReferenceNormalizer(),
