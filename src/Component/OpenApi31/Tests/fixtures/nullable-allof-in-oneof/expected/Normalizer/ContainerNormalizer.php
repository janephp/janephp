    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('iconOneOf') && null !== $data->getIconOneOf()) {
            ...
            if (is_object($data->getIconOneOf())) {
                $value = $data->getIconOneOf() === null ? null : new \Jane\Component\OpenApi31\Tests\Expected\NullableAllofInOneof\Runtime\JsonObject($this->normalizer->normalize($data->getIconOneOf(), 'json', $context));
        ...
        if ($data->isInitialized('iconAnyOf') && null !== $data->getIconAnyOf()) {
            ...
            if (is_object($data->getIconAnyOf())) {
                $value_1 = $data->getIconAnyOf() === null ? null : new \Jane\Component\OpenApi31\Tests\Expected\NullableAllofInOneof\Runtime\JsonObject($this->normalizer->normalize($data->getIconAnyOf(), 'json', $context));
