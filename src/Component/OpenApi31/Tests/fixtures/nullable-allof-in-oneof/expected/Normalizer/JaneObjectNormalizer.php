...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    private function initNormalizer(string $normalizerClass)
    {
        $normalizer = match ($normalizerClass) {
            \Jane\Component\OpenApi31\Tests\Expected\NullableAllofInOneof\Normalizer\ContainerNormalizer::class => new \Jane\Component\OpenApi31\Tests\Expected\NullableAllofInOneof\Normalizer\ContainerNormalizer(),
            \Jane\Component\OpenApi31\Tests\Expected\NullableAllofInOneof\Normalizer\ContainerIconAnyOfAnyOfNormalizer::class => new \Jane\Component\OpenApi31\Tests\Expected\NullableAllofInOneof\Normalizer\ContainerIconAnyOfAnyOfNormalizer(),
            \Jane\Component\OpenApi31\Tests\Expected\NullableAllofInOneof\Normalizer\ImageNormalizer::class => new \Jane\Component\OpenApi31\Tests\Expected\NullableAllofInOneof\Normalizer\ImageNormalizer(),
            \Jane\Component\OpenApi31\Tests\Expected\NullableAllofInOneof\Runtime\Normalizer\ReferenceNormalizer::class => new \Jane\Component\OpenApi31\Tests\Expected\NullableAllofInOneof\Runtime\Normalizer\ReferenceNormalizer(),
