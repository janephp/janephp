...
class GetTokenTooManyRequestsException extends TooManyRequestsException
{
     ...
     */
    private $response;
    public function __construct(\Jane\Component\OpenApi31\Tests\Expected\ScalarGalaxy\Model\TooManyRequestsError $tooManyRequestsError, \Psr\Http\Message\ResponseInterface $response)
    {
