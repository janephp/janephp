...
class SatelliteOrbitNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('planet', $data)) {
            $object->setPlanet($this->denormalizer->denormalize($data['planet'], \Jane\Component\OpenApi31\Tests\Expected\ScalarGalaxy\Model\Planet::class, 'json', $context));
            unset($data['planet']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('planet') && null !== $data->getPlanet()) {
            $dataArray['planet'] = $data->getPlanet() === null ? null : new \Jane\Component\OpenApi31\Tests\Expected\ScalarGalaxy\Runtime\JsonObject($this->normalizer->normalize($data->getPlanet(), 'json', $context));
        }
