...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    private function initNormalizer(string $normalizerClass)
    {
        $normalizer = match ($normalizerClass) {
            \Jane\Component\OpenApi31\Tests\Expected\Issue946\Normalizer\MyApiEndpointGetResponse200ItemNormalizer::class => new \Jane\Component\OpenApi31\Tests\Expected\Issue946\Normalizer\MyApiEndpointGetResponse200ItemNormalizer(),
            \Jane\Component\OpenApi31\Tests\Expected\Issue946\Normalizer\MyApiEndpointIdGetResponse200Normalizer::class => new \Jane\Component\OpenApi31\Tests\Expected\Issue946\Normalizer\MyApiEndpointIdGetResponse200Normalizer(),
            \Jane\Component\OpenApi31\Tests\Expected\Issue946\Runtime\Normalizer\ReferenceNormalizer::class => new \Jane\Component\OpenApi31\Tests\Expected\Issue946\Runtime\Normalizer\ReferenceNormalizer(),
