...
class Trip implements AdditionalPropertiesInterface
{
    ...
    {
        return ['id' => 'id', 'origin' => 'origin', 'destination' => 'destination', 'departureTime' => 'departure_time', 'arrivalTime' => 'arrival_time', 'operator' => 'operator', 'price' => 'price', 'bicyclesAllowed' => 'bicycles_allowed', 'dogsAllowed' => 'dogs_allowed'];
    }
}