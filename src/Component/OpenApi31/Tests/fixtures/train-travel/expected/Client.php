...
class Client extends \Jane\Component\OpenApi31\Tests\Expected\Runtime\Client\Client
{
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi31\Tests\Expected\Endpoint\GetStations($queryParameters, $accept));
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi31\Tests\Expected\Endpoint\GetTrips($queryParameters, $accept));
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi31\Tests\Expected\Endpoint\GetBookings($queryParameters, $accept));
    }
    /**
     ...
     */
    public function createBooking(\Jane\Component\OpenApi31\Tests\Expected\Model\Booking $requestBody, array $accept = [])
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi31\Tests\Expected\Endpoint\CreateBooking($requestBody, $accept));
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi31\Tests\Expected\Endpoint\DeleteBooking($bookingId, $accept));
    }
    /**
     ...
     *
     * @return null|\Jane\Component\OpenApi31\Tests\Expected\Model\BookingsBookingIdGetJsonResponse200
     */
    public function getBooking(string $bookingId, array $accept = [])
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi31\Tests\Expected\Endpoint\GetBooking($bookingId, $accept));
    }
    /**
     ...
     */
    public function createBookingPayment(string $bookingId, \Jane\Component\OpenApi31\Tests\Expected\Model\BookingPayment $requestBody, array $accept = [])
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi31\Tests\Expected\Endpoint\CreateBookingPayment($bookingId, $requestBody, $accept));
    }
