...
class Client extends \Jane\Component\OpenApi2\Tests\Expected\Runtime\Client\Client
{
     ...
     */
    public function getFoo(array $queryParameters = array(), string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi2\Tests\Expected\Endpoint\GetFoo($queryParameters), $fetch);
    }
