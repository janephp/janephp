...
namespace Jane\Component\OpenApi2\Tests\RuntimeBoilerplate;
...
class Client extends \Jane\Component\OpenApi2\Tests\RuntimeBoilerplate\Runtime\Client\Client
{
    public static function create(?\Psr\Http\Client\ClientInterface $httpClient = null, array $additionalPlugins = [], array $additionalNormalizers = [])
    {
        ...
        $normalizers = [new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \Jane\Component\OpenApi2\Tests\RuntimeBoilerplate\Normalizer\JaneObjectNormalizer()];
