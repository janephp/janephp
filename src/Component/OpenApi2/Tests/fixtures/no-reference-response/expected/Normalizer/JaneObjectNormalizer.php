...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    protected $normalizers = [
        ...
        \Jane\Component\OpenApi2\Tests\Expected\Model\TestPostResponse201::class => \Jane\Component\OpenApi2\Tests\Expected\Normalizer\TestPostResponse201Normalizer::class,
    ...
    public function getSupportedTypes(?string $format = null): array
    {
        return [
            ...
            \Jane\Component\OpenApi2\Tests\Expected\Model\TestPostResponse201::class => false,
