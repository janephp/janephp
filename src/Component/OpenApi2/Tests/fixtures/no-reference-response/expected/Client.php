...
class Client extends \Jane\Component\OpenApi2\Tests\Expected\NoReferenceResponse\Runtime\Client\Client
{
     ...
     *
     * @return ($fetch is 'object' ? null|\Jane\Component\OpenApi2\Tests\Expected\NoReferenceResponse\Model\TestPostResponse201 : \Psr\Http\Message\ResponseInterface)
     */
    public function test(string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi2\Tests\Expected\NoReferenceResponse\Endpoint\Test(), $fetch);
    }
