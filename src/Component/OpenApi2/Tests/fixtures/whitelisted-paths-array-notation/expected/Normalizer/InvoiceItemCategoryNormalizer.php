...
class InvoiceItemCategoryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\OpenApi2\\Tests\\Expected\\Model\\InvoiceItemCategory';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Jane\\OpenApi2\\Tests\\Expected\\Model\\InvoiceItemCategory';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Jane\OpenApi2\Tests\Expected\Model\InvoiceItemCategory();
        ...
        if (\array_key_exists('use_as_service', $data)) {
            $object->setUseAsService($data['use_as_service']);
        }
        if (\array_key_exists('use_as_expense', $data)) {
