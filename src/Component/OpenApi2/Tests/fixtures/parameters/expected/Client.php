...
class Client extends \Jane\Component\OpenApi2\Tests\Expected\Runtime\Client\Client
{
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi2\Tests\Expected\Endpoint\TestGetWithPathParameters($testBody, $queryParameters, $headerParameters));
    }
    /**
     * @param array $testBody
     * @param array $queryParameters {
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi2\Tests\Expected\Endpoint\TestPostWithPathParameters($testBody, $queryParameters, $headerParameters));
    }
    /**
     * @param array $queryParameters {
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi2\Tests\Expected\Endpoint\TestQueryParameters($queryParameters));
    }
    /**
     * @param array $headerParameters {
     *     @var string $testString
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi2\Tests\Expected\Endpoint\TestHeaderParameters($headerParameters));
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi2\Tests\Expected\Endpoint\TestFormParameters($formParameters));
    }
    /**
     * @param array $formParameters {
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi2\Tests\Expected\Endpoint\TestFormFileParameters($formParameters));
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi2\Tests\Expected\Endpoint\TestBinaryBody($testBinary));
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi2\Tests\Expected\Endpoint\TestPathParameters($testString, $testInteger, $testFloat));
    }
    /**
     * @param int $testInteger
     *
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi2\Tests\Expected\Endpoint\GetByTestInteger($testInteger));
    }
