...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    private function initNormalizer(string $normalizerClass)
    {
        $normalizer = match ($normalizerClass) {
            \Jane\Component\OpenApi2\Tests\Expected\Exceptions\Normalizer\ErrorNormalizer::class => new \Jane\Component\OpenApi2\Tests\Expected\Exceptions\Normalizer\ErrorNormalizer(),
            \Jane\Component\OpenApi2\Tests\Expected\Exceptions\Runtime\Normalizer\ReferenceNormalizer::class => new \Jane\Component\OpenApi2\Tests\Expected\Exceptions\Runtime\Normalizer\ReferenceNormalizer(),
