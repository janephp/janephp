...
class ContainersIdArchiveHeadResponse400Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Docker\Api\Model\ContainersIdArchiveHeadResponse400::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Docker\Api\Model\ContainersIdArchiveHeadResponse400::class;
    }
    ...
    {
        return [\Docker\Api\Model\ContainersIdArchiveHeadResponse400::class => false];
    }
}