...
class ContainersCreatePostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('NetworkingConfig', $data)) {
            $object->networkingConfig = $this->denormalizer->denormalize($data['NetworkingConfig'], \Docker\Api\Model\NetworkingConfig::class, 'json', $context);
        }
        return $object;
    }
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('networkingConfig', get_object_vars($data)) && null !== ($data->networkingConfig ?? null)) {
            $dataArray['NetworkingConfig'] = ($data->networkingConfig ?? null) === null ? null : new \Docker\Api\Runtime\JsonObject($this->normalizer->normalize($data->networkingConfig ?? null, 'json', $context));
        }
        if (!($context['skip_validation'] ?? false)) {
