...
class SwarmUnlockkeyGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return is_object($data) && get_class($data) === \Docker\Api\Model\SwarmUnlockkeyGetResponse200::class;
    }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('unlockKey', get_object_vars($data)) && null !== ($data->unlockKey ?? null)) {
            $dataArray['UnlockKey'] = $data->unlockKey;
        }
        if (!($context['skip_validation'] ?? false)) {
            $this->validate($dataArray, new \Docker\Api\Validator\SwarmUnlockkeyGetResponse200Constraint());
        }
        return $dataArray;
    }
