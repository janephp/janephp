...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    protected $normalizers = [
        ...
        \Jane\Component\OpenApi2\Tests\Expected\Model\ResponseCommon::class => \Jane\Component\OpenApi2\Tests\Expected\Normalizer\ResponseCommonNormalizer::class,
    ...
    public function getSupportedTypes(?string $format = null): array
    {
        return [
            ...
            \Jane\Component\OpenApi2\Tests\Expected\Model\ResponseCommon::class => false,
