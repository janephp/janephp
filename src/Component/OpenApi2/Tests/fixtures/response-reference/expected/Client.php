...
class Client extends \Jane\Component\OpenApi2\Tests\Expected\Runtime\Client\Client
{
    /**
     *
     * @return null|\Jane\Component\OpenApi2\Tests\Expected\Model\ResponseCommon
     */
    public function testReferenceResponse()
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi2\Tests\Expected\Endpoint\TestReferenceResponse());
    }
    /**
     *
     * @return null|array
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi2\Tests\Expected\Endpoint\TestRefArray());
    }
