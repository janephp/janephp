...
class BarItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\BarItem';
    }
    public function supportsNormalization($data, $format = null, array $context = array()) : bool
    {
        return is_object($data) && get_class($data) === 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\BarItem';
    }
    /**
     * @return mixed
     */
    ...
    {
        return array('Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\BarItem' => false);
    }
}