...
class Client extends \Jane\Component\OpenApi2\Tests\Expected\Api2\Runtime\Client\Client
{
    ...
    public static function create($httpClient = null, array $additionalPlugins = [], array $additionalNormalizers = [])
    {
        ...
        $normalizers = [new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), new \Jane\Component\OpenApi2\Tests\Expected\Api2\Normalizer\JaneObjectNormalizer()];
