...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    private function initNormalizer(string $normalizerClass)
    {
        $normalizer = match ($normalizerClass) {
            \Jane\Component\OpenApi2\Tests\Expected\NoReferenceBody\Normalizer\FooNormalizer::class => new \Jane\Component\OpenApi2\Tests\Expected\NoReferenceBody\Normalizer\FooNormalizer(),
            \Jane\Component\OpenApi2\Tests\Expected\NoReferenceBody\Normalizer\BarNormalizer::class => new \Jane\Component\OpenApi2\Tests\Expected\NoReferenceBody\Normalizer\BarNormalizer(),
            \Jane\Component\OpenApi2\Tests\Expected\NoReferenceBody\Normalizer\TestGetBodyNormalizer::class => new \Jane\Component\OpenApi2\Tests\Expected\NoReferenceBody\Normalizer\TestGetBodyNormalizer(),
            \Jane\Component\OpenApi2\Tests\Expected\NoReferenceBody\Normalizer\TestGetBodyBazNormalizer::class => new \Jane\Component\OpenApi2\Tests\Expected\NoReferenceBody\Normalizer\TestGetBodyBazNormalizer(),
            \Jane\Component\OpenApi2\Tests\Expected\NoReferenceBody\Normalizer\TestPostBodyNormalizer::class => new \Jane\Component\OpenApi2\Tests\Expected\NoReferenceBody\Normalizer\TestPostBodyNormalizer(),
            \Jane\Component\OpenApi2\Tests\Expected\NoReferenceBody\Runtime\Normalizer\ReferenceNormalizer::class => new \Jane\Component\OpenApi2\Tests\Expected\NoReferenceBody\Runtime\Normalizer\ReferenceNormalizer(),
