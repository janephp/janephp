...
class Client extends \Jane\Component\OpenApi2\Tests\Expected\Runtime\Client\Client
{
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi2\Tests\Expected\Endpoint\GetFlatItems());
    }
    /**
     *
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi2\Tests\Expected\Endpoint\Admin\Reports\GetNamespacedReport());
    }
    /**
     *
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi2\Tests\Expected\Endpoint\Ops\Monitoring\GetTaggedItems());
    }
