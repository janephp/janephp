...
class TestComplexListGetResponsedefaultNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi2\Tests\Expected\Model\TestComplexListGetResponsedefault::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Component\OpenApi2\Tests\Expected\Model\TestComplexListGetResponsedefault::class;
    }
    ...
    {
        return [\Jane\Component\OpenApi2\Tests\Expected\Model\TestComplexListGetResponsedefault::class => false];
    }
}