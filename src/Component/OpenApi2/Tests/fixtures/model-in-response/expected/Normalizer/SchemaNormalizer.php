...
class SchemaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi2\Tests\Expected\ModelInResponse\Model\Schema::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Component\OpenApi2\Tests\Expected\ModelInResponse\Model\Schema::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Component\OpenApi2\Tests\Expected\ModelInResponse\Model\Schema();
        ...
        if (\array_key_exists('mapProperty', $data)) {
            $values_1 = new \Jane\Component\OpenApi2\Tests\Expected\ModelInResponse\Runtime\JsonObject();
        ...
        if (\array_key_exists('objectProperty', $data)) {
            $object->objectProperty = $this->denormalizer->denormalize($data['objectProperty'], \Jane\Component\OpenApi2\Tests\Expected\ModelInResponse\Model\SchemaObjectProperty::class, 'json', $context);
        }
        if (\array_key_exists('objectRefProperty', $data)) {
            $object->objectRefProperty = $this->denormalizer->denormalize($data['objectRefProperty'], \Jane\Component\OpenApi2\Tests\Expected\ModelInResponse\Model\Schema::class, 'json', $context);
        }
        return $object;
    }
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('objectProperty', get_object_vars($data)) && null !== ($data->objectProperty ?? null)) {
            $dataArray['objectProperty'] = ($data->objectProperty ?? null) === null ? null : new \Jane\Component\OpenApi2\Tests\Expected\ModelInResponse\Runtime\JsonObject($this->normalizer->normalize($data->objectProperty ?? null, 'json', $context));
        }
        if (array_key_exists('objectRefProperty', get_object_vars($data)) && null !== ($data->objectRefProperty ?? null)) {
            $dataArray['objectRefProperty'] = ($data->objectRefProperty ?? null) === null ? null : new \Jane\Component\OpenApi2\Tests\Expected\ModelInResponse\Runtime\JsonObject($this->normalizer->normalize($data->objectRefProperty ?? null, 'json', $context));
        }
        return $dataArray;
    }
    public function getSupportedTypes(?string $format = null): array
    {
        return [\Jane\Component\OpenApi2\Tests\Expected\ModelInResponse\Model\Schema::class => false];
    }
}