...
class SchemaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('objectProperty', get_object_vars($data)) && null !== ($data->objectProperty ?? null)) {
            ...
            $dataArray['objectProperty'] = \is_iterable($normalized) ? new \Jane\Component\OpenApi2\Tests\Expected\ModelInResponse\Runtime\JsonObject($normalized) : $normalized;
        }
        if (array_key_exists('objectRefProperty', get_object_vars($data)) && null !== ($data->objectRefProperty ?? null)) {
            ...
            $dataArray['objectRefProperty'] = \is_iterable($normalized_1) ? new \Jane\Component\OpenApi2\Tests\Expected\ModelInResponse\Runtime\JsonObject($normalized_1) : $normalized_1;
        }
        return $dataArray;
    }
