...
class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    private function initNormalizer(string $normalizerClass)
    {
        $normalizer = match ($normalizerClass) {
            \Jane\Component\OpenApi2\Tests\Expected\Discriminator\Normalizer\PetNormalizer::class => new \Jane\Component\OpenApi2\Tests\Expected\Discriminator\Normalizer\PetNormalizer(),
            \Jane\Component\OpenApi2\Tests\Expected\Discriminator\Normalizer\CatNormalizer::class => new \Jane\Component\OpenApi2\Tests\Expected\Discriminator\Normalizer\CatNormalizer(),
            \Jane\Component\OpenApi2\Tests\Expected\Discriminator\Normalizer\DogNormalizer::class => new \Jane\Component\OpenApi2\Tests\Expected\Discriminator\Normalizer\DogNormalizer(),
            \Jane\Component\OpenApi2\Tests\Expected\Discriminator\Runtime\Normalizer\ReferenceNormalizer::class => new \Jane\Component\OpenApi2\Tests\Expected\Discriminator\Runtime\Normalizer\ReferenceNormalizer(),
