...
class InvoiceMessageNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\InvoiceMessage';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\InvoiceMessage';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Jane\Component\OpenApi2\Tests\Expected\Model\InvoiceMessage();
        ...
        if (\array_key_exists('recipients', $data)) {
            ...
            foreach ($data['recipients'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\InvoiceMessageRecipient', 'json', $context);
            }
