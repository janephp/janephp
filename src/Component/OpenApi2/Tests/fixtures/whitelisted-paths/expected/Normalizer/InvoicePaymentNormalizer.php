...
class InvoicePaymentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\InvoicePayment';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\InvoicePayment';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Jane\Component\OpenApi2\Tests\Expected\Model\InvoicePayment();
        ...
        if (\array_key_exists('payment_gateway', $data)) {
            $object->setPaymentGateway($this->denormalizer->denormalize($data['payment_gateway'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\InvoicePaymentPaymentGateway', 'json', $context));
        }
