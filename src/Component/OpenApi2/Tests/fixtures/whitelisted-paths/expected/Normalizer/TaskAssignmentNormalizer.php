...
class TaskAssignmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\TaskAssignment';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\TaskAssignment';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Jane\Component\OpenApi2\Tests\Expected\Model\TaskAssignment();
        ...
        if (\array_key_exists('project', $data)) {
            $object->setProject($this->denormalizer->denormalize($data['project'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\TaskAssignmentProject', 'json', $context));
        }
        if (\array_key_exists('task', $data)) {
            $object->setTask($this->denormalizer->denormalize($data['task'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\TaskAssignmentTask', 'json', $context));
        }
