...
class TimeEntryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\TimeEntry';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\TimeEntry';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Jane\Component\OpenApi2\Tests\Expected\Model\TimeEntry();
        ...
        if (\array_key_exists('user', $data)) {
            $object->setUser($this->denormalizer->denormalize($data['user'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\TimeEntryUser', 'json', $context));
        }
        if (\array_key_exists('user_assignment', $data)) {
            $object->setUserAssignment($this->denormalizer->denormalize($data['user_assignment'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\UserAssignment', 'json', $context));
        }
        if (\array_key_exists('client', $data)) {
            $object->setClient($this->denormalizer->denormalize($data['client'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\TimeEntryClient', 'json', $context));
        }
        if (\array_key_exists('project', $data)) {
            $object->setProject($this->denormalizer->denormalize($data['project'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\TimeEntryProject', 'json', $context));
        }
        if (\array_key_exists('task', $data)) {
            $object->setTask($this->denormalizer->denormalize($data['task'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\TimeEntryTask', 'json', $context));
        }
        if (\array_key_exists('task_assignment', $data)) {
            $object->setTaskAssignment($this->denormalizer->denormalize($data['task_assignment'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\TaskAssignment', 'json', $context));
        }
        if (\array_key_exists('external_reference', $data)) {
            $object->setExternalReference($this->denormalizer->denormalize($data['external_reference'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\TimeEntryExternalReference', 'json', $context));
        }
        if (\array_key_exists('invoice', $data)) {
            $object->setInvoice($this->denormalizer->denormalize($data['invoice'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\TimeEntryInvoice', 'json', $context));
        }
