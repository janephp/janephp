...
class InvoiceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\Invoice';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\Invoice';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Jane\Component\OpenApi2\Tests\Expected\Model\Invoice();
        ...
        if (\array_key_exists('client', $data)) {
            $object->setClient($this->denormalizer->denormalize($data['client'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\InvoiceClient', 'json', $context));
        }
        if (\array_key_exists('line_items', $data)) {
            $values = array();
            foreach ($data['line_items'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\InvoiceLineItem', 'json', $context);
            }
            $object->setLineItems($values);
        }
        if (\array_key_exists('estimate', $data)) {
            $object->setEstimate($this->denormalizer->denormalize($data['estimate'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\InvoiceEstimate', 'json', $context));
        }
        if (\array_key_exists('retainer', $data)) {
            $object->setRetainer($this->denormalizer->denormalize($data['retainer'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\InvoiceRetainer', 'json', $context));
        }
        if (\array_key_exists('creator', $data)) {
            $object->setCreator($this->denormalizer->denormalize($data['creator'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\InvoiceCreator', 'json', $context));
        }
