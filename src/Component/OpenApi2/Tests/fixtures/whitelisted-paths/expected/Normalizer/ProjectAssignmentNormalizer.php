...
class ProjectAssignmentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\ProjectAssignment';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\ProjectAssignment';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Jane\Component\OpenApi2\Tests\Expected\Model\ProjectAssignment();
        ...
        if (\array_key_exists('project', $data)) {
            $object->setProject($this->denormalizer->denormalize($data['project'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\ProjectAssignmentProject', 'json', $context));
        }
        if (\array_key_exists('client', $data)) {
            $object->setClient($this->denormalizer->denormalize($data['client'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\ProjectAssignmentClient', 'json', $context));
        }
        if (\array_key_exists('task_assignments', $data)) {
            $values = array();
            foreach ($data['task_assignments'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\TaskAssignment', 'json', $context);
            }
