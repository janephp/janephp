...
class ExpenseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\Expense';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\Expense';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Jane\Component\OpenApi2\Tests\Expected\Model\Expense();
        ...
        if (\array_key_exists('client', $data)) {
            $object->setClient($this->denormalizer->denormalize($data['client'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\ExpenseClient', 'json', $context));
        }
        if (\array_key_exists('project', $data)) {
            $object->setProject($this->denormalizer->denormalize($data['project'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\ExpenseProject', 'json', $context));
        }
        if (\array_key_exists('expense_category', $data)) {
            $object->setExpenseCategory($this->denormalizer->denormalize($data['expense_category'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\ExpenseExpenseCategory', 'json', $context));
        }
        if (\array_key_exists('user', $data)) {
            $object->setUser($this->denormalizer->denormalize($data['user'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\ExpenseUser', 'json', $context));
        }
        ...
        if (\array_key_exists('receipt', $data)) {
            $object->setReceipt($this->denormalizer->denormalize($data['receipt'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\ExpenseReceipt', 'json', $context));
        }
        if (\array_key_exists('invoice', $data)) {
            $object->setInvoice($this->denormalizer->denormalize($data['invoice'], 'Jane\\Component\\OpenApi2\\Tests\\Expected\\Model\\ExpenseInvoice', 'json', $context));
        }
