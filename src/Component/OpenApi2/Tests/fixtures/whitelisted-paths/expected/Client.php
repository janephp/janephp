...
class Client extends \Jane\OpenApi2\Tests\Expected\Runtime\Client\Client
{
     ...
     */
    public function createProject(\Jane\OpenApi2\Tests\Expected\Model\ProjectsPostBody $payload)
    {
        return $this->executeEndpoint(new \Jane\OpenApi2\Tests\Expected\Endpoint\CreateProject($payload));
    }
