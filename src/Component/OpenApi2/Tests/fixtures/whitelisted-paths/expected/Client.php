...
class Client extends \Jane\OpenApi2\Tests\Expected\WhitelistedPaths\Runtime\Client\Client
{
     ...
     *
     * @return ($fetch is 'object' ? null|\Jane\OpenApi2\Tests\Expected\WhitelistedPaths\Model\Company|\Jane\OpenApi2\Tests\Expected\WhitelistedPaths\Model\Error : \Psr\Http\Message\ResponseInterface)
     */
    public function retrieveCompany(string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Jane\OpenApi2\Tests\Expected\WhitelistedPaths\Endpoint\RetrieveCompany(), $fetch);
    }
    /**
     ...
     * @return ($fetch is 'object' ? null|\Jane\OpenApi2\Tests\Expected\WhitelistedPaths\Model\Company|\Jane\OpenApi2\Tests\Expected\WhitelistedPaths\Model\Error : \Psr\Http\Message\ResponseInterface)
     */
    public function updateCompany(\Jane\OpenApi2\Tests\Expected\WhitelistedPaths\Model\CompanyPatchBody $payload, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Jane\OpenApi2\Tests\Expected\WhitelistedPaths\Endpoint\UpdateCompany($payload), $fetch);
    }
    /**
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|\Jane\OpenApi2\Tests\Expected\WhitelistedPaths\Model\Projects|\Jane\OpenApi2\Tests\Expected\WhitelistedPaths\Model\Error : \Psr\Http\Message\ResponseInterface)
     */
    public function listProjects(array $queryParameters = [], string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Jane\OpenApi2\Tests\Expected\WhitelistedPaths\Endpoint\ListProjects($queryParameters), $fetch);
    }
    /**
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return ($fetch is 'object' ? null|\Jane\OpenApi2\Tests\Expected\WhitelistedPaths\Model\Project|\Jane\OpenApi2\Tests\Expected\WhitelistedPaths\Model\Error : \Psr\Http\Message\ResponseInterface)
     */
    public function createProject(\Jane\OpenApi2\Tests\Expected\WhitelistedPaths\Model\ProjectsPostBody $payload, string $fetch = self::FETCH_OBJECT)
    {
