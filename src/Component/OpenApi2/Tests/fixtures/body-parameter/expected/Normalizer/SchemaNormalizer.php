...
class SchemaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('objectProperty', get_object_vars($data)) && null !== ($data->objectProperty ?? null)) {
            $dataArray['objectProperty'] = new \Jane\Component\OpenApi2\Tests\Expected\BodyParameter\Runtime\JsonObject($this->normalizer->normalize($data->objectProperty, 'json', $context));
        }
        if (array_key_exists('objectRefProperty', get_object_vars($data)) && null !== ($data->objectRefProperty ?? null)) {
            $dataArray['objectRefProperty'] = new \Jane\Component\OpenApi2\Tests\Expected\BodyParameter\Runtime\JsonObject($this->normalizer->normalize($data->objectRefProperty, 'json', $context));
        }
        return $dataArray;
    }
