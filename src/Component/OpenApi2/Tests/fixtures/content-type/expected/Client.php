...
class Client extends \Jane\Component\OpenApi2\Tests\Expected\Runtime\Client\Client
{
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi2\Tests\Expected\Endpoint\BodyParameterTriggersContentTypeBeingSet($testString));
    }
    /**
     *
     * @return null
    ...
    {
        return $this->executeEndpoint(new \Jane\Component\OpenApi2\Tests\Expected\Endpoint\ProducesTriggersAcceptBeingSet());
    }
