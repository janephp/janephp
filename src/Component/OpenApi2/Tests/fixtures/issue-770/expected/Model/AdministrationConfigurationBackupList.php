...
class AdministrationConfigurationBackupList
{
    /**
     * @var array
     */
    ...
    /**
     * @var list<AdministrationBackupFile>
     */
    protected $list;
    /**
     * @return int
    ...
    /**
     * @return list<AdministrationBackupFile>
     */
    ...
    /**
     * @param list<AdministrationBackupFile> $list
     *
     * @return self
     */
