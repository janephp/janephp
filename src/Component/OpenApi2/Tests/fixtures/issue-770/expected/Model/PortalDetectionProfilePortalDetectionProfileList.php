...
class PortalDetectionProfilePortalDetectionProfileList
{
    /**
     * @var array
     */
    ...
    protected $extra;
    /**
     * @var list<PortalDetectionProfilePortalDetectionProfile>
     */
    protected $list;
    /**
     * @return int
    ...
    /**
     * @return list<PortalDetectionProfilePortalDetectionProfile>
     */
    ...
    /**
     * @param list<PortalDetectionProfilePortalDetectionProfile> $list
     *
     * @return self
     */
