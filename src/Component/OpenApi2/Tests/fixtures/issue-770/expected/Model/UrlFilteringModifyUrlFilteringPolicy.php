...
class UrlFilteringModifyUrlFilteringPolicy
{
    ...
    /**
     * @return UrlFilteringModifyUrlFilteringPolicyBlockByThreatLevelConfig
     */
    public function getBlockByThreatLevelConfig(): UrlFilteringModifyUrlFilteringPolicyBlockByThreatLevelConfig
    {
        return $this->blockByThreatLevelConfig;
    }
    /**
     * @param UrlFilteringModifyUrlFilteringPolicyBlockByThreatLevelConfig $blockByThreatLevelConfig
     *
     * @return self
     */
    public function setBlockByThreatLevelConfig(UrlFilteringModifyUrlFilteringPolicyBlockByThreatLevelConfig $blockByThreatLevelConfig): self
    {
