...
class ServiceRadiusAccountingServiceList
{
    /**
     * @var array
     */
    ...
    protected $extra;
    /**
     * @var list<ServiceRadiusAccountingService>
     */
    protected $list;
    /**
     * @return int
    ...
    /**
     * @return list<ServiceRadiusAccountingService>
     */
    ...
    /**
     * @param list<ServiceRadiusAccountingService> $list
     *
     * @return self
     */
