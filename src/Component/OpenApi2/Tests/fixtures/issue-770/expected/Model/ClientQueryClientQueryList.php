...
class ClientQueryClientQueryList
{
    /**
     * @var array
     */
    ...
    protected $extra;
    /**
     * @var list<ClientQueryCreateClientQuery>
     */
    protected $list;
    /**
     * @return int
    ...
    /**
     * @return list<ClientQueryCreateClientQuery>
     */
    ...
    /**
     * @param list<ClientQueryCreateClientQuery> $list
     *
     * @return self
     */
