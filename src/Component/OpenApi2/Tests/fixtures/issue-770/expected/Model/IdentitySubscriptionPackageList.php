...
class IdentitySubscriptionPackageList
{
    /**
     * @var array
     */
    ...
    protected $extra;
    /**
     * @var list<IdentitySubscriptionPackageListListItem>
     */
    protected $list;
    /**
     * @return int
    ...
    /**
     * @return list<IdentitySubscriptionPackageListListItem>
     */
    ...
    /**
     * @param list<IdentitySubscriptionPackageListListItem> $list
     *
     * @return self
     */
