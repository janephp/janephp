...
class ZoneAvailableTunnelProfileList
{
    /**
     * @var array
     */
    ...
    /**
     * @var list<ZoneAvailableTunnelProfile>
     */
    protected $list;
    /**
     * @return int
    ...
    /**
     * @return list<ZoneAvailableTunnelProfile>
     */
    ...
    /**
     * @param list<ZoneAvailableTunnelProfile> $list
     *
     * @return self
     */
