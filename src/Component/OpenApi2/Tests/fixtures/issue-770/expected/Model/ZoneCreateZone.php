...
class ZoneCreateZone
{
     ...
     * @var int
     */
    public int $dosBarringPeriod = 60;
    /**
     * DoS Protection(Barring UE) threshold of the zone.
     *
     * @var int
     */
    public int $dosBarringThreshold = 5;
    /**
     * DoS Protection(Barring UE) check period of the zone.
     *
     * @var int
     */
    public int $dosBarringCheckPeriod = 30;
    /**
     * @var CommonGenericRef
     */
     ...
     * @var bool
     */
    public bool $clusterRedundancyEnabled = false;
    /**
     ...
     * @var bool
     */
    public bool $rogueApJammingDetection = false;
    /**
     * @var int
     */
     ...
     * @var bool
     */
    public bool $directedMulticastFromWiredClientEnabled = true;
    /**
     * Directed multicast from wireless client.
     *
     * @var bool
     */
    public bool $directedMulticastFromWirelessClientEnabled = true;
    /**
     * Directed multicast from network.
     *
     * @var bool
     */
    public bool $directedMulticastFromNetworkEnabled = true;
    /**
     ...
     * @var bool
     */
    public bool $rksGreForwardBroadcast = false;
    /**
     * @var string
     */
    public string $sshTunnelEncryption = 'AES128';
    /**
