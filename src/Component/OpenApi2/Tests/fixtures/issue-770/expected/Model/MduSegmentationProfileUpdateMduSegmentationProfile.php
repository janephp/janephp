...
class MduSegmentationProfileUpdateMduSegmentationProfile
{
    ...
    /**
     * @return MduSegmentationProfileUpdateMduSegmentationProfileNetworkSegmentationSwitchInfo
     */
    public function getNetworkSegmentationSwitchInfo(): MduSegmentationProfileUpdateMduSegmentationProfileNetworkSegmentationSwitchInfo
    {
        return $this->networkSegmentationSwitchInfo;
    }
    /**
     * @param MduSegmentationProfileUpdateMduSegmentationProfileNetworkSegmentationSwitchInfo $networkSegmentationSwitchInfo
     *
     * @return self
     */
    public function setNetworkSegmentationSwitchInfo(MduSegmentationProfileUpdateMduSegmentationProfileNetworkSegmentationSwitchInfo $networkSegmentationSwitchInfo): self
    {
