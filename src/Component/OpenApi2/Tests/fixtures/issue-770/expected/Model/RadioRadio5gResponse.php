...
class RadioRadio5gResponse
{
     ...
     * @var list<int>
     */
    protected $availableChannelRange;
    /**
     * @var list<int>
     */
    protected $availableChannelRangeIndoor;
    /**
     * @var string
     */
     ...
     * @return list<int>
     */
    public function getAvailableChannelRange(): array
    {
        return $this->availableChannelRange;
    }
    /**
     * @param list<int> $availableChannelRange
     *
     * @return self
     */
    public function setAvailableChannelRange(array $availableChannelRange): self
    {
        $this->initialized['availableChannelRange'] = true;
        $this->availableChannelRange = $availableChannelRange;
        return $this;
    }
    /**
     * @return list<int>
     */
    public function getAvailableChannelRangeIndoor(): array
    {
        return $this->availableChannelRangeIndoor;
    }
    /**
     * @param list<int> $availableChannelRangeIndoor
     *
     * @return self
     */
    public function setAvailableChannelRangeIndoor(array $availableChannelRangeIndoor): self
    {
        $this->initialized['availableChannelRangeIndoor'] = true;
        $this->availableChannelRangeIndoor = $availableChannelRangeIndoor;
        return $this;
    }
    /**
     * @return string
