...
class ServiceCommonAccountingServiceList
{
    /**
     * @var array
     */
    ...
    protected $extra;
    /**
     * @var list<ServiceCommonAccountingService>
     */
    protected $list;
    /**
     * @return int
    ...
    /**
     * @return list<ServiceCommonAccountingService>
     */
    ...
    /**
     * @param list<ServiceCommonAccountingService> $list
     *
     * @return self
     */
