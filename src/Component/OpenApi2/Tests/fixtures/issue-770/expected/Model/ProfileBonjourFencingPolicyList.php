...
class ProfileBonjourFencingPolicyList
{
    /**
     * @var array
     */
    ...
    /**
     * @var list<ProfileBonjourFencingPolicy>
     */
    protected $list;
    /**
     * @return int
    ...
    /**
     * @return list<ProfileBonjourFencingPolicy>
     */
    ...
    /**
     * @param list<ProfileBonjourFencingPolicy> $list
     *
     * @return self
     */
