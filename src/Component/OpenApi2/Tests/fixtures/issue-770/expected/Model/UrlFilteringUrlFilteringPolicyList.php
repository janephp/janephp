...
class UrlFilteringUrlFilteringPolicyList
{
    /**
     * @var array
     */
    ...
    protected $extra;
    /**
     * @var list<UrlFilteringUrlFilteringPolicy>
     */
    protected $list;
    /**
     * @return int
    ...
    /**
     * @return list<UrlFilteringUrlFilteringPolicy>
     */
    ...
    /**
     * @param list<UrlFilteringUrlFilteringPolicy> $list
     *
     * @return self
     */
