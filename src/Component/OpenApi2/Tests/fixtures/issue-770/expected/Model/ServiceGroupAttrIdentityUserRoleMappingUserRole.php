...
class ServiceGroupAttrIdentityUserRoleMappingUserRole
{
     ...
     * Identity user role
     *
     * @return ServiceGroupAttrIdentityUserRoleMappingUserRoleUserTrafficProfile
     */
    public function getUserTrafficProfile(): ServiceGroupAttrIdentityUserRoleMappingUserRoleUserTrafficProfile
    {
     ...
     * Identity user role
     *
     * @param ServiceGroupAttrIdentityUserRoleMappingUserRoleUserTrafficProfile $userTrafficProfile
     *
     * @return self
     */
    public function setUserTrafficProfile(ServiceGroupAttrIdentityUserRoleMappingUserRoleUserTrafficProfile $userTrafficProfile): self
    {
