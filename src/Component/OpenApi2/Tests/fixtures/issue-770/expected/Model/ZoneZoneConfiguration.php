...
class ZoneZoneConfiguration
{
     ...
     * @var bool
     */
    protected $restrictedApAccessEnabled;
    /**
     * Restricted AP Access Profile Id of the zone.
     *
     * @var string
     */
    protected $restrictedApAccessProfileId;
    /**
     ...
     * @var bool
     */
    protected $rogueApJammingDetection;
    /**
     * @var int
     */
     ...
     * @return bool
     */
    public function getRestrictedApAccessEnabled(): bool
    {
        return $this->restrictedApAccessEnabled;
    }
    /**
     * Enable Restricted AP Access of the zone.
     *
     * @param bool $restrictedApAccessEnabled
     *
     * @return self
     */
    public function setRestrictedApAccessEnabled(bool $restrictedApAccessEnabled): self
    {
        $this->initialized['restrictedApAccessEnabled'] = true;
        $this->restrictedApAccessEnabled = $restrictedApAccessEnabled;
        return $this;
    }
    /**
     * Restricted AP Access Profile Id of the zone.
     ...
     * @return string
     */
    public function getRestrictedApAccessProfileId(): string
    {
        return $this->restrictedApAccessProfileId;
    }
    /**
     * Restricted AP Access Profile Id of the zone.
     *
     * @param string $restrictedApAccessProfileId
     *
     * @return self
     */
    public function setRestrictedApAccessProfileId(string $restrictedApAccessProfileId): self
    {
        $this->initialized['restrictedApAccessProfileId'] = true;
        $this->restrictedApAccessProfileId = $restrictedApAccessProfileId;
        return $this;
    }
    /**
     * Enable Bonjour Fencing Policy on the AP
