...
class ProfileFirewallProfileQueryCriteriaoptions
{
    ...
    /**
     * Include the system default Firewall profile as well while querying.
     *
     * @var bool
     */
    protected $includeSystemDefault;
    /**
     * include Not Available auth service option while returning result
     *
     * @return bool
     ...
     * @return bool
     */
    public function getIncludeSystemDefault(): bool
    {
        return $this->includeSystemDefault;
    }
    /**
     * Include the system default Firewall profile as well while querying.
     *
     * @param bool $includeSystemDefault
     *
     * @return self
     */
    public function setIncludeSystemDefault(bool $includeSystemDefault): self
    {
        $this->initialized['includeSystemDefault'] = true;
        $this->includeSystemDefault = $includeSystemDefault;
        return $this;
    }
}