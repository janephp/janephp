...
class VendorSpecificAttributeProfileQueryCriteriaResult
{
    /**
     * @var array
     */
    ...
    protected $extra;
    /**
     * @var list<VendorSpecificAttributeProfileGet>
     */
    protected $list;
    /**
     * @return int
    ...
    /**
     * @return list<VendorSpecificAttributeProfileGet>
     */
    ...
    /**
     * @param list<VendorSpecificAttributeProfileGet> $list
     *
     * @return self
     */
