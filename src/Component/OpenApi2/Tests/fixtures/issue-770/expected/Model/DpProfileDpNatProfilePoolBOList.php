...
class DpProfileDpNatProfilePoolBOList
{
    /**
     * @var array
     */
    ...
    /**
     * @var list<DpProfileDpNatProfilePoolBO>
     */
    protected $list;
    /**
     * @return int
    ...
    /**
     * @return list<DpProfileDpNatProfilePoolBO>
     */
    ...
    /**
     * @param list<DpProfileDpNatProfilePoolBO> $list
     *
     * @return self
     */
