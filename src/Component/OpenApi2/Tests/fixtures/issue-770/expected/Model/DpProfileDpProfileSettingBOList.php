...
class DpProfileDpProfileSettingBOList
{
    /**
     * @var array
     */
    ...
    /**
     * @var list<DpProfileDpProfileSettingBO>
     */
    protected $list;
    /**
     * @return int
    ...
    /**
     * @return list<DpProfileDpProfileSettingBO>
     */
    ...
    /**
     * @param list<DpProfileDpProfileSettingBO> $list
     *
     * @return self
     */
