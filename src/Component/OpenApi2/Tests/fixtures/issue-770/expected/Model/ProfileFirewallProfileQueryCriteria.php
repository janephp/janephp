...
class ProfileFirewallProfileQueryCriteria
{
    /**
     * @var array
     */
     ...
     *
     * @var list<CommonQueryCriteriaExtraFiltersItem>
     */
     ...
     * "AND" condition for multiple filters
     *
     * @return list<CommonQueryCriteriaExtraFiltersItem>
     */
     ...
     * "AND" condition for multiple filters
     *
     * @param list<CommonQueryCriteriaExtraFiltersItem> $extraFilters
     *
     * @return self
     */
