...
class RadioRadio6gResponse
{
     ...
     * @var bool
     */
    protected $lowPowerIndoorModeEnabled;
    /**
     * @var list<int>
     */
     ...
     * @return bool
     */
    public function getLowPowerIndoorModeEnabled(): bool
    {
        return $this->lowPowerIndoorModeEnabled;
    }
    /**
     * @param bool $lowPowerIndoorModeEnabled
     *
     * @return self
     */
    public function setLowPowerIndoorModeEnabled(bool $lowPowerIndoorModeEnabled): self
    {
        $this->initialized['lowPowerIndoorModeEnabled'] = true;
        $this->lowPowerIndoorModeEnabled = $lowPowerIndoorModeEnabled;
        return $this;
    }
    /**
     * @return list<int>
