...
class WlanCreateStandardOpenWlan
{
    /**
     * @var array
     */
    ...
    /**
     * To Create a WLAN with "networkSegmentationEnabled": true, enabling externalDpsk and authService are required. Please also setup "externalDpsk": {"enabled": true, "authService": { "id": "profile_id" } } in Request Body
     *
     * @var bool
     */
     ...
     * @var string
     */
    protected $accessTunnelType = 'APLBO';
    /**
