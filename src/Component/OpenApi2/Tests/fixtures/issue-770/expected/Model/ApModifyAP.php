...
class ApModifyAP
{
    ...
    /**
     * @return RadioRadioConfigAp
     */
    public function getRadioConfig(): RadioRadioConfigAp
    {
        return $this->radioConfig;
    }
    /**
     * @param RadioRadioConfigAp $radioConfig
     *
     * @return self
     */
    public function setRadioConfig(RadioRadioConfigAp $radioConfig): self
    {
