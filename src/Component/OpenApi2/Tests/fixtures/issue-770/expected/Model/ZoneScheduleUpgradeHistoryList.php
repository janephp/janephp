...
class ZoneScheduleUpgradeHistoryList
{
    /**
     * @var array
     */
    ...
    /**
     * @var list<ZoneScheduleUpgradeHistory>
     */
    protected $list;
    /**
     * @return int
    ...
    /**
     * @return list<ZoneScheduleUpgradeHistory>
     */
    ...
    /**
     * @param list<ZoneScheduleUpgradeHistory> $list
     *
     * @return self
     */
