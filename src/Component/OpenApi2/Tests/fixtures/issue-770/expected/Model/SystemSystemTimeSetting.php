...
class SystemSystemTimeSetting
{
     ...
     * @var string
     */
    protected $currentSystemTimeString;
    /**
     * System UTC Time
     *
     * @var string
     */
    protected $currentSystemTimeUTCString;
    /**
     ...
     * @return string
     */
    public function getCurrentSystemTimeString(): string
    {
        return $this->currentSystemTimeString;
    }
    /**
     * System Time
     *
     * @param string $currentSystemTimeString
     *
     * @return self
     */
    public function setCurrentSystemTimeString(string $currentSystemTimeString): self
    {
        $this->initialized['currentSystemTimeString'] = true;
        $this->currentSystemTimeString = $currentSystemTimeString;
        return $this;
    }
    /**
     * System UTC Time
     ...
     * @return string
     */
    public function getCurrentSystemTimeUTCString(): string
    {
        return $this->currentSystemTimeUTCString;
    }
    /**
     * System UTC Time
     *
     * @param string $currentSystemTimeUTCString
     *
     * @return self
     */
    public function setCurrentSystemTimeUTCString(string $currentSystemTimeUTCString): self
    {
        $this->initialized['currentSystemTimeUTCString'] = true;
        $this->currentSystemTimeUTCString = $currentSystemTimeUTCString;
        return $this;
    }
    /**
     * Primary NtpServer address
