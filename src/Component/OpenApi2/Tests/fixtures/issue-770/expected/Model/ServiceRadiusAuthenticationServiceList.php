...
class ServiceRadiusAuthenticationServiceList
{
    /**
     * @var array
     */
    ...
    protected $extra;
    /**
     * @var list<ServiceRadiusAuthenticationService>
     */
    protected $list;
    /**
     * @return int
    ...
    /**
     * @return list<ServiceRadiusAuthenticationService>
     */
    ...
    /**
     * @param list<ServiceRadiusAuthenticationService> $list
     *
     * @return self
     */
