...
class FindDomainsEventNotificationSettingsByDomainId extends \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\Client\BaseEndpoint implements \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\Client\Endpoint
{
    protected $domainId;
    /**
    ...
    protected function transformResponseBody(\Symfony\Contracts\HttpClient\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (400 === $status) {
            throw new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Exception\FindDomainsEventNotificationSettingsByDomainIdBadRequestException($response);
        }
        if (403 === $status) {
            throw new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Exception\FindDomainsEventNotificationSettingsByDomainIdForbiddenException($response);
        }
        if (500 === $status) {
            throw new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Exception\FindDomainsEventNotificationSettingsByDomainIdInternalServerErrorException($response);
        }
        if (200 === $status) {
    ...
    {
        return \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\EventManagementEventDataResponse::class;
    }
}