...
class ZoneLoadBalancingNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\Tests\Expected\Model\ZoneLoadBalancing::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Component\OpenApi3\Tests\Expected\Model\ZoneLoadBalancing::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Component\OpenApi3\Tests\Expected\Model\ZoneLoadBalancing();
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('bandBalancing') && null !== $data->getBandBalancing()) {
            $dataArray['bandBalancing'] = $this->normalizer->normalize($data->getBandBalancing(), 'json', $context);
        }
    ...
    {
        return [\Jane\Component\OpenApi3\Tests\Expected\Model\ZoneLoadBalancing::class => false];
    }
}