...
class SystemSnmpAgentConfigurationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        $dataArray = [];
        if (array_key_exists('snmpNotificationEnabled', get_object_vars($data)) && null !== ($data->snmpNotificationEnabled ?? null)) {
