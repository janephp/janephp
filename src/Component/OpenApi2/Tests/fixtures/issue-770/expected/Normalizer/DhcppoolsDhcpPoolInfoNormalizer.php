...
class DhcppoolsDhcpPoolInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('clientInfoList', $data)) {
            $object->setClientInfoList($this->denormalizer->denormalize($data['clientInfoList'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\DhcppoolsDhcpPoolInfoClientInfoList::class, 'json', $context));
        }
        return $object;
    }
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('clientInfoList') && null !== $data->getClientInfoList()) {
            $dataArray['clientInfoList'] = $data->getClientInfoList() === null ? null : new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($this->normalizer->normalize($data->getClientInfoList(), 'json', $context));
        }
        return $dataArray;
    }
