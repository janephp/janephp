...
class AdministrationLicensesSummaryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('capacityControlLicenseCount', $data)) {
            $object->setCapacityControlLicenseCount($this->denormalizer->denormalize($data['capacityControlLicenseCount'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\AdministrationLicensesSummaryCapacityControlLicenseCount::class, 'json', $context));
        }
        return $object;
    }
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('capacityControlLicenseCount') && null !== $data->getCapacityControlLicenseCount()) {
            $dataArray['capacityControlLicenseCount'] = $data->getCapacityControlLicenseCount() === null ? null : new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($this->normalizer->normalize($data->getCapacityControlLicenseCount(), 'json', $context));
        }
        return $dataArray;
    }
