...
class IdentityIdentityGuestPassConfigurationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('wlan', get_object_vars($data)) && null !== ($data->wlan ?? null)) {
            $dataArray['wlan'] = new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($this->normalizer->normalize($data->wlan, 'json', $context));
        }
        if (array_key_exists('zone', get_object_vars($data)) && null !== ($data->zone ?? null)) {
            $dataArray['zone'] = new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($this->normalizer->normalize($data->zone, 'json', $context));
        }
        ...
        if (array_key_exists('passValidFor', get_object_vars($data)) && null !== ($data->passValidFor ?? null)) {
            $dataArray['passValidFor'] = new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($this->normalizer->normalize($data->passValidFor, 'json', $context));
        }
