...
class ServiceModifyRadiusAuthenticationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\ServiceModifyRadiusAuthentication::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\ServiceModifyRadiusAuthentication::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\ServiceModifyRadiusAuthentication();
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('rateLimiting', get_object_vars($data)) && null !== ($data->rateLimiting ?? null)) {
            $dataArray['rateLimiting'] = new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($this->normalizer->normalize($data->rateLimiting, 'json', $context));
        }
    ...
    {
        return [\Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\ServiceModifyRadiusAuthentication::class => false];
    }
}