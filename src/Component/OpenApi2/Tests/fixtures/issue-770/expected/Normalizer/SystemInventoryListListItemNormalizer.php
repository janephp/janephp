...
class SystemInventoryListListItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\SystemInventoryListListItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\SystemInventoryListListItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\SystemInventoryListListItem();
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('meshSSID', get_object_vars($data)) && null !== ($data->meshSSID ?? null)) {
            $dataArray['meshSSID'] = $data->meshSSID;
        }
        ...
        if (array_key_exists('apFirmwareVersion', get_object_vars($data)) && null !== ($data->apFirmwareVersion ?? null)) {
            $dataArray['apFirmwareVersion'] = $data->apFirmwareVersion;
        }
        if (array_key_exists('meshEnabled', get_object_vars($data)) && null !== ($data->meshEnabled ?? null)) {
            $dataArray['meshEnabled'] = $data->meshEnabled;
        }
        return $dataArray;
    }
    public function getSupportedTypes(?string $format = null): array
    {
        return [\Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\SystemInventoryListListItem::class => false];
    }
}