...
class RadioRadio24gResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\RadioRadio24gResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\RadioRadio24gResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\RadioRadio24gResponse();
        ...
        if (\array_key_exists('availableChannelRange', $data)) {
            ...
            $object->setAvailableChannelRange($values_1);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('availableChannelRange') && null !== $data->getAvailableChannelRange()) {
            $values_1 = [];
            foreach ($data->getAvailableChannelRange() as $value_1) {
                $values_1[] = $value_1;
            }
    ...
    {
        return [\Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\RadioRadio24gResponse::class => false];
    }
}