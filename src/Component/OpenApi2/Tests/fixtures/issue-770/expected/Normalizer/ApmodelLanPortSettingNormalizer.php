...
class ApmodelLanPortSettingNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\Tests\Expected\Model\ApmodelLanPortSetting::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Component\OpenApi3\Tests\Expected\Model\ApmodelLanPortSetting::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Jane\Component\OpenApi3\Tests\Expected\Model\ApmodelLanPortSetting();
        ...
        if (\array_key_exists('overwriteVlanEnabled', $data)) {
            $object->setOverwriteVlanEnabled($data['overwriteVlanEnabled']);
        }
        if (\array_key_exists('vlanUntagId', $data)) {
            $object->setVlanUntagId($data['vlanUntagId']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('overwriteVlanEnabled') && null !== $data->getOverwriteVlanEnabled()) {
            $dataArray['overwriteVlanEnabled'] = $data->getOverwriteVlanEnabled();
        }
        if ($data->isInitialized('vlanUntagId') && null !== $data->getVlanUntagId()) {
            $dataArray['vlanUntagId'] = $data->getVlanUntagId();
        }
    ...
    {
        return [\Jane\Component\OpenApi3\Tests\Expected\Model\ApmodelLanPortSetting::class => false];
    }
}