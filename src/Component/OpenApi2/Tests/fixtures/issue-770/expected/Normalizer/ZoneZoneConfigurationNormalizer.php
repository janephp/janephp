...
class ZoneZoneConfigurationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('restrictedApAccessEnabled', $data)) {
            $object->setRestrictedApAccessEnabled($data['restrictedApAccessEnabled']);
        }
        if (\array_key_exists('restrictedApAccessProfileId', $data)) {
            $object->setRestrictedApAccessProfileId($data['restrictedApAccessProfileId']);
        }
        ...
        if (\array_key_exists('radioConfig', $data)) {
            $object->setRadioConfig($this->denormalizer->denormalize($data['radioConfig'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\RadioRadioConfigResponse::class, 'json', $context));
        }
        return $object;
    }
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('restrictedApAccessEnabled') && null !== $data->getRestrictedApAccessEnabled()) {
            $dataArray['restrictedApAccessEnabled'] = $data->getRestrictedApAccessEnabled();
        }
        if ($data->isInitialized('restrictedApAccessProfileId') && null !== $data->getRestrictedApAccessProfileId()) {
            $dataArray['restrictedApAccessProfileId'] = $data->getRestrictedApAccessProfileId();
        }
