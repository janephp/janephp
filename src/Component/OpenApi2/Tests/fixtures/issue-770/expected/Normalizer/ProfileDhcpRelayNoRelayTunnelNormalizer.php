...
class ProfileDhcpRelayNoRelayTunnelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('dhcpOption82', $data)) {
            $object->setDhcpOption82($this->denormalizer->denormalize($data['dhcpOption82'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\ProfileDhcpOption82::class, 'json', $context));
        }
        return $object;
    }
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('dhcpOption82') && null !== $data->getDhcpOption82()) {
            $dataArray['dhcpOption82'] = $data->getDhcpOption82() === null ? null : new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($this->normalizer->normalize($data->getDhcpOption82(), 'json', $context));
        }
        return $dataArray;
    }
