...
class RacStatsRadiusProxyListNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\Tests\Expected\Model\RacStatsRadiusProxyList::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Component\OpenApi3\Tests\Expected\Model\RacStatsRadiusProxyList::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Component\OpenApi3\Tests\Expected\Model\RacStatsRadiusProxyList();
        ...
        if (\array_key_exists('list', $data)) {
            ...
            foreach ($data['list'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Jane\Component\OpenApi3\Tests\Expected\Model\RacStatsRadiusProxy::class, 'json', $context);
            }
    ...
    {
        return [\Jane\Component\OpenApi3\Tests\Expected\Model\RacStatsRadiusProxyList::class => false];
    }
}