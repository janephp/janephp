...
class MduSegmentationProfileMduSegmentationProfileSummaryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('networkSegmentationSwitchInfo', $data)) {
            $object->setNetworkSegmentationSwitchInfo($this->denormalizer->denormalize($data['networkSegmentationSwitchInfo'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\MduSegmentationProfileMduSegmentationProfileSummaryNetworkSegmentationSwitchInfo::class, 'json', $context));
        }
        if (\array_key_exists('reviewData', $data)) {
            $object->setReviewData($this->denormalizer->denormalize($data['reviewData'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\MduSegmentationProfileMduSegmentationProfileSummaryReviewData::class, 'json', $context));
        }
        return $object;
    }
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('reviewData') && null !== $data->getReviewData()) {
            $dataArray['reviewData'] = $data->getReviewData() === null ? null : new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($this->normalizer->normalize($data->getReviewData(), 'json', $context));
        }
        return $dataArray;
    }
