...
class MduSegmentationProfileMduSegmentationProfileSummaryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('networkSegmentationSwitchInfo', $data)) {
            $object->setNetworkSegmentationSwitchInfo($this->denormalizer->denormalize($data['networkSegmentationSwitchInfo'], \Jane\Component\OpenApi3\Tests\Expected\Model\MduSegmentationProfileMduSegmentationProfileSummaryNetworkSegmentationSwitchInfo::class, 'json', $context));
        }
        if (\array_key_exists('reviewData', $data)) {
            $object->setReviewData($this->denormalizer->denormalize($data['reviewData'], \Jane\Component\OpenApi3\Tests\Expected\Model\MduSegmentationProfileMduSegmentationProfileSummaryReviewData::class, 'json', $context));
        }
        return $object;
    }
