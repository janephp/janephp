...
class DpProfileDpNatProfileBasicBONormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('natPublicSubnetId', $data)) {
            $object->setNatPublicSubnetId($this->denormalizer->denormalize($data['natPublicSubnetId'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\DpProfileDpNatProfilePublicSubnetIdBO::class, 'json', $context));
        }
        return $object;
    }
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('natPublicSubnetId') && null !== $data->getNatPublicSubnetId()) {
            $dataArray['natPublicSubnetId'] = $data->getNatPublicSubnetId() === null ? null : new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($this->normalizer->normalize($data->getNatPublicSubnetId(), 'json', $context));
        }
        return $dataArray;
    }
