...
class CommonSnmpUserNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\CommonSnmpUser::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\CommonSnmpUser::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\CommonSnmpUser();
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('readEnabled') && null !== $data->getReadEnabled()) {
            $dataArray['readEnabled'] = $data->getReadEnabled();
        }
        if ($data->isInitialized('writeEnabled') && null !== $data->getWriteEnabled()) {
            $dataArray['writeEnabled'] = $data->getWriteEnabled();
        }
        if ($data->isInitialized('notificationEnabled') && null !== $data->getNotificationEnabled()) {
    ...
    {
        return [\Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\CommonSnmpUser::class => false];
    }
}