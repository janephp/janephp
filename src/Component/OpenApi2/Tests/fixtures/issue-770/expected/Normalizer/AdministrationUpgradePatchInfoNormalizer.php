...
class AdministrationUpgradePatchInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('clusterOperationProgress', $data)) {
            $object->setClusterOperationProgress($this->denormalizer->denormalize($data['clusterOperationProgress'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\ClusterbladeClusterUpgradeProgress::class, 'json', $context));
        }
        if (\array_key_exists('uploadPatchInfo', $data)) {
            $object->setUploadPatchInfo($this->denormalizer->denormalize($data['uploadPatchInfo'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\ClusterbladeUploadPatchInfo::class, 'json', $context));
        }
        return $object;
    }
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('uploadPatchInfo') && null !== $data->getUploadPatchInfo()) {
            $dataArray['uploadPatchInfo'] = $data->getUploadPatchInfo() === null ? null : new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($this->normalizer->normalize($data->getUploadPatchInfo(), 'json', $context));
        }
        return $dataArray;
    }
