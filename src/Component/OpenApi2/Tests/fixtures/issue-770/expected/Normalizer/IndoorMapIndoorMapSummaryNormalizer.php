...
class IndoorMapIndoorMapSummaryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\IndoorMapIndoorMapSummary::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\IndoorMapIndoorMapSummary::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\IndoorMapIndoorMapSummary();
        ...
        if (\array_key_exists('scale', $data)) {
            $object->setScale($this->denormalizer->denormalize($data['scale'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\IndoorMapScale::class, 'json', $context));
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('scale') && null !== $data->getScale()) {
            $dataArray['scale'] = $data->getScale() === null ? null : new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($this->normalizer->normalize($data->getScale(), 'json', $context));
        }
    ...
    {
        return [\Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\IndoorMapIndoorMapSummary::class => false];
    }
}