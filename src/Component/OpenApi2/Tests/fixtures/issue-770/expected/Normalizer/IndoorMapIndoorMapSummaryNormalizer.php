...
class IndoorMapIndoorMapSummaryNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('imageFileName', $data)) {
            $object->imageFileName = $data['imageFileName'];
        }
        ...
        if (\array_key_exists('groupType', $data)) {
            $object->groupType = $data['groupType'];
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('scale', get_object_vars($data)) && null !== ($data->scale ?? null)) {
            $normalized = $this->normalizer->normalize($data->scale, 'json', $context);
            $dataArray['scale'] = \is_iterable($normalized) ? new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($normalized) : $normalized;
        }
