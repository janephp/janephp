...
class MduSegmentationProfileAccessSwitchObjNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('upLink', $data)) {
            $object->setUpLink($this->denormalizer->denormalize($data['upLink'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\MduSegmentationProfileUpLinkObj::class, 'json', $context));
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('upLink') && null !== $data->getUpLink()) {
            $dataArray['upLink'] = $data->getUpLink() === null ? null : new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($this->normalizer->normalize($data->getUpLink(), 'json', $context));
        }
