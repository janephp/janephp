...
class ProfileModifyIpAclRulesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\ProfileModifyIpAclRules::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\ProfileModifyIpAclRules::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\ProfileModifyIpAclRules();
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('enableSourceIpSubnet', get_object_vars($data)) && null !== ($data->enableSourceIpSubnet ?? null)) {
            $dataArray['enableSourceIpSubnet'] = $data->enableSourceIpSubnet;
        }
        ...
        if (array_key_exists('customProtocol', get_object_vars($data)) && null !== ($data->customProtocol ?? null)) {
            $dataArray['customProtocol'] = $data->customProtocol;
        }
        $dataArray['action'] = $data->action;
        $dataArray['direction'] = $data->direction;
        return $dataArray;
    }
    public function getSupportedTypes(?string $format = null): array
    {
        return [\Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\ProfileModifyIpAclRules::class => false];
    }
}