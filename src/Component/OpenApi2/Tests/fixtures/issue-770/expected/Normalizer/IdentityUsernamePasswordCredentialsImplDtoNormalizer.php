...
class IdentityUsernamePasswordCredentialsImplDtoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('authenticationServerConfig', $data)) {
            $object->setAuthenticationServerConfig($this->denormalizer->denormalize($data['authenticationServerConfig'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\IdentityAuthenticationServerConfig::class, 'json', $context));
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('authenticationServerConfig') && null !== $data->getAuthenticationServerConfig()) {
            $dataArray['authenticationServerConfig'] = $data->getAuthenticationServerConfig() === null ? null : new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($this->normalizer->normalize($data->getAuthenticationServerConfig(), 'json', $context));
        }
