...
class IdentityUsernamePasswordCredentialsImplDtoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\IdentityUsernamePasswordCredentialsImplDto::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\IdentityUsernamePasswordCredentialsImplDto::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\IdentityUsernamePasswordCredentialsImplDto();
        ...
        if (\array_key_exists('authenticationServerConfig', $data)) {
            $object->authenticationServerConfig = $this->denormalizer->denormalize($data['authenticationServerConfig'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\IdentityAuthenticationServerConfig::class, 'json', $context);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('authenticationServerConfig', get_object_vars($data)) && null !== ($data->authenticationServerConfig ?? null)) {
            $normalized = $this->normalizer->normalize($data->authenticationServerConfig, 'json', $context);
            $dataArray['authenticationServerConfig'] = \is_iterable($normalized) ? new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($normalized) : $normalized;
        }
    ...
    {
        return [\Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\IdentityUsernamePasswordCredentialsImplDto::class => false];
    }
}