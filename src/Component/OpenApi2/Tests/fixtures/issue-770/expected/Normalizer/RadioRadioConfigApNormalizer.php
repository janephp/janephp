...
class RadioRadioConfigApNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('radio24g', $data)) {
            $object->setRadio24g($this->denormalizer->denormalize($data['radio24g'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\RadioRadio24gAp::class, 'json', $context));
        }
        if (\array_key_exists('radio5g', $data)) {
            $object->setRadio5g($this->denormalizer->denormalize($data['radio5g'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\RadioRadio5gAp::class, 'json', $context));
        }
        if (\array_key_exists('radio5gUpper', $data)) {
            $object->setRadio5gUpper($this->denormalizer->denormalize($data['radio5gUpper'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\RadioRadio5gAp::class, 'json', $context));
        }
        if (\array_key_exists('radio5gLower', $data)) {
            $object->setRadio5gLower($this->denormalizer->denormalize($data['radio5gLower'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\RadioRadio5gAp::class, 'json', $context));
        }
        if (\array_key_exists('radio6g', $data)) {
            $object->setRadio6g($this->denormalizer->denormalize($data['radio6g'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\RadioRadio6gAp::class, 'json', $context));
        }
