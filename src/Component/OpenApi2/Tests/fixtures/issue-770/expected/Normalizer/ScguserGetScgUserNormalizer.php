...
class ScguserGetScgUserNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\ScguserGetScgUser::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\ScguserGetScgUser::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\ScguserGetScgUser();
        ...
        if (\array_key_exists('credentialExpired', $data) && \is_int($data['credentialExpired'])) {
            $data['credentialExpired'] = (bool) $data['credentialExpired'];
        }
        ...
        if (\array_key_exists('credentialExpired', $data)) {
            $object->setCredentialExpired($data['credentialExpired']);
        }
        return $object;
    }
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('credentialExpired') && null !== $data->getCredentialExpired()) {
            $dataArray['credentialExpired'] = $data->getCredentialExpired();
        }
        return $dataArray;
    }
    public function getSupportedTypes(?string $format = null): array
    {
        return [\Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\ScguserGetScgUser::class => false];
    }
}