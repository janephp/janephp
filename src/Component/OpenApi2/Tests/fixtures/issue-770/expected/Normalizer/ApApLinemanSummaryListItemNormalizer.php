...
class ApApLinemanSummaryListItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('alarms', $data)) {
            $object->setAlarms($this->denormalizer->denormalize($data['alarms'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\ApAlarmSummary::class, 'json', $context));
        }
        return $object;
    }
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('alarms') && null !== $data->getAlarms()) {
            $dataArray['alarms'] = $data->getAlarms() === null ? null : new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($this->normalizer->normalize($data->getAlarms(), 'json', $context));
        }
        return $dataArray;
    }
