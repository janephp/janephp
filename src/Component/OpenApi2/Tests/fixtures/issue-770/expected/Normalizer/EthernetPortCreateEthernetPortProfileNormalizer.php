...
class EthernetPortCreateEthernetPortProfileNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\EthernetPortCreateEthernetPortProfile::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\EthernetPortCreateEthernetPortProfile::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\EthernetPortCreateEthernetPortProfile();
        ...
        if (\array_key_exists('qinq', $data)) {
            $object->qinq = $this->denormalizer->denormalize($data['qinq'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\CommonQinq::class, 'json', $context);
        }
        ...
        if (\array_key_exists('_8021X', $data)) {
            $object->n8021X = $this->denormalizer->denormalize($data['_8021X'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\ApmodelLanPort8021X::class, 'json', $context);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('tunnelEnabled', get_object_vars($data)) && null !== ($data->tunnelEnabled ?? null)) {
            $dataArray['tunnelEnabled'] = $data->tunnelEnabled;
        }
        ...
        if (array_key_exists('dynamicVlanEnabled', get_object_vars($data)) && null !== ($data->dynamicVlanEnabled ?? null)) {
            $dataArray['dynamicVlanEnabled'] = $data->dynamicVlanEnabled;
        }
        ...
        if (array_key_exists('qinq', get_object_vars($data)) && null !== ($data->qinq ?? null)) {
            $normalized = $this->normalizer->normalize($data->qinq, 'json', $context);
            $dataArray['qinq'] = \is_iterable($normalized) ? new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($normalized) : $normalized;
        }
        ...
        if (array_key_exists('userSidePortEnabled', get_object_vars($data)) && null !== ($data->userSidePortEnabled ?? null)) {
            $dataArray['userSidePortEnabled'] = $data->userSidePortEnabled;
        }
        ...
        $normalized_1 = $data->n8021X === null ? null : $this->normalizer->normalize($data->n8021X, 'json', $context);
        $dataArray['_8021X'] = \is_iterable($normalized_1) ? new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($normalized_1) : $normalized_1;
        if (array_key_exists('tunnelProfile', get_object_vars($data)) && null !== ($data->tunnelProfile ?? null)) {
            $normalized_2 = $this->normalizer->normalize($data->tunnelProfile, 'json', $context);
            $dataArray['tunnelProfile'] = \is_iterable($normalized_2) ? new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($normalized_2) : $normalized_2;
        }
        if (array_key_exists('ipsecProfile', get_object_vars($data)) && null !== ($data->ipsecProfile ?? null)) {
            $normalized_3 = $this->normalizer->normalize($data->ipsecProfile, 'json', $context);
            $dataArray['ipsecProfile'] = \is_iterable($normalized_3) ? new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($normalized_3) : $normalized_3;
        }
        ...
        if (array_key_exists('firewallAVCEnabled', get_object_vars($data)) && null !== ($data->firewallAVCEnabled ?? null)) {
            $dataArray['firewallAVCEnabled'] = $data->firewallAVCEnabled;
        }
        if (array_key_exists('firewallUrlFilteringPolicyEnabled', get_object_vars($data)) && null !== ($data->firewallUrlFilteringPolicyEnabled ?? null)) {
            $dataArray['firewallUrlFilteringPolicyEnabled'] = $data->firewallUrlFilteringPolicyEnabled;
        }
        ...
        if (array_key_exists('clientIsolationWhitelist', get_object_vars($data)) && null !== ($data->clientIsolationWhitelist ?? null)) {
            $normalized_4 = $this->normalizer->normalize($data->clientIsolationWhitelist, 'json', $context);
            $dataArray['clientIsolationWhitelist'] = \is_iterable($normalized_4) ? new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($normalized_4) : $normalized_4;
        }
        return $dataArray;
    }
    public function getSupportedTypes(?string $format = null): array
    {
        return [\Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\EthernetPortCreateEthernetPortProfile::class => false];
    }
}