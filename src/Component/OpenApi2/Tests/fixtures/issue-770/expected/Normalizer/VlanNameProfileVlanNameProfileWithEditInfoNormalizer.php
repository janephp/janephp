...
class VlanNameProfileVlanNameProfileWithEditInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi3\Tests\Expected\Model\VlanNameProfileVlanNameProfileWithEditInfo::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Jane\Component\OpenApi3\Tests\Expected\Model\VlanNameProfileVlanNameProfileWithEditInfo::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Jane\Component\OpenApi3\Tests\Expected\Model\VlanNameProfileVlanNameProfileWithEditInfo();
        ...
        if (\array_key_exists('rules', $data)) {
            ...
            foreach ($data['rules'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Jane\Component\OpenApi3\Tests\Expected\Model\VlanNameProfileVlanNameRule::class, 'json', $context);
            }
            $object->rules = $values;
        }
    ...
    {
        return [\Jane\Component\OpenApi3\Tests\Expected\Model\VlanNameProfileVlanNameProfileWithEditInfo::class => false];
    }
}