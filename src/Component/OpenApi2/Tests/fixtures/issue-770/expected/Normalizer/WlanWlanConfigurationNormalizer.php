...
class WlanWlanConfigurationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('encryption', get_object_vars($data)) && null !== ($data->encryption ?? null)) {
            $normalized = $this->normalizer->normalize($data->encryption, 'json', $context);
            $dataArray['encryption'] = \is_iterable($normalized) ? new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($normalized) : $normalized;
        }
        ...
        if (array_key_exists('authServiceOrProfile', get_object_vars($data)) && null !== ($data->authServiceOrProfile ?? null)) {
            $normalized_1 = $this->normalizer->normalize($data->authServiceOrProfile, 'json', $context);
            $dataArray['authServiceOrProfile'] = \is_iterable($normalized_1) ? new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($normalized_1) : $normalized_1;
        }
        ...
        if (array_key_exists('macAuth', get_object_vars($data)) && null !== ($data->macAuth ?? null)) {
            $normalized_2 = $this->normalizer->normalize($data->macAuth, 'json', $context);
            $dataArray['macAuth'] = \is_iterable($normalized_2) ? new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($normalized_2) : $normalized_2;
        }
        if (array_key_exists('accountingServiceOrProfile', get_object_vars($data)) && null !== ($data->accountingServiceOrProfile ?? null)) {
            $normalized_3 = $this->normalizer->normalize($data->accountingServiceOrProfile, 'json', $context);
            $dataArray['accountingServiceOrProfile'] = \is_iterable($normalized_3) ? new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($normalized_3) : $normalized_3;
        }
        ...
        if (array_key_exists('portalServiceProfile', get_object_vars($data)) && null !== ($data->portalServiceProfile ?? null)) {
            $normalized_4 = $this->normalizer->normalize($data->portalServiceProfile, 'json', $context);
            $dataArray['portalServiceProfile'] = \is_iterable($normalized_4) ? new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($normalized_4) : $normalized_4;
        }
        if (array_key_exists('hotspot20Profile', get_object_vars($data)) && null !== ($data->hotspot20Profile ?? null)) {
            $normalized_5 = $this->normalizer->normalize($data->hotspot20Profile, 'json', $context);
            $dataArray['hotspot20Profile'] = \is_iterable($normalized_5) ? new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($normalized_5) : $normalized_5;
        }
        ...
        if (array_key_exists('defaultUserTrafficProfile', get_object_vars($data)) && null !== ($data->defaultUserTrafficProfile ?? null)) {
            $normalized_6 = $this->normalizer->normalize($data->defaultUserTrafficProfile, 'json', $context);
            $dataArray['defaultUserTrafficProfile'] = \is_iterable($normalized_6) ? new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($normalized_6) : $normalized_6;
        }
        ...
        if (array_key_exists('coreTunnelProfile', get_object_vars($data)) && null !== ($data->coreTunnelProfile ?? null)) {
            $normalized_7 = $this->normalizer->normalize($data->coreTunnelProfile, 'json', $context);
            $dataArray['coreTunnelProfile'] = \is_iterable($normalized_7) ? new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($normalized_7) : $normalized_7;
        }
        if (array_key_exists('vlan', get_object_vars($data)) && null !== ($data->vlan ?? null)) {
            $normalized_8 = $this->normalizer->normalize($data->vlan, 'json', $context);
            $dataArray['vlan'] = \is_iterable($normalized_8) ? new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($normalized_8) : $normalized_8;
        }
        if (array_key_exists('l2ACL', get_object_vars($data)) && null !== ($data->l2ACL ?? null)) {
            $normalized_9 = $this->normalizer->normalize($data->l2ACL, 'json', $context);
            $dataArray['l2ACL'] = \is_iterable($normalized_9) ? new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($normalized_9) : $normalized_9;
        }
        if (array_key_exists('devicePolicy', get_object_vars($data)) && null !== ($data->devicePolicy ?? null)) {
            $normalized_10 = $this->normalizer->normalize($data->devicePolicy, 'json', $context);
            $dataArray['devicePolicy'] = \is_iterable($normalized_10) ? new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($normalized_10) : $normalized_10;
        }
        if (array_key_exists('radiusOptions', get_object_vars($data)) && null !== ($data->radiusOptions ?? null)) {
            $normalized_11 = $this->normalizer->normalize($data->radiusOptions, 'json', $context);
            $dataArray['radiusOptions'] = \is_iterable($normalized_11) ? new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($normalized_11) : $normalized_11;
        }
        if (array_key_exists('schedule', get_object_vars($data)) && null !== ($data->schedule ?? null)) {
            $normalized_12 = $this->normalizer->normalize($data->schedule, 'json', $context);
            $dataArray['schedule'] = \is_iterable($normalized_12) ? new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($normalized_12) : $normalized_12;
        }
