...
class UrlFilteringModifyUrlFilteringPolicyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('blockByThreatLevelConfig', $data)) {
            $object->setBlockByThreatLevelConfig($this->denormalizer->denormalize($data['blockByThreatLevelConfig'], \Jane\Component\OpenApi3\Tests\Expected\Model\UrlFilteringModifyUrlFilteringPolicyBlockByThreatLevelConfig::class, 'json', $context));
        }
        return $object;
    }
