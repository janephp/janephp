...
class ProfileHs20AdviceOfChargeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        if (\array_key_exists('naiRealm', $data)) {
            $object->setNaiRealm($this->denormalizer->denormalize($data['naiRealm'], \Jane\Component\OpenApi3\Tests\Expected\Issue770\Model\ProfileHs20AdviceOfChargeNaiRealm::class, 'json', $context));
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('naiRealm') && null !== $data->getNaiRealm()) {
            $dataArray['naiRealm'] = $data->getNaiRealm() === null ? null : new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($this->normalizer->normalize($data->getNaiRealm(), 'json', $context));
        }
