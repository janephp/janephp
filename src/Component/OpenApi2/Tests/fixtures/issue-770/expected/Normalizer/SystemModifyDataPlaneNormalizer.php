...
class SystemModifyDataPlaneNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $normalized = $data->primaryInterface === null ? null : $this->normalizer->normalize($data->primaryInterface, 'json', $context);
        ...
        $normalized_1 = $data->ipv6PrimaryInterface === null ? null : $this->normalizer->normalize($data->ipv6PrimaryInterface, 'json', $context);
