...
class DomainDevicePolicyDomainDevicePolicyProfileByQueryCriteriaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if (array_key_exists('rawDataTotalCount', get_object_vars($data)) && null !== ($data->rawDataTotalCount ?? null)) {
            $dataArray['rawDataTotalCount'] = $data->rawDataTotalCount;
        }
        ...
        if (array_key_exists('extra', get_object_vars($data)) && null !== ($data->extra ?? null)) {
            $normalized = $this->normalizer->normalize($data->extra, 'json', $context);
            $dataArray['extra'] = \is_iterable($normalized) ? new \Jane\Component\OpenApi3\Tests\Expected\Issue770\Runtime\JsonObject($normalized) : $normalized;
        }
