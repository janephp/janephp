...
class FormDataParameterSubSchema implements AdditionalPropertiesInterface
{
    ...
    {
        return ['required' => ['required', 'getRequired', 'setRequired'], 'in' => ['in', 'getIn', 'setIn'], 'description' => ['description', 'getDescription', 'setDescription'], 'name' => ['name', 'getName', 'setName'], 'allowEmptyValue' => ['allowEmptyValue', 'getAllowEmptyValue', 'setAllowEmptyValue'], 'type' => ['type', 'getType', 'setType'], 'format' => ['format', 'getFormat', 'setFormat'], 'items' => ['items', 'getItems', 'setItems'], 'collectionFormat' => ['collectionFormat', 'getCollectionFormat', 'setCollectionFormat'], 'default' => ['default', 'getDefault', 'setDefault'], 'maximum' => ['maximum', 'getMaximum', 'setMaximum'], 'exclusiveMaximum' => ['exclusiveMaximum', 'getExclusiveMaximum', 'setExclusiveMaximum'], 'minimum' => ['minimum', 'getMinimum', 'setMinimum'], 'exclusiveMinimum' => ['exclusiveMinimum', 'getExclusiveMinimum', 'setExclusiveMinimum'], 'maxLength' => ['maxLength', 'getMaxLength', 'setMaxLength'], 'minLength' => ['minLength', 'getMinLength', 'setMinLength'], 'pattern' => ['pattern', 'getPattern', 'setPattern'], 'maxItems' => ['maxItems', 'getMaxItems', 'setMaxItems'], 'minItems' => ['minItems', 'getMinItems', 'setMinItems'], 'uniqueItems' => ['uniqueItems', 'getUniqueItems', 'setUniqueItems'], 'enum' => ['enum', 'getEnum', 'setEnum'], 'multipleOf' => ['multipleOf', 'getMultipleOf', 'setMultipleOf']];
    }
}
