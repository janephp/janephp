...
class Oauth2ApplicationSecurity implements AdditionalPropertiesInterface
{
    ...
    {
        return ['type' => ['type', 'getType', 'setType'], 'flow' => ['flow', 'getFlow', 'setFlow'], 'scopes' => ['scopes', 'getScopes', 'setScopes'], 'tokenUrl' => ['tokenUrl', 'getTokenUrl', 'setTokenUrl'], 'description' => ['description', 'getDescription', 'setDescription']];
    }
}
