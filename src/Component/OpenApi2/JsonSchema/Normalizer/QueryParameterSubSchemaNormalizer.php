...
class QueryParameterSubSchemaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('allowEmptyValue') && null !== $data->getAllowEmptyValue()) {
            $dataArray['allowEmptyValue'] = $data->getAllowEmptyValue();
        }
    ...
    {
        return ['Jane\\Component\\OpenApi2\\JsonSchema\\Model\\QueryParameterSubSchema' => false];
    }
}