...
class QueryParameterSubSchemaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Jane\Component\OpenApi2\JsonSchema\Model\QueryParameterSubSchema::class;
    }
    ...
    {
        return [\Jane\Component\OpenApi2\JsonSchema\Model\QueryParameterSubSchema::class => false];
    }
}
