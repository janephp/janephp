...
class PrimitivesItemsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\Component\\OpenApi2\\JsonSchema\\Model\\PrimitivesItems';
    }
    public function supportsNormalization($data, $format = null, array $context = []) : bool
    {
        return $data instanceof \Jane\Component\OpenApi2\JsonSchema\Model\PrimitivesItems;
    }
    /**
     * @return mixed
     */
    ...
    {
        return ['Jane\\Component\\OpenApi2\\JsonSchema\\Model\\PrimitivesItems' => false];
    }
}