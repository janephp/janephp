...
class BooksGetResponse200HydraSearchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return is_object($data) && get_class($data) === 'ApiPlatform\\Demo\\Model\\BooksGetResponse200HydraSearch';
    }
