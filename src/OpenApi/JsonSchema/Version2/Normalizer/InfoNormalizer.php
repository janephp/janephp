...
class InfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\OpenApi\\JsonSchema\\Version2\\Model\\Info';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Jane\OpenApi\JsonSchema\Version2\Model\Info;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Jane\OpenApi\JsonSchema\Version2\Model\Info();
        $data = clone $data;
        ...
        if (property_exists($data, 'contact')) {
            $object->setContact($this->denormalizer->denormalize($data->{'contact'}, 'Jane\\OpenApi\\JsonSchema\\Version2\\Model\\Contact', 'json', $context));
            unset($data->{'contact'});
        }
        if (property_exists($data, 'license')) {
            $object->setLicense($this->denormalizer->denormalize($data->{'license'}, 'Jane\\OpenApi\\JsonSchema\\Version2\\Model\\License', 'json', $context));
            unset($data->{'license'});
        }
