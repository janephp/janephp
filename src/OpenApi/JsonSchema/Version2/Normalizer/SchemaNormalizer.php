...
class SchemaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\OpenApi\\JsonSchema\\Version2\\Model\\Schema';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Jane\OpenApi\JsonSchema\Version2\Model\Schema;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Jane\OpenApi\JsonSchema\Version2\Model\Schema();
        $data = clone $data;
        ...
        if (property_exists($data, 'allOf')) {
            ...
            foreach ($data->{'allOf'} as $value_7) {
                $values_4[] = $this->denormalizer->denormalize($value_7, 'Jane\\OpenApi\\JsonSchema\\Version2\\Model\\Schema', 'json', $context);
            }
        ...
        if (property_exists($data, 'properties')) {
            ...
            foreach ($data->{'properties'} as $key => $value_8) {
                $values_5[$key] = $this->denormalizer->denormalize($value_8, 'Jane\\OpenApi\\JsonSchema\\Version2\\Model\\Schema', 'json', $context);
            }
        ...
        if (property_exists($data, 'xml')) {
            $object->setXml($this->denormalizer->denormalize($data->{'xml'}, 'Jane\\OpenApi\\JsonSchema\\Version2\\Model\\Xml', 'json', $context));
            unset($data->{'xml'});
        }
