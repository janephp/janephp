...
class ResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\OpenApi\\JsonSchema\\Version2\\Model\\Response';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Jane\OpenApi\JsonSchema\Version2\Model\Response;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Jane\OpenApi\JsonSchema\Version2\Model\Response();
        $data = clone $data;
        ...
        if (property_exists($data, 'schema')) {
            ...
            if (is_object($data->{'schema'})) {
                $value = $this->denormalizer->denormalize($data->{'schema'}, 'Jane\\OpenApi\\JsonSchema\\Version2\\Model\\Schema', 'json', $context);
            }
            if (is_object($data->{'schema'}) and (isset($data->{'schema'}->{'type'}) and $data->{'schema'}->{'type'} == 'file')) {
                $value = $this->denormalizer->denormalize($data->{'schema'}, 'Jane\\OpenApi\\JsonSchema\\Version2\\Model\\FileSchema', 'json', $context);
            }
        ...
        if (property_exists($data, 'headers')) {
            ...
            foreach ($data->{'headers'} as $key => $value_1) {
                $values[$key] = $this->denormalizer->denormalize($value_1, 'Jane\\OpenApi\\JsonSchema\\Version2\\Model\\Header', 'json', $context);
            }
