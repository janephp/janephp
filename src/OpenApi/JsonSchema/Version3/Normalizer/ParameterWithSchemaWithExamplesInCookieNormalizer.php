...
class ParameterWithSchemaWithExamplesInCookieNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\OpenApi\\JsonSchema\\Version3\\Model\\ParameterWithSchemaWithExamplesInCookie';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Jane\OpenApi\JsonSchema\Version3\Model\ParameterWithSchemaWithExamplesInCookie;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Jane\OpenApi\JsonSchema\Version3\Model\ParameterWithSchemaWithExamplesInCookie();
        $data = clone $data;
