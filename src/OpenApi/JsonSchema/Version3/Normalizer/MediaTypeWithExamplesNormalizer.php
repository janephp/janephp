...
class MediaTypeWithExamplesNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\OpenApi\\JsonSchema\\Version3\\Model\\MediaTypeWithExamples';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Jane\OpenApi\JsonSchema\Version3\Model\MediaTypeWithExamples;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Jane\OpenApi\JsonSchema\Version3\Model\MediaTypeWithExamples();
        $data = clone $data;
        ...
        if (property_exists($data, 'encoding')) {
            ...
            foreach ($data->{'encoding'} as $key_1 => $value_3) {
                $values_1[$key_1] = $this->denormalizer->denormalize($value_3, 'Jane\\OpenApi\\JsonSchema\\Version3\\Model\\Encoding', 'json', $context);
            }
