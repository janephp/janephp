...
class SchemaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\OpenApi2\\Model\\Schema';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Jane\OpenApi2\Model\Schema;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Jane\OpenApi2\Model\Schema();
        $data = clone $data;
        ...
        if (property_exists($data, 'additionalProperties')) {
            ...
            if (is_object($data->{'additionalProperties'})) {
                $value_2 = $this->denormalizer->denormalize($data->{'additionalProperties'}, 'Jane\\OpenApi2\\Model\\Schema', 'json', $context);
            }
        ...
        if (property_exists($data, 'items')) {
            ...
            if (is_object($data->{'items'})) {
                $value_5 = $this->denormalizer->denormalize($data->{'items'}, 'Jane\\OpenApi2\\Model\\Schema', 'json', $context);
            }
            if (is_array($data->{'items'})) {
                $values_3 = [];
                foreach ($data->{'items'} as $value_6) {
                    $values_3[] = $this->denormalizer->denormalize($value_6, 'Jane\\OpenApi2\\Model\\Schema', 'json', $context);
                }
                $value_5 = $values_3;
            }
        ...
        if (property_exists($data, 'allOf')) {
            ...
            foreach ($data->{'allOf'} as $value_7) {
                $values_4[] = $this->denormalizer->denormalize($value_7, 'Jane\\OpenApi2\\Model\\Schema', 'json', $context);
            }
        ...
        if (property_exists($data, 'properties')) {
            ...
            foreach ($data->{'properties'} as $key => $value_8) {
                $values_5[$key] = $this->denormalizer->denormalize($value_8, 'Jane\\OpenApi2\\Model\\Schema', 'json', $context);
            }
        ...
        if (property_exists($data, 'xml')) {
            $object->setXml($this->denormalizer->denormalize($data->{'xml'}, 'Jane\\OpenApi2\\Model\\Xml', 'json', $context));
            unset($data->{'xml'});
        }
