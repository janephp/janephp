...
class BodyParameterNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\OpenApi2\\Model\\BodyParameter';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Jane\OpenApi2\Model\BodyParameter;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Jane\OpenApi2\Model\BodyParameter();
        $data = clone $data;
        ...
        if (property_exists($data, 'schema')) {
            $object->setSchema($this->denormalizer->denormalize($data->{'schema'}, 'Jane\\OpenApi2\\Model\\Schema', 'json', $context));
            unset($data->{'schema'});
        }
