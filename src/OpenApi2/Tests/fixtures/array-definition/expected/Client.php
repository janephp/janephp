...
class Client extends \Jane\OpenApiRuntime\Client\Psr18Client
{
     ...
     *
     * @return null|\Jane\OpenApi2\Tests\Expected\Model\BarItem[]|\Psr\Http\Message\ResponseInterface
     */
    public function testSimple(string $fetch = self::FETCH_OBJECT)
    {
        return $this->executePsr7Endpoint(new \Jane\OpenApi2\Tests\Expected\Endpoint\TestSimple(), $fetch);
    }
