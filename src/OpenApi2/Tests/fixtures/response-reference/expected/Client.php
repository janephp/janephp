...
class Client extends \Jane\OpenApi2\Tests\Expected\Runtime\Client\Client
{
     ...
     *
     * @return null|\Jane\OpenApi2\Tests\Expected\Model\ResponseCommon|\Psr\Http\Message\ResponseInterface
     */
    public function testReferenceResponse(string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Jane\OpenApi2\Tests\Expected\Endpoint\TestReferenceResponse(), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
    ...
    {
        return $this->executeEndpoint(new \Jane\OpenApi2\Tests\Expected\Endpoint\TestRefArray(), $fetch);
    }
