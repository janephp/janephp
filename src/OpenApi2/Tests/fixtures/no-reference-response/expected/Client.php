...
class Client extends \Jane\OpenApiRuntime\Client\Psr18Client
{
     ...
     *
     * @return null|\Jane\OpenApi2\Tests\Expected\Model\TestPostResponse201|\Psr\Http\Message\ResponseInterface
     */
    public function test(string $fetch = self::FETCH_OBJECT)
    {
        return $this->executePsr7Endpoint(new \Jane\OpenApi2\Tests\Expected\Endpoint\Test(), $fetch);
    }
