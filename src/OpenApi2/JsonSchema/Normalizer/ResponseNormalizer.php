...
class ResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\OpenApi2\\JsonSchema\\Model\\Response';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Jane\OpenApi2\JsonSchema\Model\Response;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Jane\OpenApi2\JsonSchema\Model\Response();
        ...
        if (\array_key_exists('schema', $data) && $data['schema'] !== null) {
            ...
            if (is_array($data['schema'])) {
                $value = $this->denormalizer->denormalize($data['schema'], 'Jane\\OpenApi2\\JsonSchema\\Model\\Schema', 'json', $context);
            } elseif (is_array($data['schema']) and (isset($data['schema']['type']) and $data['schema']['type'] == 'file')) {
                $value = $this->denormalizer->denormalize($data['schema'], 'Jane\\OpenApi2\\JsonSchema\\Model\\FileSchema', 'json', $context);
            }
        ...
        if (\array_key_exists('headers', $data) && $data['headers'] !== null) {
            ...
            foreach ($data['headers'] as $key => $value_1) {
                $values[$key] = $this->denormalizer->denormalize($value_1, 'Jane\\OpenApi2\\JsonSchema\\Model\\Header', 'json', $context);
            }
