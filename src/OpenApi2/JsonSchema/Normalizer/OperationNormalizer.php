...
class OperationNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\OpenApi2\\JsonSchema\\Model\\Operation';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Jane\OpenApi2\JsonSchema\Model\Operation;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Jane\OpenApi2\JsonSchema\Model\Operation();
        ...
        if (\array_key_exists('parameters', $data) && $data['parameters'] !== null) {
            ...
            foreach ($data['parameters'] as $value_3) {
                ...
                if (is_array($value_3) and isset($value_3['name']) and (isset($value_3['in']) and $value_3['in'] == 'body') and isset($value_3['schema'])) {
                    $value_4 = $this->denormalizer->denormalize($value_3, 'Jane\\OpenApi2\\JsonSchema\\Model\\BodyParameter', 'json', $context);
                    ...
                    $value_4 = $this->denormalizer->denormalize($value_3, 'Jane\\OpenApi2\\JsonSchema\\Model\\HeaderParameterSubSchema', 'json', $context);
                    ...
                    $value_4 = $this->denormalizer->denormalize($value_3, 'Jane\\OpenApi2\\JsonSchema\\Model\\FormDataParameterSubSchema', 'json', $context);
                    ...
                    $value_4 = $this->denormalizer->denormalize($value_3, 'Jane\\OpenApi2\\JsonSchema\\Model\\QueryParameterSubSchema', 'json', $context);
                    ...
                    $value_4 = $this->denormalizer->denormalize($value_3, 'Jane\\OpenApi2\\JsonSchema\\Model\\PathParameterSubSchema', 'json', $context);
                } elseif (is_array($value_3) and isset($value_3['$ref'])) {
                    $value_4 = $this->denormalizer->denormalize($value_3, 'Jane\\OpenApi2\\JsonSchema\\Model\\JsonReference', 'json', $context);
                }
                $values_3[] = $value_4;
            }
            ...
            foreach ($data['responses'] as $key => $value_5) {
                if (preg_match('/^([0-9]{3})$|^(default)$/', (string) $key) && isset($value_5)) {
                    ...
                    if (is_array($value_5) and isset($value_5['description'])) {
                        $value_6 = $this->denormalizer->denormalize($value_5, 'Jane\\OpenApi2\\JsonSchema\\Model\\Response', 'json', $context);
                    } elseif (is_array($value_5) and isset($value_5['$ref'])) {
                        $value_6 = $this->denormalizer->denormalize($value_5, 'Jane\\OpenApi2\\JsonSchema\\Model\\JsonReference', 'json', $context);
                    }
