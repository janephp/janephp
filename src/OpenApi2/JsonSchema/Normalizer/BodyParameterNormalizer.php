...
class BodyParameterNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\OpenApi2\\JsonSchema\\Model\\BodyParameter';
    }

    public function supportsNormalization($data, $format = null)
    {
        return $data instanceof \Jane\OpenApi2\JsonSchema\Model\BodyParameter;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Jane\OpenApi2\JsonSchema\Model\BodyParameter();
        ...
        if (\array_key_exists('schema', $data) && $data['schema'] !== null) {
            ...
            if (is_array($data['schema'])) {
                ...
                $value = $this->denormalizer->denormalize($data['schema'], 'Jane\\OpenApi2\\JsonSchema\\Model\\JsonReference', 'json', $context);
            }
