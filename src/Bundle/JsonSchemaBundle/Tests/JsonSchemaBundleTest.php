...
use Jane\Bundle\JsonSchemaBundle\DependencyInjection\Configuration;
...
class JsonSchemaBundleTest extends KernelTestCase
{
    ...
    protected function tearDown(): void
    {
        ...
        (new Filesystem())->remove(sys_get_temp_dir() . '/jane-jsonschema-bundle-test-' . getmypid());
    }
    ...
    public function testGenerateCommandSucceedsUsingDefaultConfigResolution(): void
    {
        ...
        $tester = new CommandTester($application->find('jane:json-schema:generate'));
        $tester->execute([]);
    ...
    public function testGenerateCommandFailsOnMissingConfigFile(): void
    {
        ...
        $statusCode = $application->run(new ArrayInput([
            'command' => 'jane:json-schema:generate',
