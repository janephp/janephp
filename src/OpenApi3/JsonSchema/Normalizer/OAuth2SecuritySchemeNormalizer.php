...
class OAuth2SecuritySchemeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof \Jane\OpenApi3\JsonSchema\Model\OAuth2SecurityScheme;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Jane\OpenApi3\JsonSchema\Model\OAuth2SecurityScheme();
        ...
        if (\array_key_exists('flows', $data) && $data['flows'] !== null) {
            $object->setFlows($this->denormalizer->denormalize($data['flows'], 'Jane\\OpenApi3\\JsonSchema\\Model\\OAuthFlows', 'json', $context));
            unset($data['flows']);
