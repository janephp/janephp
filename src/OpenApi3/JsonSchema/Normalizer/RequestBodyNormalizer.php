...
class RequestBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof \Jane\OpenApi3\JsonSchema\Model\RequestBody;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Jane\OpenApi3\JsonSchema\Model\RequestBody();
        ...
        if (\array_key_exists('content', $data) && $data['content'] !== null) {
            ...
            foreach ($data['content'] as $key => $value) {
                $values[$key] = $this->denormalizer->denormalize($value, 'Jane\\OpenApi3\\JsonSchema\\Model\\MediaType', 'json', $context);
            }
