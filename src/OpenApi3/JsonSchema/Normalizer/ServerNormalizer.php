...
class ServerNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $data instanceof \Jane\OpenApi3\JsonSchema\Model\Server;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Jane\OpenApi3\JsonSchema\Model\Server();
        ...
        if (\array_key_exists('variables', $data) && $data['variables'] !== null) {
            ...
            foreach ($data['variables'] as $key => $value) {
                $values[$key] = $this->denormalizer->denormalize($value, 'Jane\\OpenApi3\\JsonSchema\\Model\\ServerVariable', 'json', $context);
            }
