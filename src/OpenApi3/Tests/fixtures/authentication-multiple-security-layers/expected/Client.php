...
class Client extends \Jane\OpenApi3\Tests\Expected\Runtime\Client\Client
{
    ...
    {
        return $this->executeEndpoint(new \Jane\OpenApi3\Tests\Expected\Endpoint\GetBar(), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
    ...
    {
        return $this->executeEndpoint(new \Jane\OpenApi3\Tests\Expected\Endpoint\GetBaz(), $fetch);
    }
    public static function create($httpClient = null, array $additionalPlugins = array())
    {
        if (null === $httpClient) {
            ...
            $plugins = array();
            $uri = \Http\Discovery\Psr17FactoryDiscovery::findUrlFactory()->createUri('http://127.0.0.1/');
