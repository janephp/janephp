...
class BazNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\OpenApi3\\Tests\\Expected\\Model\\Baz';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'Jane\\OpenApi3\\Tests\\Expected\\Model\\Baz';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Jane\OpenApi3\Tests\Expected\Model\Baz();
        if (null === $data) {
            return $object;
        }
        ...
        if (\array_key_exists('sub', $data)) {
            $object->setSub($this->denormalizer->denormalize($data['sub'], 'Jane\\OpenApi3\\Tests\\Expected\\Model\\SubBaz', 'json', $context));
        }
        return $object;
    }
