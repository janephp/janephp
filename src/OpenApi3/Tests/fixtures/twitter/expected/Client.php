...
class Client extends \Jane\OpenApiRuntime\Client\Psr18Client
{
     ...
     *
     * @return null|\Jane\OpenApi3\Tests\Expected\Model\UserLookupResponse|\Jane\OpenApi3\Tests\Expected\Model\Error|\Psr\Http\Message\ResponseInterface
     */
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return null|\Jane\OpenApi3\Tests\Expected\Model\TweetMetricsResponse|\Jane\OpenApi3\Tests\Expected\Model\Error|\Psr\Http\Message\ResponseInterface
     */
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return null|\Jane\OpenApi3\Tests\Expected\Model\TweetSearchResponse|\Jane\OpenApi3\Tests\Expected\Model\Error|\Psr\Http\Message\ResponseInterface
     */
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return null|\Jane\OpenApi3\Tests\Expected\Model\GetRulesResponse|\Jane\OpenApi3\Tests\Expected\Model\Error|\Psr\Http\Message\ResponseInterface
     */
     ...
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
     * @return null|\Jane\OpenApi3\Tests\Expected\Model\Error|\Psr\Http\Message\ResponseInterface
     */
