...
class FindUsersByIdOrUsername extends \Jane\OpenApi3\Tests\Expected\Runtime\Client\BaseEndpoint implements \Jane\OpenApi3\Tests\Expected\Runtime\Client\Endpoint
{
    /**
    ...
    public function getQueryString() : string
    {
        ...
        return ltrim((new \Rize\UriTemplate\UriTemplate())->expand('{?ids,usernames,format,tweet.format,user.format,place.format,expansions}', $optionsResolved), '?');
    }
     ...
     *
     *
     * @return null|\Jane\OpenApi3\Tests\Expected\Model\UserLookupResponse|\Jane\OpenApi3\Tests\Expected\Model\Error
     */
    protected function transformResponseBody(string $body, int $status, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        if (200 === $status && mb_strpos($contentType, 'application/json') !== false) {
            return $serializer->deserialize($body, 'Jane\\OpenApi3\\Tests\\Expected\\Model\\UserLookupResponse', 'json');
        }
