...
class Client extends \Jane\OpenApiRuntime\Client\Psr18Client
{
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\CompanySearch($queryParameters, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\CompanyCreditReport($id, $queryParameters, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\CompanySearchCriteria($queryParameters, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\CompanyReportJSONSchema($countryCode, $queryParameters, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\CountriesInSubscription($headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\PeopleDirectorSearch($queryParameters, $headerParameters), $fetch);
    }
    /**
     * 
     *
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\DirectorReport($personId, $queryParameters, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\PeopleDirectorSearchCriteria($queryParameters, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\CompanyImageDocuments($queryParameters, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\ImageDocumentCategoryTypes($queryParameters, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\RequestFreshInvestigation($requestBody, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\DeletePendingFreshInvesitgation($orderId, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\EditPendingFreshInvestigation($orderId, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\BankMatch($queryParameters, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\MonitoringUserDetails($headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\CompanyEvents($id, $queryParameters, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\AllEventRules($headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\FilteredEventRules($countryCode, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\NotificationEvents($queryParameters, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\ListAllPortfolios($queryParameters, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\ListCountriesOfMonitoredCompanies($portfolioId, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\ListFilteredCompaniesInAPortfolio($portfolioId, $queryParameters, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\PortfolioUserPermissions($portfolioId, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\ListDecisionTrees($queryParameters, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\RunDecisionTree($provenirId, $requestBody, $queryParameters, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\CompanyComplianceSearchCriteria($headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\ListOfCompanyPreDefinedSearches($headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\CompanyComplianceSearch($predefinedSearch, $queryParameters, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\IndividualsComplianceSearchCriteria($headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\ListOfIndividualsPreDefinedSearches($headerParameters), $fetch);
    }
    /**
     * Searches the provided `Predefined search` list with your search criteria. Results returned here indicate potential matches (depending on the predefined Search used).
     *
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\IndividualPersonComplianceSearch($predefinedSearch, $queryParameters, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executePsr7Endpoint(new \CreditSafe\API\Endpoint\CustomReportParameters($country, $queryParameters, $headerParameters), $fetch);
    }
