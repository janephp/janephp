...
class Client extends \Jane\OpenApiRuntime\Client\Client
{
    ...
    {
        return $this->executeEndpoint(new \CreditSafe\API\Endpoint\ListFreshInvestigations($queryParameters, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \CreditSafe\API\Endpoint\FreshInvestigationReport($orderId, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \CreditSafe\API\Endpoint\ResetPortfolioEventRules($portfolioId, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \CreditSafe\API\Endpoint\CopyCompaniesToAnotherPortfolio($portfolioId, $requestBody, $queryParameters, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \CreditSafe\API\Endpoint\MovesCompaniesFromOnePortfolioToAnother($portfolioId, $requestBody, $queryParameters, $headerParameters), $fetch);
    }
    /**
    ...
    */
    ...
    {
        return $this->executeEndpoint(new \CreditSafe\API\Endpoint\MonitoredCompanyFromAPortfolio($portfolioId, $id, $headerParameters), $fetch);
    }
    /**
    ...
    {
        return $this->executeEndpoint(new \CreditSafe\API\Endpoint\UpdatePortfolioCompany($portfolioId, $id, $requestBody, $headerParameters), $fetch);
    }
    /**
