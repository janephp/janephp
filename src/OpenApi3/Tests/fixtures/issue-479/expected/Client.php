...
class Client extends \Jane\OpenApi3\Tests\Expected\Runtime\Client\Client
{
     ...
     */
    public function foo(\Jane\OpenApi3\Tests\Expected\Model\FooPostBody $requestBody, string $fetch = self::FETCH_OBJECT)
    {
        return $this->executeEndpoint(new \Jane\OpenApi3\Tests\Expected\Endpoint\Foo($requestBody), $fetch);
    }
