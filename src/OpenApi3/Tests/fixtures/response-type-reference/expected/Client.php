...
class Client extends \Jane\OpenApiRuntime\Client\Psr18Client
{
     ...
     *
     * @return null|\Jane\OpenApi3\Tests\Expected\Model\FooGetResponse200|\Psr\Http\Message\ResponseInterface
     */
    public function foo(string $fetch = self::FETCH_OBJECT)
    {
        return $this->executePsr7Endpoint(new \Jane\OpenApi3\Tests\Expected\Endpoint\Foo(), $fetch);
    }
