...
class TeamsListPendingInvitationsLegacy extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7Endpoint
{
    protected $team_id;
    /**
    ...
    */
    ...
    {
        return str_replace(array('{team_id}'), array($this->team_id), '/teams/{team_id}/invitations');
    }
