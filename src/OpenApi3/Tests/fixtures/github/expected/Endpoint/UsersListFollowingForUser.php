...
class UsersListFollowingForUser extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7Endpoint
{
    protected $username;
    /**
    ...
    {
        return str_replace(array('{username}'), array($this->username), '/users/{username}/following');
    }
