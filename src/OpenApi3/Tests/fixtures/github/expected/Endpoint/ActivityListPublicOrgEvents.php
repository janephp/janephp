...
class ActivityListPublicOrgEvents extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7Endpoint
{
    protected $org;
    /**
     * 
    ...
    {
        return str_replace(array('{org}'), array($this->org), '/orgs/{org}/events');
    }
