...
class OrgsListPublicMembers extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7Endpoint
{
    protected $org;
    /**
    ...
    {
        return str_replace(array('{org}'), array($this->org), '/orgs/{org}/public_members');
    }
