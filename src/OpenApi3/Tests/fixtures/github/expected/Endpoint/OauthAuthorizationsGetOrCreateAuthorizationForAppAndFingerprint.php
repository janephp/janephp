...
class OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprint extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Endpoint
{
    protected $client_id;
