...
class Client extends \Jane\OpenApiRuntime\Client\Psr18Client
{
     ...
     *
     * @return null|\Jane\OpenApi3\Tests\Expected\Model\Pet[]|\Jane\OpenApi3\Tests\Expected\Model\Error|\Psr\Http\Message\ResponseInterface
     */
    public function listPets(array $queryParameters = array(), string $fetch = self::FETCH_OBJECT)
    {
        return $this->executePsr7Endpoint(new \Jane\OpenApi3\Tests\Expected\Endpoint\ListPets($queryParameters), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
    ...
    {
        return $this->executePsr7Endpoint(new \Jane\OpenApi3\Tests\Expected\Endpoint\CreatePets(), $fetch);
    }
    /**
     * 
     *
    ...
    {
        return $this->executePsr7Endpoint(new \Jane\OpenApi3\Tests\Expected\Endpoint\ShowPetById($petId), $fetch);
    }
