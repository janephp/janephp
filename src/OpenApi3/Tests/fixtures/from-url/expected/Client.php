...
class Client extends \Jane\OpenApi3\Tests\Expected\Runtime\Client\Client
{
    ...
    {
        return $this->executeEndpoint(new \Jane\OpenApi3\Tests\Expected\Endpoint\ListPets($queryParameters), $fetch);
    }
    /**
     * @param string $fetch Fetch mode to use (can be OBJECT or RESPONSE)
     *
    ...
    {
        return $this->executeEndpoint(new \Jane\OpenApi3\Tests\Expected\Endpoint\CreatePets(), $fetch);
    }
    /**
     * 
     *
    ...
    {
        return $this->executeEndpoint(new \Jane\OpenApi3\Tests\Expected\Endpoint\ShowPetById($petId), $fetch);
    }
