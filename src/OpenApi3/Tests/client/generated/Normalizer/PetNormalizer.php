...
class PetNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Jane\\OpenApi3\\Tests\\Client\\PetStore\\Model\\Pet';
    }

    public function supportsNormalization($data, $format = null)
    {
        return \is_object($data) && \get_class($data) === 'Jane\\OpenApi3\\Tests\\Client\\PetStore\\Model\\Pet';
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Jane\OpenApi3\Tests\Client\PetStore\Model\Pet();
        if (null === $data) {
            return $object;
        }
