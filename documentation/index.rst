...
Jane also include the AutoMapper, an advanced serializer that generate class that can serialize or deserialize to
...
Also, if you are a more advanced user, you can read the detailled components pages:
